 ...
 */
static NEMUSTRICTRC iomRCInterpretIN(PVM pVM, PVMCPU pVCpu, PCPUMCTXCORE pRegFrame, PDISCPUSTATE pCpu)
{
#ifdef IN_RC
    ...
    Assert(cbSize > 0);
    NEMUSTRICTRC rcStrict = IOMInterpretCheckPortIOAccess(pVM, pRegFrame, uPort, cbSize);
 ...
 * @param   pCpu        Disassembler CPU state.
 */
static NEMUSTRICTRC iomRCInterpretOUT(PVM pVM, PVMCPU pVCpu, PCPUMCTXCORE pRegFrame, PDISCPUSTATE pCpu)
{
#ifdef IN_RC
 ...
 * @param   pCpu        Disassembler CPU state.
 */
static NEMUSTRICTRC iomRCInterpretINS(PVM pVM, PVMCPU pVCpu, PCPUMCTXCORE pRegFrame, PDISCPUSTATE pCpu)
{
#ifdef NEMU_WITH_3RD_IEM_STEP
    ...
    NEMUSTRICTRC rcStrict = IOMInterpretCheckPortIOAccess(pVM, pRegFrame, Port, cb);
 ...
 * @param   pCpu        Disassembler CPU state.
 */
static NEMUSTRICTRC iomRCInterpretOUTS(PVM pVM, PVMCPU pVCpu, PCPUMCTXCORE pRegFrame, PDISCPUSTATE pCpu)
{
#ifdef NEMU_WITH_3RD_IEM_STEP
