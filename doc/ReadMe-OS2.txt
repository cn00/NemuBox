...
* Misc:
  ...
  - Installer.
  - VMX support.
  - NemuSDL (resizing/scaling/keyboard/slowness).
...
5. Note that by default VirtualBox stores all user data in the
   ...
   overwrite the location of this directory using the NEMU_USER_HOME
...
* XX.XX.XXXX
  ...
  - Fixed: NemuSDL keyboard key event to scan code conversion [contributed
    by Paul Smedley].
