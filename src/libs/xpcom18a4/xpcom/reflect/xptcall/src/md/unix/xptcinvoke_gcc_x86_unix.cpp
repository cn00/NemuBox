...
/* alignment here seems unimportant here; this was 16, now it's 2 which
   is what xptcstubs uses. */
	...
	".globl " SYMBOL_UNDERSCORE "NemuNsxpXPTC_InvokeByIndex\n\t"
	".type  " SYMBOL_UNDERSCORE "NemuNsxpXPTC_InvokeByIndex,@function\n"
	SYMBOL_UNDERSCORE "NemuNsxpXPTC_InvokeByIndex:\n\t"
#else
...
#else
#ifdef NEMU_WITH_XPCOM_NAMESPACE_CLEANUP
	".size " SYMBOL_UNDERSCORE "NemuNsxpXPTC_InvokeByIndex, . -" SYMBOL_UNDERSCORE "NemuNsxpXPTC_InvokeByIndex\n\t"
#else
