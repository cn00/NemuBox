...
class tdBenchmark1(nemu.TestDriver):
    """
    Benchmark #1.
    """
    ...
    def __init__(self):
        ...
        oTestVm = nemutestvms.BootSectorTestVm(self.oTestVmSet, 'tst-bs-test1',
                                               os.path.join(self.sNemuBootSectors, 'bootsector2-test1.img'));
