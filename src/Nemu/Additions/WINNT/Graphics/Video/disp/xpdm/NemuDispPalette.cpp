/* $Id: NemuDispPalette.cpp $ */

/** @file
 * Nemu XPDM Display driver, palette related functions
 */
...
int NemuDispSetPalette8BPP(PNEMUDISPDEV pDev)
{
    ...
    return NemuDispMPSetColorRegisters(pDev->hDriver, pClut, MAX_CLUT_SIZE);
}
...
BOOL APIENTRY NemuDispDrvSetPalette(DHPDEV dhpdev, PALOBJ *ppalo, FLONG fl, ULONG iStart, ULONG cColors)
{
    ...
    rc =  NemuDispMPSetColorRegisters(pDev->hDriver, pClut, MAX_CLUT_SIZE);
