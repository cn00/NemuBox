...
class tdGuestOsInstOs2(nemu.TestDriver):
    """
    ...
    def actionConfig(self):
        ...
        if sController == self.ksSataController:
            fRc = oSession.setStorageControllerType(nemucon.StorageControllerType_IntelAhci, sController)
        ...
        fRc = fRc and oSession.setBootOrder(2, nemucon.DeviceType_Floppy)
        ...
        return nemu.TestDriver.actionConfig(self)
