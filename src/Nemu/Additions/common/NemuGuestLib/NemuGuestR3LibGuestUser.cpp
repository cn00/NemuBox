/* $Id: NemuGuestR3LibGuestUser.cpp $ */
/** @file
 * NemuGuestR3Lib - Ring-3 Support Library for VirtualBox guest additions,
                                           ...
                                           uint8_t *puDetails, uint32_t cbDetails)
{
    ...
    if (RT_SUCCESS(rc))
    {
         ...
         */
        uint32_t cbOffDynamic = RT_OFFSETOF(NemuGuestUserStatus, szUser);
