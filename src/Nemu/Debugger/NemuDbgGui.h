...
#ifndef ___Debugger_NemuDbgGui_h
#define ___Debugger_NemuDbgGui_h
 ...
 */
class NemuDbgGui : public QObject
{
    Q_OBJECT;

public:
    /**
     * Create a default NemuDbgGui object.
     */
    NemuDbgGui();

    /**
     * Initializes a NemuDbgGui object by ISession.
     *
     * @returns Nemu status code.
     * @param   pSession    Nemu Session object.
     */
    int init(ISession *pSession);

    /**
     * Initializes a NemuDbgGui object by VM handle.
     *
     * @returns Nemu status code.
    ...
    /**
     * Destroys the NemuDbgGui object.
     */
    virtual ~NemuDbgGui();
...
protected:
    ...
    NemuDbgStats *m_pDbgStats;
    /** The debugger console (aka. command line). */
    NemuDbgConsole *m_pDbgConsole;
