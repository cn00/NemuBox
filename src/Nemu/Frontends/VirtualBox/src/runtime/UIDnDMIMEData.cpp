...
/** @file
 * Nemu Qt GUI - UIDnDMIMEData class implementation.
 */
...
# ifndef NEMU_WITH_DRAG_AND_DROP_PROMISES
    /*
     * Without NEMU_WITH_DRAG_AND_DROP_PROMISES being set in Nemu *and* in our (patched) Qt
...
# endif /* NEMU_WITH_DRAG_AND_DROP_PROMISES */
#else /* !RT_OS_DARWIN */
    /*
