/* $Id: NemuGuestR3LibModule.cpp $ */
/** @file
 * NemuGuestR3Lib - Ring-3 Support Library for VirtualBox guest additions, Shared modules.
 */
...
#ifdef RT_OS_WINDOWS
# if ARCH_BITS == 32
    pReq->enmGuestOS    = NEMUOSFAMILY_Windows32;
# else
    pReq->enmGuestOS    = NEMUOSFAMILY_Windows64;
# endif
#else
    /** todo */
    pReq->enmGuestOS    = NEMUOSFAMILY_Unknown;
#endif
