...
#define PR_CreateTrace NemuNsprPR_CreateTrace
#define PR_DestroyTrace NemuNsprPR_DestroyTrace
#define PR_Trace NemuNsprPR_Trace
#define PR_SetTraceOption NemuNsprPR_SetTraceOption
#define PR_GetTraceOption NemuNsprPR_GetTraceOption
#define PR_GetTraceHandleFromName NemuNsprPR_GetTraceHandleFromName
#define PR_GetTraceNameFromHandle NemuNsprPR_GetTraceNameFromHandle
#define PR_FindNextTraceQname NemuNsprPR_FindNextTraceQname
#define PR_FindNextTraceRname NemuNsprPR_FindNextTraceRname
#define PR_RecordTraceEntries NemuNsprPR_RecordTraceEntries
#define PR_GetTraceEntries NemuNsprPR_GetTraceEntries
