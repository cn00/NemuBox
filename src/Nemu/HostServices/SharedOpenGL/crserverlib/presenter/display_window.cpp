...
void CrFbDisplayWindow::onUpdateEnd()
{
    ...
    {
        crNemuServerNotifyEvent(mu32Screen,
                                fVisible? NEMU3D_NOTIFY_EVENT_TYPE_3DDATA_VISIBLE:
                                          NEMU3D_NOTIFY_EVENT_TYPE_3DDATA_HIDDEN,
                                NULL, 0);
...
int CrFbDisplayWindow::windowSetCompositor(bool fSet)
{
    ...
    if (fSet)
    {
        const struct NEMUVR_SCR_COMPOSITOR* pCompositor = CrFbGetCompositor(getFramebuffer());
