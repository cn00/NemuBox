/* $Id: NemuZoneAccess.c $ */
/** @file
 * NemuZoneAccess - Hack that keeps nemudrv referenced for granting zone access, Solaris hosts.
 */
...
*********************************************************************************************************************************/
#define DEVICE_NAME     "/devices/pseudo/nemudrv@0:nemudrv"
#define DEVICE_NAME_USR "/devices/pseudo/nemudrv@0:nemudrvu"
