/* $Id: NemuAboutDlg.h $ */
/** @file
 * Nemu Qt GUI - NemuAboutDlg class declaration.
 */
...
#ifndef ___NemuAboutDlg_h___
#define ___NemuAboutDlg_h___
...
class NemuAboutDlg : public QIWithRetranslateUI2<QIDialog>
{
    Q_OBJECT;
...
public:
    ...
    NemuAboutDlg(QWidget *pParent, const QString &strVersion);
