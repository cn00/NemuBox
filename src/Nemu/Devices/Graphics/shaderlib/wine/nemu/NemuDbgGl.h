...
#ifndef ___NemuDbgGl_h__
#define ___NemuDbgGl_h__
...
#define DBGL_CHECK_DRAWPRIM(_gl_info, _pDevice) do { \
        if (g_NemuDbgGlFCheckDrawPrim) { \
            dbglCheckTexUnits((_gl_info), (_pDevice), g_NemuDbgGlFBreakDrawPrimIfCanNotMatch); \
        } \
    } while (0)
#else
...
extern DWORD g_NemuDbgGlFCheckDrawPrim;
extern DWORD g_NemuDbgGlFBreakDrawPrimIfCanNotMatch;

#endif /* #ifndef ___NemuDbgGl_h__ */
