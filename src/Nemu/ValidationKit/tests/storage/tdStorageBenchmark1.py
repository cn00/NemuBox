...
class tdStorageBenchmark(nemu.TestDriver):                                      # pylint: disable=R0902
    """
    Storage benchmark.
    """
        ...
        if oSession is not None:
            ...
            if sDiskFormat == "iSCSI":
                ...
                if self.fpApiVer >= 5.0:
                    oHd = oSession.oNemu.createMedium(sDiskFormat, sDiskPath, nemucon.AccessMode_ReadWrite, \
                                                      nemucon.DeviceType_HardDisk);
                else:
                    oHd = oSession.oNemu.createHardDisk(sDiskFormat, sDiskPath);
            ...
            if oSession is not None:
                ...
                if oSession is not None:
                    try:
                        ...
                        self.oNemu.deleteHdByLocation(sDiskPath);
                        oSession.saveSettings();
                        oSession.close();
                        oSession = None;
                    except:
