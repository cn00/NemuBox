/* $Id: tstNemuAPIWin.cpp $ */
/** @file
 *
 * tstNemuAPIWin - sample program to illustrate the VirtualBox
 *                 COM API for machine management on Windows.
                   It only uses standard C/C++ and COM semantics,
 *                 no additional Nemu classes/macros/helpers. To
...
int testStartVM(IVirtualBox *virtualBox)
{
    ...
    else
    {
        ...
        do
        {
            ...
            /* Start a VM session using the delivered Nemu GUI. */
