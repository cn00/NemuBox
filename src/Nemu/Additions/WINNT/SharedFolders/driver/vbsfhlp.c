...
/**
 * Convert Nemu IRT file attributes to NT file attributes
 *
 * @returns NT file attributes
 * @param   fMode       IRT file attributes
 *
 */
uint32_t NemuToNTFileAttributes (uint32_t fMode)
{
 ...
 *
 */
uint32_t NTToNemuFileAttributes (uint32_t fMode)
{
    uint32_t FileAttributes = 0;
...
NTSTATUS vbsfHlpDeleteDriveLetter (WCHAR Letter)
{
    ...
    /**
     * Convert Nemu error code to NT status code
     *
     * @returns NT status code
     * @param   nemuRC          Nemu error code
     *
     */
NTSTATUS NemuErrorToNTStatus (int nemuRC)
{
    NTSTATUS Status;
