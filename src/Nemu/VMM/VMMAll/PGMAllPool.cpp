...
#endif
#if 0 /*defined(NEMU_STRICT) && defined(PGMPOOL_WITH_OPTIMIZED_DIRTY_PT)*/
 ...
 *
 * @returns Nemu status code suitable for scheduling.
                                       ...
                                       PCPUMCTXCORE pRegFrame, RTGCPHYS GCPhysFault, RTGCPTR pvFault)
{
     ...
     */
    NEMUSTRICTRC rc2 = EMInterpretInstructionDisasState(pVCpu, pDis, pRegFrame, pvFault, EMCODETYPE_ALL);
    if (rc2 == VINF_SUCCESS)
    { /* do nothing */ }
#ifdef NEMU_WITH_IEM
...
# endif
    ...
    else if (rc2 == VERR_EM_INTERPRETER)
    {
        ...
        AssertMsgFailed(("%Rrc\n", NEMUSTRICTRC_VAL(rc2))); /* ASSUMES no complicated stuff here. */
                                             ...
                                             PCPUMCTXCORE pRegFrame, RTGCPHYS GCPhysFault, RTGCPTR pvFault, bool *pfReused)
{
     ...
     */
    NEMUSTRICTRC rc = EMInterpretInstructionDisasState(pVCpu, pDis, pRegFrame, pvFault, EMCODETYPE_ALL);
    if (RT_SUCCESS(rc))
        AssertMsg(rc == VINF_SUCCESS, ("%Rrc\n", NEMUSTRICTRC_VAL(rc))); /* ASSUMES no complicated stuff here. */
 ...
 */
DECLEXPORT(NEMUSTRICTRC) pgmPoolAccessPfHandler(PVM pVM, PVMCPU pVCpu, RTGCUINT uErrorCode, PCPUMCTXCORE pRegFrame,
...
#if 0 /* test code defined(NEMU_STRICT) && defined(PGMPOOL_WITH_OPTIMIZED_DIRTY_PT) */
...
int pgmPoolTrackUpdateGCPhys(PVM pVM, RTGCPHYS GCPhysPage, PPGMPAGE pPhysPage, bool fFlushPTEs, bool *pfFlushTLBs)
{
    ...
    if (u16)
    {
         ...
         * have to flush the whole shebang. Unless NEMU_WITH_NEW_LAZY_PAGE_ALLOC
        ...
        {
# if defined(NEMU_WITH_2X_4GB_ADDR_SPACE_IN_R0) || defined(IN_RC) /** @todo we can drop this now. */
