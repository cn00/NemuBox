...
def SaveFileOnChange(File, Content, IsBinaryFile=True):
    ...
    try:
        if False: # Nemu: Don't want python25.dll dependencies, original: if GlobalData.gIsWindows:
            try:
...
def RealPath2(File, Dir='', OverrideDir=''):
    ...
    if GlobalData.gAllFiles:
        ...
        # Nemu hack begin - Required for RAW reset vectors and logo bmps files outside the workspace.
