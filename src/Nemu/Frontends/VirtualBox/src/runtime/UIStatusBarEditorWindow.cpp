...
/** @file
 * Nemu Qt GUI - UIStatusBarEditorWindow class implementation.
 */
...
UIStatusBarEditorWindow::UIStatusBarEditorWindow(UIMachineWindow *pParent)
    : UISlidingToolBar(pParent, pParent->statusBar(), new UIStatusBarEditorWidget(0, false, nemuGlobal().managedVMUuid()), UISlidingToolBar::Position_Bottom)
{
}
