/* $Id: NemuServicePageSharing.cpp $ */
/** @file
 * NemuService - Guest page sharing.
 */
...
/** @page pg_vgsvc_pagesharing NemuService - Page Sharing
 *
 ...
 * and therefore not actually callable for other NemuService code (may crash).
 *
...
/**
 * This gets control when NemuService is launched with "pagefusion" by
...
static DECLCALLBACK(int) vgsvcPageSharingWorkerProcess(bool volatile *pfShutdown)
{
    ...
    for (;;)
    {
        ...
        /*
         * Start a 2nd NemuService process to deal with page fusion as we do
