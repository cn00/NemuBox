...
#define NS_InitXPCOM2 NemuNsxpNS_InitXPCOM2
#define NS_ShutdownXPCOM NemuNsxpNS_ShutdownXPCOM
#define NS_NewNativeLocalFile NemuNsxpNS_NewNativeLocalFile
#define NS_GetServiceManager NemuNsxpNS_GetServiceManager
#define NS_GetComponentManager NemuNsxpNS_GetComponentManager
#define NS_GetComponentRegistrar NemuNsxpNS_GetComponentRegistrar
#define NS_GetDebug NemuNsxpNS_GetDebug
#define NS_GetMemoryManager NemuNsxpNS_GetMemoryManager
#define NS_GetTraceRefcnt NemuNsxpNS_GetTraceRefcnt
#define NS_NewLocalFile NemuNsxpNS_NewLocalFile
