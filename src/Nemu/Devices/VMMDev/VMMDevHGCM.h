/* $Id: */
/** @file
 * NemuDev - HGCM - Host-Guest Communication Manager, internal header.
 */
...
DECLCALLBACK(void) hgcmCompleted(PPDMIHGCMPORT pInterface, int32_t result, PNEMUHGCMCMD pCmdPtr);
