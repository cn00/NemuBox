...
#define NEMUVWD_VERSION_MAJOR 1
#define NEMUVWD_VERSION_MINOR 1

static EXT_API_VERSION g_NemuVWDVersion = {
        NEMUVWD_VERSION_MAJOR,
        NEMUVWD_VERSION_MINOR,
