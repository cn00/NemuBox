...
#define  NEMUGUEST_VIDEO_NAME    "NemuVideo"

/** The video inf file name */
#define  NEMUGUEST_VIDEO_INF_NAME    "NemuVideo.inf"
...
BOOL installVideoDriver(TCHAR* szDriverDir)
{
  ...
  wsprintf(DeviceInstallParams.DriverPath,
           TEXT("%ws\\%ws"),
           szDriverDir, TEXT(NEMUGUEST_VIDEO_INF_NAME));
