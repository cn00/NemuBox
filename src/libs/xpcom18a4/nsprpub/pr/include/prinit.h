...
#define PR_Abort NemuNsprPR_Abort
#define PR_Cleanup NemuNsprPR_Cleanup
#define PR_DisableClockInterrupts NemuNsprPR_DisableClockInterrupts
#define PR_EnableClockInterrupts NemuNsprPR_EnableClockInterrupts
#define PR_BlockClockInterrupts NemuNsprPR_BlockClockInterrupts
#define PR_UnblockClockInterrupts NemuNsprPR_UnblockClockInterrupts
#define PR_Init NemuNsprPR_Init
#define PR_Initialize NemuNsprPR_Initialize
#define PR_Initialized NemuNsprPR_Initialized
#define PR_VersionCheck NemuNsprPR_VersionCheck
#define PR_SetConcurrency NemuNsprPR_SetConcurrency
#define PR_SetFDCacheSize NemuNsprPR_SetFDCacheSize
#define PR_ProcessExit NemuNsprPR_ProcessExit
#define PR_CallOnce NemuNsprPR_CallOnce
#define PR_CallOnceWithArg NemuNsprPR_CallOnceWithArg
