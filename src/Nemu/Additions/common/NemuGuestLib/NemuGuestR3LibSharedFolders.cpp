/* $Id: NemuGuestR3LibSharedFolders.cpp $ */
/** @file
 * NemuGuestR3Lib - Ring-3 Support Library for VirtualBox guest additions, shared folders.
 */
...
#include <Nemu/log.h>
#include <Nemu/shflsvc.h> /** @todo File should be moved to Nemu/HostServices/SharedFolderSvc.h */
...
VBGLR3DECL(int) VbglR3SharedFolderConnect(HGCMCLIENTID *pidClient)
{
    ...
    RT_ZERO(Info.Loc.u);
    strcpy(Info.Loc.u.host.achName, "NemuSharedFolders");
