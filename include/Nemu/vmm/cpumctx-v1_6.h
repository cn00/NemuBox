...
#ifndef ___Nemu_vmm_cpumctx_v1_6_h
#define ___Nemu_vmm_cpumctx_v1_6_h
...
typedef struct NEMUIDTR_VER1_6
{
    /** Size of the IDT. */
    uint16_t    cbIdt;
    /** Address of the IDT. */
...
typedef struct NEMUGDTR_VER1_6
{
    /** Size of the GDT. */
    uint16_t    cbGdt;
    /** Address of the GDT. */
