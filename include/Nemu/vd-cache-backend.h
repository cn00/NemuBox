/** @file
 * Internal hard disk format support API for NemuHDD cache images.
 */
...
#ifndef __NemuHDD_CachePlugin_h__
#define __NemuHDD_CachePlugin_h__

#include <Nemu/vd.h>
#include <Nemu/vd-ifs-internal.h>

/**
 * Cache format backend interface used by Nemu HDD Container implementation.
 */
