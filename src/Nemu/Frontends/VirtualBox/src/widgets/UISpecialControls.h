...
/** @file
 * Nemu Qt GUI - NemuSpecialButtons declarations.
 */
...
#ifndef ___NemuSpecialControls_h__
#define ___NemuSpecialControls_h__
...
#else /* NEMU_DARWIN_USE_NATIVE_CONTROLS */
...
#endif /* ___NemuSpecialControls_h__ */
