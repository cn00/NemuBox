 ...
 * Retain an interface.
 *
 * @returns Nemu status code, can assume success in most situations.
...
#if defined(RT_OS_DARWIN) && !defined(NEMUNETADP_DO_NOT_USE_NETFLT)
            pszName = "NemuNetFlt";
#else /* NEMUNETADP_DO_NOT_USE_NETFLT */
            pszName = "NemuNetAdp";
#endif /* NEMUNETADP_DO_NOT_USE_NETFLT */
            break;
#ifndef NEMU_WITH_NAT_SERVICE
        case kIntNetTrunkType_SrvNat:
            pszName = "NemuSrvNat";
            break;
#endif
