 ...
 * without mappings there even when NEMU_WITH_RAW_MODE is not defined.
 *
 ...
 */
#if defined(IN_RING0) \
  || (   !defined(NEMU_WITH_RAW_MODE) \
      && (   HC_ARCH_BITS != 32 \
          || !defined(NEMU_WITH_64_BITS_GUESTS) \
         ) \
     )
...
/** @def NEMU_STRICT_PGM_HANDLER_VIRTUAL
 * Enables some extra assertions for virtual handlers (mainly phys2virt related).
 */
#ifdef NEMU_STRICT
# define NEMU_STRICT_PGM_HANDLER_VIRTUAL
#endif

/** @def NEMU_WITH_NEW_LAZY_PAGE_ALLOC
 * Enables the experimental lazy page allocation code. */
#ifdef DOXYGEN_RUNNING
# define NEMU_WITH_NEW_LAZY_PAGE_ALLOC
#endif

/** @def NEMU_WITH_REAL_WRITE_MONITORED_PAGES
...
#define NEMU_WITH_REAL_WRITE_MONITORED_PAGES
 ...
 * @todo Move PGM_PTFLAGS_* and PGM_PDFLAGS_* to Nemu/vmm/pgm.h. */
 ...
 */
#if defined(NEMU_WITH_2X_4GB_ADDR_SPACE_IN_R0) || defined(IN_RC)
...
#if defined(NEMU_STRICT) && 0 /** @todo triggers in pgmRZDynMapGCPageV2Inlined */
...
#if defined(__GNUC__) && defined(NEMU_STRICT)
...
#elif defined(NEMU_STRICT) || 1 /* temporarily going strict here */
...
#if defined(NEMU_WITH_2X_4GB_ADDR_SPACE) || defined(NEMU_WITH_RAW_MODE)
...
#ifdef NEMU_WITH_STATISTICS /** @todo move this chunk to the heap. */
    /** @name Statistics
     * @{ */
...
DECLCALLBACK(NEMUSTRICTRC) pgmR3PoolClearAllRendezvous(PVM pVM, PVMCPU pVCpu, void *fpvFlushRemTbl);
...
# if defined(NEMU_STRICT) && HC_ARCH_BITS == 64 && defined(IN_RING3)
