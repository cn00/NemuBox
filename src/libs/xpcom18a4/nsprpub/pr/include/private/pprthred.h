...
#define PR_AttachThread NemuNsprPR_AttachThread
#define PR_DetachThread NemuNsprPR_DetachThread
#define PR_GetThreadID NemuNsprPR_GetThreadID
#define PR_SetThreadDumpProc NemuNsprPR_SetThreadDumpProc
#define PR_GetThreadAffinityMask NemuNsprPR_GetThreadAffinityMask
#define PR_SetThreadAffinityMask NemuNsprPR_SetThreadAffinityMask
#define PR_SetCPUAffinityMask NemuNsprPR_SetCPUAffinityMask
#define PR_ShowStatus NemuNsprPR_ShowStatus
#define PR_SetThreadRecycleMode NemuNsprPR_SetThreadRecycleMode
#define PR_CreateThreadGCAble NemuNsprPR_CreateThreadGCAble
#define PR_AttachThreadGCAble NemuNsprPR_AttachThreadGCAble
#define PR_SetThreadGCAble NemuNsprPR_SetThreadGCAble
#define PR_ClearThreadGCAble NemuNsprPR_ClearThreadGCAble
#define PR_SuspendAll NemuNsprPR_SuspendAll
#define PR_ResumeAll NemuNsprPR_ResumeAll
#define PR_GetSP NemuNsprPR_GetSP
#define PR_GetGCRegisters NemuNsprPR_GetGCRegisters
#define GetExecutionEnvironment NemuNsprGetExecutionEnvironment
#define SetExecutionEnvironment NemuNsprSetExecutionEnvironment
#define PR_EnumerateThreads NemuNsprPR_EnumerateThreads
#define PR_ThreadScanStackPointers NemuNsprPR_ThreadScanStackPointers
#define PR_ScanStackPointers NemuNsprPR_ScanStackPointers
#define PR_GetStackSpaceLeft NemuNsprPR_GetStackSpaceLeft
#define PR_NewNamedMonitor NemuNsprPR_NewNamedMonitor
#define PR_TestAndLock NemuNsprPR_TestAndLock
#define PR_TestAndEnterMonitor NemuNsprPR_TestAndEnterMonitor
#define PR_GetMonitorEntryCount NemuNsprPR_GetMonitorEntryCount
#define PR_CTestAndEnterMonitor NemuNsprPR_CTestAndEnterMonitor
#define PR_Mac_WaitForAsyncNotify NemuNsprPR_Mac_WaitForAsyncNotify
#define PR_Mac_PostAsyncNotify NemuNsprPR_Mac_PostAsyncNotify
#define PR_OS2_SetFloatExcpHandler NemuNsprPR_OS2_SetFloatExcpHandler
#define PR_OS2_UnsetFloatExcpHandler NemuNsprPR_OS2_UnsetFloatExcpHandler
#define PR_XLock NemuNsprPR_XLock
#define PR_XUnlock NemuNsprPR_XUnlock
#define PR_XIsLocked NemuNsprPR_XIsLocked
#define PR_XWait NemuNsprPR_XWait
#define PR_XNotify NemuNsprPR_XNotify
#define PR_XNotifyAll NemuNsprPR_XNotifyAll
