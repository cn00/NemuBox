/* $Id: NemuVMMPreload.cpp $ */
/** @file
 * NemuVMMPreload - Preload Nemu the ring-0 modules.
 */
...
{
    { "NemuVMMR0.r0",       true,  NULL },
    { "NemuDDR0.r0",    true,  NULL },
    { "NemuDD2R0.r0",   true,  NULL },
};
...
static RTEXITCODE ParseOptions(int argc, char **argv, bool *pfExit)
{
    ...
    while ((ch = RTGetOpt(&GetState, &ValueUnion)))
    {
        switch(ch)
        {
            ...
            case 'h':
                RTPrintf(NEMU_PRODUCT " VMM ring-0 Module Preloader Version " NEMU_VERSION_STRING
                         "(C) 2005-" NEMU_C_YEAR " " NEMU_VENDOR "\n"
                         "All rights reserved.\n"
                         "\n"
                         "Usage: NemuVMMPreload [-hlqvV] [-o|--only <mod>]\n"
                         "\n");
                *pfExit = true;
