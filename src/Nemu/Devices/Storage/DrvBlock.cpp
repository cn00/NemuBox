/* $Id: DrvBlock.cpp $ */
/** @file
 * Nemu storage devices: Generic block driver
 */
 ...
 * "NemuInternal/Devices/piix3ide/0/LUN#<x>/Config/FlushInterval". <x>
...
#define NEMU_PERIODIC_FLUSH

/** @def NEMU_IGNORE_FLUSH
...
static DECLCALLBACK(int) drvblockConstruct(PPDMDRVINS pDrvIns, PCFGMNODE pCfg, uint32_t fFlags)
{
     ...
     */
#if defined(NEMU_PERIODIC_FLUSH) || defined(NEMU_IGNORE_FLUSH)
