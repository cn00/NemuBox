/* $Id: Nemu-CodingGuidelines.cpp $ */
/** @file
 * Nemu - Coding Guidelines.
 */
...
/** @page pg_nemu_guideline                 Nemu Coding Guidelines
 *
 * The Nemu Coding guidelines are followed by all of Nemu with the exception of
 ...
 *
 *
 * @section sec_nemu_guideline_compulsory       Compulsory
 *
 *
 ...
 *
 *      - All functions return Nemu status codes. There are three general
 ...
 *
 *      - Nemu status codes have three subdivisions:
 ...
 *
 *      - Headers in /include/Nemu shall not contain any slash-slash C++
 ...
 *
 *
 * @subsection sec_nemu_guideline_compulsory_sub64  64-bit and 32-bit
 *
 ...
 *
 *
 * @subsection sec_nemu_guideline_compulsory_cppmain   C++ guidelines for Main
 *
 ...
 *
 *
 * @subsection sec_nemu_guideline_compulsory_cppqtgui   C++ guidelines for the Qt GUI
 *
 ...
 *
 * - GUI classes which correspond to GUI tasks should be prefixed by UI (no Nemu anymore)
 *
 ...
 *
 *
 * @subsection sec_nemu_guideline_compulsory_xslt  XSLT
 *
 ...
 *
 *
 * @subsection sec_nemu_guideline_compulsory_doxygen    Doxygen Comments
 *
 ...
 *
 *
 * @section sec_nemu_guideline_optional         Optional
 *
 * First part is the actual coding style and all the prefixes.  The second part
 * is a bunch of good advice.
 *
 *
 * @subsection sec_nemu_guideline_optional_layout   The code layout
 *
 ...
 *
 *
 * @subsection sec_nemu_guideline_optional_prefix   Variable / Member Prefixes
 *
 ...
 *
 *
 * @subsection sec_nemu_guideline_optional_misc     Misc / Advice / Stuff
 *
 ...
 *
 *
 * @section sec_nemu_guideline_warnings     Compiler Warnings
 *
 ...
 *
 *
 * @subsection sec_nemu_guideline_warnings_signed_unsigned_compare      Signed / Unsigned Compare
 *
 ...
 *
 *
 * @section sec_nemu_guideline_svn          Subversion Commit Rules
 *
 *
 * Before checking in:
 *
 *      - Check Tinderbox and make sure the tree is green across all platforms. If it's
 *        red on a platform, don't check in. If you want, warn in the \#nemu channel and
