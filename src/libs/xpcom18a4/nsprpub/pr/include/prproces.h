...
#define PR_CreateProcessDetached NemuNsprPR_CreateProcessDetached
#define PR_ProcessAttrSetInheritableFD NemuNsprPR_ProcessAttrSetInheritableFD
#define PR_DestroyProcessAttr NemuNsprPR_DestroyProcessAttr
#define PR_NewProcessAttr NemuNsprPR_NewProcessAttr
#define PR_ResetProcessAttr NemuNsprPR_ResetProcessAttr
#define PR_ProcessAttrSetStdioRedirect NemuNsprPR_ProcessAttrSetStdioRedirect
#define PR_SetStdioRedirect NemuNsprPR_SetStdioRedirect
#define PR_ProcessAttrSetCurrentDirectory NemuNsprPR_ProcessAttrSetCurrentDirectory
#define PR_CreateProcess NemuNsprPR_CreateProcess
#define PR_DetachProcess NemuNsprPR_DetachProcess
#define PR_WaitProcess NemuNsprPR_WaitProcess
#define PR_KillProcess NemuNsprPR_KillProcess
