...
/** @file
 * Nemu Qt GUI - UIMainEventListener class declaration.
 */
...
signals:
    ...
    /** Notifies about the NemuSVC become @a fAvailable. */
    void sigNemuSVCAvailabilityChange(bool fAvailable);
...
public:
    ...
    STDMETHOD(HandleEvent)(NemuEventType_T enmType, IEvent *pEvent);
};
