...
static void WINAPI nemuDebugSetMuteStub(void)
{
}

static IDirect3D9* WINAPI nemuDirect3DCreate9Stub(UINT SDKVersion)
{
    return NULL;
}

static HRESULT WINAPI nemuDirect3DCreate9ExStub(UINT SDKVersion, IDirect3D9Ex **direct3d9ex)
{
    if (direct3d9ex)
        *direct3d9ex = NULL;
    return E_FAIL;
...
static void* WINAPI nemuDirect3DShaderValidatorCreate9Stub(void)
{
    return NULL;
}

static int WINAPI nemuD3DPERF_BeginEventStub(D3DCOLOR color, LPCWSTR name)
{
    return 0;
}

static int WINAPI nemuD3DPERF_EndEventStub(void)
{
    return 0;
}

static DWORD WINAPI nemuD3DPERF_GetStatusStub(void)
{
    return 0;
}

static void WINAPI nemuD3DPERF_SetOptionsStub(DWORD options)
{

}

static BOOL WINAPI nemuD3DPERF_QueryRepeatFrameStub(void)
{
    return 0;
}

static void WINAPI nemuD3DPERF_SetMarkerStub(D3DCOLOR color, LPCWSTR name)
{

}

static void WINAPI nemuD3DPERF_SetRegionStub(D3DCOLOR color, LPCWSTR name)
{
...
static D3D9Export g_swd3d9 = {0, "NemuD3D9-x86.dll", "MSD3D9.dll",};
#else
static D3D9Export g_swd3d9 = {0, "NemuD3D9.dll", "MSD3D9.dll",};
#endif
