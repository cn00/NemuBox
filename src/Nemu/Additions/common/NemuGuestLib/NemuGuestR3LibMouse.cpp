/* $Id: NemuGuestR3LibMouse.cpp $ */
/** @file
 * NemuGuestR3Lib - Ring-3 Support Library for VirtualBox guest additions, Mouse.
 */
...
{
    return vbglR3DoIOCtl(NEMUGUEST_IOCTL_SET_MOUSE_STATUS, &fFeatures, sizeof(fFeatures));
}
