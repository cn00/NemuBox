...
{
#ifdef NEMU_XPIDL_EMULATE_GENJIFACES_DIFF
    const char *basename;
    const char *ext;
#endif
...
#ifndef NEMU_XPIDL_EMULATE_GENJIFACES_DIFF
    /*
     * Last pass
     */
...
#endif /* NEMU_XPIDL_EMULATE_GENJIFACES */
...
#else  /* !NEMU_XPIDL_EMULATE_GENJIFACES */
