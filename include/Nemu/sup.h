...
#ifndef ___Nemu_sup_h
#define ___Nemu_sup_h
 ...
 *
 * @returns Nemu status code.
 * @deprecated  Use SUPR3LoadModule(pszFilename, "NemuVMMR0.r0", &pvImageBase)
 */
 ...
 * a little while.
 *
 * @returns Nemu status code. On failure it will have printed a LogRel message.
 *
 ...
 *
 * @returns Nemu status code.  On failure
 *          message.
 ...
 * no symbolic linking.
 *
 * @returns Nemu status code. On failure a message will be stored in @a pszErr.
 *
