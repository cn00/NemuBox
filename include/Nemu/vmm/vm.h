...
#ifndef ___Nemu_vmm_vm_h
#define ___Nemu_vmm_vm_h
...
# include <Nemu/sup.h>
#else
# pragma D depends_on library nemu-types.d
 ...
 *
 * Run 'kmk run-struct-tests' (from src/Nemu/VMM if you like) after updating!
 */
...
#define VMMR0_MAIN_MODULE_NAME          "NemuVMMR0.r0"

/**
 * Wrapper macro for avoiding too much \#ifdef NEMU_WITH_RAW_MODE.
 */
