 ...
 * @param   rc      The return value on failure. Use VERR_GVMM_INSTANCE for Nemu
 *                  status codes.
 */
                            ...
                            if (RT_SUCCESS(rc))
                            {
                                ...
                                if (RT_SUCCESS(rc))
                                {
                                    ...
                                    if (RT_SUCCESS(rc))
                                    {
                                        ...
                                        if (RT_SUCCESS(rc))
                                        {
                                            NEMUVMM_R0_GVMM_VM_CREATED(pGVM, pVM, ProcId, (void *)hEMT0, cCpus);
 ...
 *
 * @returns Nemu status code, no informational stuff.
 *
 * @param   pVM                 The cross context VM structure.
