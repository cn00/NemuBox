...
/** Convenience typedef. */
typedef NemuMainDriveInfo::DriveInfoList DriveInfoList;
/** Convenience typedef. */
typedef NemuMainDriveInfo::DriveInfo DriveInfo;

/** Implementation of the hotplug waiter class below */
class NemuMainHotplugWaiterImpl
{
public:
    NemuMainHotplugWaiterImpl(void) {}
    virtual ~NemuMainHotplugWaiterImpl(void) {}
    /** @copydoc NemuMainHotplugWaiter::Wait */
    virtual int Wait(RTMSINTERVAL cMillies) = 0;
    /** @copydoc NemuMainHotplugWaiter::Interrupt */
    virtual void Interrupt(void) = 0;
    /** @copydoc NemuMainHotplugWaiter::getStatus */
 ...
 */
class NemuMainHotplugWaiter
{
    /** Class implementation. */
    NemuMainHotplugWaiterImpl *mImpl;
public:
    /** Constructor.  Responsible for selecting the implementation. */
    NemuMainHotplugWaiter(const char *pcszDevicesRoot);
    /** Destructor. */
    ~NemuMainHotplugWaiter (void)
    {
        delete mImpl;
    }
    /**
