...
static void ARRAYSPU_APIENTRY
arrayspu_NemuAttachThread()
{
    crStateNemuAttachThread();
    array_spu.child.NemuAttachThread();
}

static void ARRAYSPU_APIENTRY
arrayspu_NemuDetachThread()
{
    crStateNemuDetachThread();
    array_spu.child.NemuDetachThread();
}
...
SPUNamedFunctionTable _cr_array_table[] = {
    ...
    { "NemuAttachThread", (SPUGenericFunction) arrayspu_NemuAttachThread},
    { "NemuDetachThread", (SPUGenericFunction) arrayspu_NemuDetachThread},
    { NULL, NULL }
};
