...
/** @file
 * Nemu audio devices: Pulse Audio audio driver.
 */
...
#define NEMU_PULSEAUDIO_MAX_LOG_REL_ERRORS 32 /** @todo Make this configurable thru driver options. */
...
static int drvHostPulseAudioError(PDRVHOSTPULSEAUDIO pThis, const char *szMsg)
{
    ...
    if (pThis->cLogErrors++ < NEMU_PULSEAUDIO_MAX_LOG_REL_ERRORS)
    {
