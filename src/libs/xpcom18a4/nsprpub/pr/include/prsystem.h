...
#define PR_GetDirectorySeparator NemuNsprPR_GetDirectorySeparator
#define PR_GetDirectorySepartor NemuNsprPR_GetDirectorySepartor
#define PR_GetPathSeparator NemuNsprPR_GetPathSeparator
#define PR_GetSystemInfo NemuNsprPR_GetSystemInfo
#define PR_GetPageSize NemuNsprPR_GetPageSize
#define PR_GetPageShift NemuNsprPR_GetPageShift
#define PR_GetNumberOfProcessors NemuNsprPR_GetNumberOfProcessors
