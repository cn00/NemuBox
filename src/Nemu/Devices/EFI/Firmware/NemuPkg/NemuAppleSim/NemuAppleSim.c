/* $Id: NemuAppleSim.c $ */
/** @file
 * NemuAppleSim.c - VirtualBox Apple Firmware simulation support
 */
 ...
 */
EFI_STATUS EFIAPI
NemuInitAppleSim(IN EFI_HANDLE ImageHandle, IN EFI_SYSTEM_TABLE *SystemTable)
{
    EFI_STATUS          rc;
    UINT64              FSBFrequency;
    UINT64              TSCFrequency;
...
EFI_STATUS EFIAPI
NemuDeinitAppleSim(IN EFI_HANDLE         ImageHandle)
{
    return EFI_SUCCESS;
}
