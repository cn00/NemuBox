...
*********************************************************************************************************************************/
/** The IOClass key of the service (see NemuUSB.cpp / Info.plist). */
#define IOCLASS_NAME    "org_virtualbox_NemuUSB"
...
USBLIB_DECL(int) USBLibInit(void)
{
    ...
    /*
     * Open the service.
     * This will cause the user client class in NemuUSB.cpp to be instantiated.
     */
    kr = IOServiceOpen(ServiceObject, mach_task_self(), NEMUUSB_DARWIN_IOSERVICE_COOKIE, &g_Connection);
...
{
    NEMUUSBADDFILTEROUT Out = { 0, VERR_WRONG_ORDER };
