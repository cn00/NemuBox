/* $Id: NemuManageGuestCtrlListener.cpp $ */
/** @file
 * NemuManage - Guest control listener implementations.
 */
...
STDMETHODIMP GuestFileEventListener::HandleEvent(NemuEventType_T aType, IEvent *aEvent)
{
    switch (aType)
    {
...
STDMETHODIMP GuestProcessEventListener::HandleEvent(NemuEventType_T aType, IEvent *aEvent)
{
    switch (aType)
    {
...
STDMETHODIMP GuestSessionEventListener::HandleEvent(NemuEventType_T aType, IEvent *aEvent)
{
    switch (aType)
    {
        case NemuEventType_OnGuestFileRegistered:
        {
            HRESULT rc;
            do
            {
        ...
        case NemuEventType_OnGuestProcessRegistered:
        {
            HRESULT rc;
            do
            {
...
STDMETHODIMP GuestEventListener::HandleEvent(NemuEventType_T aType, IEvent *aEvent)
{
    switch (aType)
    {
        case NemuEventType_OnGuestSessionRegistered:
        {
            HRESULT rc;
            do
            {
                ...
                if (fRegistered)
                {
                    ...
                    com::SafeArray<NemuEventType_T> eventTypes;
                    eventTypes.push_back(NemuEventType_OnGuestFileRegistered);
                    eventTypes.push_back(NemuEventType_OnGuestProcessRegistered);
                    CHECK_ERROR_BREAK(es, RegisterListener(pListener, ComSafeArrayAsInParam(eventTypes),
                                                           true /* Active listener */));
