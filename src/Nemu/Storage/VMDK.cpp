...
typedef struct VMDKIMAGE
{
    ...
    /** Open flags passed by NemuHD layer. */
    unsigned        uOpenFlags;
...
#ifdef NEMU_WITH_VMDK_STRICT_SIZE_CHECK
...
#endif /* NEMU_WITH_VMDK_STRICT_SIZE_CHECK */
    if (pExtent->enmType != VMDKETYPE_HOSTED_SPARSE)
        goto out;
 ...
 */
static int vmdkCreateRawImage(PVMDKIMAGE pImage, const PNEMUHDDRAW pRaw,
                              uint64_t cbSize)
{
    int rc = VINF_SUCCESS;
    PVMDKEXTENT pExtent;

    if (pRaw->uFlags & NEMUHDDRAW_DISK)
    {
        ...
        pExtent->enmAccess = (pRaw->uFlags & NEMUHDDRAW_READONLY) ? VMDKACCESS_READONLY : VMDKACCESS_READWRITE;
    ...
    else
    {
        ...
        {
            PNEMUHDDRAWPARTDESC pPart = &pRaw->pPartDescs[i];
        ...
        for (unsigned i = 0; i < pRaw->cPartDescs; i++)
        {
            ...
            else
            {
                if (pPart->pszRawDevice)
                {
                    ...
                    pExtent->enmAccess = (pPart->uFlags & NEMUHDDRAW_READONLY) ? VMDKACCESS_READONLY : VMDKACCESS_READWRITE;
                    pExtent->fMetaDirty = false;
                           ...
                           unsigned uPercentStart, unsigned uPercentSpan)
{
        ...
        &&  (uImageFlags & VD_VMDK_IMAGE_FLAGS_RAWDISK))
    {
        ...
        const PNEMUHDDRAW pRaw = (const PNEMUHDDRAW)pszComment;
                                ...
                                uint64_t cbWrite)
{
    ...
    /* Zero byte write optimization. Since we don't tell NemuHDD that we need
...
/** @copydoc NEMUHDDBACKEND::pfnCheckIfValid */
...
/** @copydoc NEMUHDDBACKEND::pfnOpen */
...
/** @copydoc NEMUHDDBACKEND::pfnCreate */
...
/** @copydoc NEMUHDDBACKEND::pfnRename */
...
/** @copydoc NEMUHDDBACKEND::pfnClose */
...
/** @copydoc NEMUHDDBACKEND::pfnRead */
...
/** @copydoc NEMUHDDBACKEND::pfnWrite */
...
/** @copydoc NEMUHDDBACKEND::pfnFlush */
...
/** @copydoc NEMUHDDBACKEND::pfnGetVersion */
...
/** @copydoc NEMUHDDBACKEND::pfnGetSectorSize */
...
/** @copydoc NEMUHDDBACKEND::pfnGetSize */
...
/** @copydoc NEMUHDDBACKEND::pfnGetFileSize */
...
/** @copydoc NEMUHDDBACKEND::pfnGetPCHSGeometry */
...
/** @copydoc NEMUHDDBACKEND::pfnSetPCHSGeometry */
...
/** @copydoc NEMUHDDBACKEND::pfnGetLCHSGeometry */
...
/** @copydoc NEMUHDDBACKEND::pfnSetLCHSGeometry */
...
/** @copydoc NEMUHDDBACKEND::pfnGetImageFlags */
...
/** @copydoc NEMUHDDBACKEND::pfnGetOpenFlags */
...
/** @copydoc NEMUHDDBACKEND::pfnSetOpenFlags */
...
/** @copydoc NEMUHDDBACKEND::pfnGetComment */
...
/** @copydoc NEMUHDDBACKEND::pfnSetComment */
...
/** @copydoc NEMUHDDBACKEND::pfnGetUuid */
...
/** @copydoc NEMUHDDBACKEND::pfnSetUuid */
...
/** @copydoc NEMUHDDBACKEND::pfnGetModificationUuid */
...
/** @copydoc NEMUHDDBACKEND::pfnSetModificationUuid */
...
/** @copydoc NEMUHDDBACKEND::pfnGetParentUuid */
...
/** @copydoc NEMUHDDBACKEND::pfnSetParentUuid */
...
/** @copydoc NEMUHDDBACKEND::pfnGetParentModificationUuid */
...
/** @copydoc NEMUHDDBACKEND::pfnSetParentModificationUuid */
...
/** @copydoc NEMUHDDBACKEND::pfnDump */
...
const NEMUHDDBACKEND g_VmdkBackend =
{
    /* pszBackendName */
    "VMDK",
    /* cbSize */
