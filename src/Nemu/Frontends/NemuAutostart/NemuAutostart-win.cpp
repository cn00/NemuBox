...
*********************************************************************************************************************************/
/** The service name. */
#define AUTOSTART_SERVICE_NAME             "NemuAutostartSvc"
...
{
    HANDLE hEventLog = RegisterEventSourceA(NULL /* local computer */, "NemuAutostartSvc");
    AssertReturnVoid(hEventLog != NULL);
    WORD wType = 0;
    const char *apsz[2];
    apsz[0] = "NemuAutostartSvc";
    apsz[1] = pszMsg;
...
{
    RTPrintf("NemuAutostartSvc: The \"interrogate\" action is not implemented.\n");
...
{
    RTPrintf("NemuAutostartSvc: The \"stop\" action is not implemented.\n");
    return RTEXITCODE_FAILURE;
}
...
{
    RTPrintf("NemuAutostartSvc: The \"continue\" action is not implemented.\n");
    return RTEXITCODE_FAILURE;
}
...
{
    RTPrintf("NemuAutostartSvc: The \"pause\" action is not implemented.\n");
    return RTEXITCODE_FAILURE;
}
...
{
    RTPrintf("NemuAutostartSvc: The \"start\" action is not implemented.\n");
...
{
    RTPrintf("NemuAutostartSvc: The \"qdescription\" action is not implemented.\n");
    return RTEXITCODE_FAILURE;
}
...
{
    RTPrintf("NemuAutostartSvc: The \"qconfig\" action is not implemented.\n");
    return RTEXITCODE_FAILURE;
}
...
{
    RTPrintf("NemuAutostartSvc: The \"disable\" action is not implemented.\n");
    return RTEXITCODE_FAILURE;
}

static RTEXITCODE autostartSvcWinEnable(int argc, char **argv)
{
    RTPrintf("NemuAutostartSvc: The \"enable\" action is not implemented.\n");
    return RTEXITCODE_FAILURE;
}
...
static RTEXITCODE autostartSvcWinShowHelp(void)
{
    ...
    RTPrintf("Usage:\n"
             ...
             "NemuAutostartSvc\n"
             "      Runs the service.\n"
             "NemuAutostartSvc <version|-v|--version> [-brief]\n"
             "      Displays the version.\n"
             "NemuAutostartSvc <help|-?|-h|--help> [...]\n"
             "      Displays this help screen.\n"
             "\n"
             "NemuAutostartSvc <install|/RegServer|/i>\n"
             "      Installs the service.\n"
             "NemuAutostartSvc <uninstall|delete|/UnregServer|/u>\n"
...
/**
 * NemuAutostart main(), Windows edition.
 *
 *
