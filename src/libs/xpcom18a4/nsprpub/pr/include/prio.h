...
#define PR_GetInheritedFD NemuNsprPR_GetInheritedFD
#define PR_SetFDInheritable NemuNsprPR_SetFDInheritable
#define PR_Access NemuNsprPR_Access
#define PR_Open NemuNsprPR_Open
#define PR_Read NemuNsprPR_Read
#define PR_Write NemuNsprPR_Write
#define PR_Seek NemuNsprPR_Seek
#define PR_Seek64 NemuNsprPR_Seek64
#define PR_Poll NemuNsprPR_Poll
#define PR_NewPollableEvent NemuNsprPR_NewPollableEvent
#define PR_SetPollableEvent NemuNsprPR_SetPollableEvent
#define PR_WaitForPollableEvent NemuNsprPR_WaitForPollableEvent
#define PR_DestroyPollableEvent NemuNsprPR_DestroyPollableEvent
#define PR_Close NemuNsprPR_Close
#define PR_GetSpecialFD NemuNsprPR_GetSpecialFD
#define PR_Connect NemuNsprPR_Connect
#define PR_OpenTCPSocket NemuNsprPR_OpenTCPSocket
#define PR_SetSocketOption NemuNsprPR_SetSocketOption
#define PR_Bind NemuNsprPR_Bind
#define PR_Listen NemuNsprPR_Listen
#define PR_Accept NemuNsprPR_Accept
#define PR_AcceptRead NemuNsprPR_AcceptRead
#define PR_OpenDir NemuNsprPR_OpenDir
#define PR_ReadDir NemuNsprPR_ReadDir
#define PR_CloseDir NemuNsprPR_CloseDir
#define PR_CreatePipe NemuNsprPR_CreatePipe
#define PR_GetDescType NemuNsprPR_GetDescType
#define PR_GetSpecialFD NemuNsprPR_GetSpecialFD
#define PR_GetUniqueIdentity NemuNsprPR_GetUniqueIdentity
#define PR_GetNameForIdentity NemuNsprPR_GetNameForIdentity
#define PR_GetLayersIdentity NemuNsprPR_GetLayersIdentity
#define PR_GetIdentitiesLayer NemuNsprPR_GetIdentitiesLayer
#define PR_GetDefaultIOMethods NemuNsprPR_GetDefaultIOMethods
#define PR_CreateIOLayerStub NemuNsprPR_CreateIOLayerStub
#define PR_CreateIOLayer NemuNsprPR_CreateIOLayer
#define PR_PushIOLayer NemuNsprPR_PushIOLayer
#define PR_PopIOLayer NemuNsprPR_PopIOLayer
#define PR_OpenFile NemuNsprPR_OpenFile
#define PR_Writev NemuNsprPR_Writev
#define PR_Delete NemuNsprPR_Delete
#define PR_Rename NemuNsprPR_Rename
#define PR_GetFileInfo NemuNsprPR_GetFileInfo
#define PR_GetFileInfo64 NemuNsprPR_GetFileInfo64
#define PR_GetOpenFileInfo NemuNsprPR_GetOpenFileInfo
#define PR_GetOpenFileInfo64 NemuNsprPR_GetOpenFileInfo64
#define PR_Available NemuNsprPR_Available
#define PR_Available64 NemuNsprPR_Available64
#define PR_Sync NemuNsprPR_Sync
#define PR_MkDir NemuNsprPR_MkDir
#define PR_MakeDir NemuNsprPR_MakeDir
#define PR_RmDir NemuNsprPR_RmDir
#define PR_NewUDPSocket NemuNsprPR_NewUDPSocket
#define PR_NewTCPSocket NemuNsprPR_NewTCPSocket
#define PR_OpenUDPSocket NemuNsprPR_OpenUDPSocket
#define PR_OpenTCPSocket NemuNsprPR_OpenTCPSocket
#define PR_ConnectContinue NemuNsprPR_ConnectContinue
#define PR_GetConnectStatus NemuNsprPR_GetConnectStatus
#define PR_Shutdown NemuNsprPR_Shutdown
#define PR_Recv NemuNsprPR_Recv
#define PR_Send NemuNsprPR_Send
#define PR_RecvFrom NemuNsprPR_RecvFrom
#define PR_SendTo NemuNsprPR_SendTo
#define PR_TransmitFile NemuNsprPR_TransmitFile
#define PR_SendFile NemuNsprPR_SendFile
#define PR_NewTCPSocketPair NemuNsprPR_NewTCPSocketPair
#define PR_GetSockName NemuNsprPR_GetSockName
#define PR_GetPeerName NemuNsprPR_GetPeerName
#define PR_GetSocketOption NemuNsprPR_GetSocketOption
#define PR_CreateFileMap NemuNsprPR_CreateFileMap
#define PR_GetMemMapAlignment NemuNsprPR_GetMemMapAlignment
#define PR_MemMap NemuNsprPR_MemMap
#define PR_MemUnmap NemuNsprPR_MemUnmap
#define PR_CloseFileMap NemuNsprPR_CloseFileMap
#define PR_CreatePipe NemuNsprPR_CreatePipe
