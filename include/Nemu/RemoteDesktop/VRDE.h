/** @file
 * Nemu Remote Desktop Extension (VRDE) - Public APIs.
 */
...
#ifndef ___Nemu_RemoteDesktop_VRDE_h
#define ___Nemu_RemoteDesktop_VRDE_h
...
#define VRDE_USB_XFER_ERR   (12) /* Nemu protocol error. */
