...
#ifndef ___Nemu_HostService_GuestPropertyService_h
#define ___Nemu_HostService_GuestPropertyService_h
...
{
    NemuGuestHGCMCallInfoTimed hdr;
...
#endif  /* !___Nemu_HostService_GuestPropertySvc_h */
