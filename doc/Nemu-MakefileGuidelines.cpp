/* $Id: Nemu-MakefileGuidelines.cpp $ */
/** @file
 * Nemu - Makefile Guidelines.
 */
...
/** @page pg_nemu_makefile_guidelines      Nemu Makefile Guidelines
 *
 ...
 *
 *
 * @section sec_nemu_makefile_guidelines_kbuild         kBuild
 *
 ...
 *
 *
 * @section sec_nemu_makefile_guidelines_example        Example Makefiles
 *
 * Let me point to some good sample makefiles:
 *      - src/Nemu/Additions/common/NemuService/Makefile.kmk
 *      - src/Nemu/Debugger/Makefile.kmk
 *      - src/Nemu/Disassembler/Makefile.kmk
 *
 * And some bad ones:
 *      - src/lib/xpcom18a4/Makefile.kmk
 *      - src/recompiler/Makefile.kmk
 *      - src/Nemu/Devices/Makefile.kmk
 *      - src/Nemu/Main/Makefile.kmk
 *      - src/Nemu/Runtime/Makefile.kmk
 *
 *
 * @section sec_nemu_makefile_guidelines                Guidelines
 *
 ...
 *
 *      - Template names starts with NEMU and are all upper cased, no
 *        underscores or other separators. (TODO: Change this to camel case.)
 *
 *      - Makefile variables shall be prefixed with NEMU or VB to avoid clashes
 ...
 *
 *      - Always use templates (mytarget_TEMPLATE = NEMUSOMETHING).
 *
 ...
 *        src/Nemu/Debugger/Makefile.kmk. I.e. exactly one tab, the file name /
 ...
 *
 *
 * @section sec_nemu_makefile_guidelines_reminders      Helpful reminders
 *
 ...
 *
 *      - You can build individual targets: kmk NemuRT
 *
