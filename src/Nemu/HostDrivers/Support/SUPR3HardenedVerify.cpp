...
static SUPINSTFILE const    g_aSupInstallFiles[] =
{
    ...
    /* ---------------------------------------------------------------------- */
    {   kSupIFT_Dll,  kSupID_AppPrivArch,       false, "NemuVMMR0.r0" },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,       false, "NemuDDR0.r0" },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,       false, "NemuDD2R0.r0" },

#ifdef NEMU_WITH_RAW_MODE
    {   kSupIFT_Rc,   kSupID_AppPrivArch,       false, "VMMRC.rc" },
    {   kSupIFT_Rc,   kSupID_AppPrivArch,       false, "NemuDDRC.rc" },
    {   kSupIFT_Rc,   kSupID_AppPrivArch,       false, "NemuDD2RC.rc" },
#endif

    {   kSupIFT_Dll,  kSupID_AppSharedLib,      false, "NemuRT" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppSharedLib,      false, "NemuVMM" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppSharedLib,      false, "NemuREM" SUPLIB_DLL_SUFF },
#if HC_ARCH_BITS == 32
    {   kSupIFT_Dll,  kSupID_AppSharedLib,       true, "NemuREM32" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppSharedLib,       true, "NemuREM64" SUPLIB_DLL_SUFF },
#endif
    {   kSupIFT_Dll,  kSupID_AppSharedLib,      false, "NemuDD" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppSharedLib,      false, "NemuDD2" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppSharedLib,      false, "NemuDDU" SUPLIB_DLL_SUFF },

//#ifdef NEMU_WITH_DEBUGGER_GUI
    {   kSupIFT_Dll,  kSupID_AppSharedLib,       true, "NemuDbg" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppSharedLib,       true, "NemuDbg3" SUPLIB_DLL_SUFF },
//#endif

//#ifdef NEMU_WITH_SHARED_CLIPBOARD
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "NemuSharedClipboard" SUPLIB_DLL_SUFF },
//#endif
//#ifdef NEMU_WITH_SHARED_FOLDERS
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "NemuSharedFolders" SUPLIB_DLL_SUFF },
//#endif
//#ifdef NEMU_WITH_DRAG_AND_DROP
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "NemuDragAndDropSvc" SUPLIB_DLL_SUFF },
//#endif
//#ifdef NEMU_WITH_GUEST_PROPS
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "NemuGuestPropSvc" SUPLIB_DLL_SUFF },
//#endif
//#ifdef NEMU_WITH_GUEST_CONTROL
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "NemuGuestControlSvc" SUPLIB_DLL_SUFF },
//#endif
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "NemuHostChannel" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "NemuSharedCrOpenGL" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "NemuOGLhostcrutil" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "NemuOGLhosterrorspu" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "NemuOGLrenderspu" SUPLIB_DLL_SUFF },

    {   kSupIFT_Exe,  kSupID_AppBin,             true, "NemuManage" SUPLIB_EXE_SUFF },

#ifdef NEMU_WITH_MAIN
    {   kSupIFT_Exe,  kSupID_AppBin,            false, "NemuSVC" SUPLIB_EXE_SUFF },
 #ifdef RT_OS_WINDOWS
    {   kSupIFT_Dll,  kSupID_AppSharedLib,      false, "NemuC" SUPLIB_DLL_SUFF },
 #else
    {   kSupIFT_Exe,  kSupID_AppPrivArch,       false, "NemuXPCOMIPCD" SUPLIB_EXE_SUFF },
    {   kSupIFT_Dll,  kSupID_AppSharedLib,      false, "NemuXPCOM" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArchComp,   false, "NemuXPCOMIPCC" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArchComp,   false, "NemuC" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArchComp,   false, "NemuSVCM" SUPLIB_DLL_SUFF },
    {   kSupIFT_Data, kSupID_AppPrivArchComp,   false, "NemuXPCOMBase.xpt" },
 #endif
#endif

    {   kSupIFT_Dll,  kSupID_AppSharedLib,       true, "VRDPAuth" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppSharedLib,       true, "NemuAuth" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppSharedLib,       true, "NemuVRDP" SUPLIB_DLL_SUFF },

//#ifdef NEMU_WITH_HEADLESS
    {   kSupIFT_Exe,  kSupID_AppBin,             true, "NemuHeadless" SUPLIB_EXE_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "NemuHeadless" SUPLIB_DLL_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "NemuVideoRecFB" SUPLIB_DLL_SUFF },
//#endif
...
# if !defined(RT_OS_DARWIN) && !defined(RT_OS_WINDOWS) && !defined(RT_OS_OS2)
    {   kSupIFT_Dll,  kSupID_AppSharedLib,       true, "NemuKeyboard" SUPLIB_DLL_SUFF },
# endif
//#endif

//#ifdef NEMU_WITH_NEMUSDL
    {   kSupIFT_Exe,  kSupID_AppBin,             true, "NemuSDL" SUPLIB_EXE_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "NemuSDL" SUPLIB_DLL_SUFF },
//#endif

//#ifdef NEMU_WITH_WEBSERVICES
    {   kSupIFT_Exe,  kSupID_AppBin,             true, "nemuwebsrv" SUPLIB_EXE_SUFF },
//#endif

#ifdef RT_OS_LINUX
    {   kSupIFT_Exe,  kSupID_AppBin,             true, "NemuTunctl" SUPLIB_EXE_SUFF },
#endif

//#ifdef NEMU_WITH_NETFLT
    {   kSupIFT_Exe,  kSupID_AppBin,             true, "NemuNetDHCP" SUPLIB_EXE_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "NemuNetDHCP" SUPLIB_DLL_SUFF },
//#endif

//#ifdef NEMU_WITH_LWIP_NAT
    {   kSupIFT_Exe,  kSupID_AppBin,             true, "NemuNetNAT" SUPLIB_EXE_SUFF },
    {   kSupIFT_Dll,  kSupID_AppPrivArch,        true, "NemuNetNAT" SUPLIB_DLL_SUFF },
//#endif
...
{
# if defined(NEMU_WITH_HARDENING) && !defined(IN_SUP_R3_STATIC) /* Latter: Not in NemuCpuReport and friends. */
 ...
 *
 * @returns Nemu status code, error buffer filled on failure.
...
# ifdef NEMU_WITH_HARDENING
        ...
        if (   pszSuffix
            ...
            &&                   pszSuffix[3]  == '\0' )
            fFlags |= SUPHNTVI_F_RC_IMAGE;
#  ifndef IN_SUP_R3_STATIC /* Not in NemuCpuReport and friends. */
 ...
 *
 * @returns Nemu status code. Will not bitch on failure since the
