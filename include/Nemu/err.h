...
#ifndef ___Nemu_err_h
#define ___Nemu_err_h

#include <Nemu/cdefs.h>
#include <iprt/err.h>


/** @defgroup grp_err       Nemu Error Codes
 * @{
 */
 ...
 * Returned by pfnInit in NemuService to indicated a non-fatal error that
...
#define VERR_SSM_INTEGRITY_NEMU_VERSION         (-1820)
...
/** @name Nemu Remote Desktop Protocol (VRDP) Status Codes
 * @{
 */
...
/** The NemuVMMR0.r0 module version does not match NemuVMM.dll/so/dylib.
 * If you just upgraded VirtualBox, please terminate all VMs and make sure
 * that neither NemuNetDHCP nor NemuNetNAT is running.  Then try again.
 * If this error persists, try re-installing VirtualBox. */
#define VERR_VMM_R0_VERSION_MISMATCH        (-2704)
/** The VMMRC.rc module version does not match NemuVMM.dll/so/dylib.
 ...
 * to this Nemu version. Either mixing incompatible versions or
...
/** @name Nemu HDD Container (VD) Status Codes
 * @{
 */
/** Invalid image type. */
...
/** @name Nemu Guest Library (VBGL) Status Codes
 * @{
 */
...
/** IOCtl to NemuGuest driver failed. */
#define VERR_VBGL_IOCTL_FAILED                      (-3302)
/** @} */


/** @name Nemu USB (VUSB) Status Codes
 * @{
 */
...
/** The VM process was denied access to nemudrv because someone have managed to
...
/** The process trying to open NemuDrv is not a budding VM process (1). */
#define VERR_SUPDRV_NOT_BUDDING_VM_PROCESS_1        (-3748)
/** The process trying to open NemuDrv is not a budding VM process (2). */
...
/** @name Nemu Disassembler Status Codes
 * @{
 */
...
/** @name Nemu Webservice Status Codes
 * @{
 */
...
/** @name Nemu Video HW Acceleration command status
 * @{
 */
...
/** @name Nemu COM error codes
 *
 * @remarks Global::nemuStatusCodeToCOM and Global::nemuStatusCodeFromCOM uses
 ...
 * corresponding 1:1 to NEMU_E_XXX.  This is the lowest value. */
#define VERR_COM_NEMU_LOWEST                        (-4699)
/** Object corresponding to the supplied arguments does not exist. */
#define VERR_COM_OBJECT_NOT_FOUND                   (VERR_COM_NEMU_LOWEST + 1)
/** Current virtual machine state prevents the operation. */
#define VERR_COM_INVALID_VM_STATE                   (VERR_COM_NEMU_LOWEST + 2)
/** Virtual machine error occurred attempting the operation. */
#define VERR_COM_VM_ERROR                           (VERR_COM_NEMU_LOWEST + 3)
/** File not accessible or erroneous file contents. */
#define VERR_COM_FILE_ERROR                         (VERR_COM_NEMU_LOWEST + 4)
/** IPRT error. */
#define VERR_COM_IPRT_ERROR                         (VERR_COM_NEMU_LOWEST + 5)
/** Pluggable Device Manager error. */
#define VERR_COM_PDM_ERROR                          (VERR_COM_NEMU_LOWEST + 6)
/** Current object state prohibits operation. */
#define VERR_COM_INVALID_OBJECT_STATE               (VERR_COM_NEMU_LOWEST + 7)
/** Host operating system related error. */
#define VERR_COM_HOST_ERROR                         (VERR_COM_NEMU_LOWEST + 8)
/** Requested operation is not supported. */
#define VERR_COM_NOT_SUPPORTED                      (VERR_COM_NEMU_LOWEST + 9)
/** Invalid XML found. */
#define VERR_COM_XML_ERROR                          (VERR_COM_NEMU_LOWEST + 10)
/** Current session state prohibits operation. */
#define VERR_COM_INVALID_SESSION_STATE              (VERR_COM_NEMU_LOWEST + 11)
/** Object being in use prohibits operation. */
#define VERR_COM_OBJECT_IN_USE                      (VERR_COM_NEMU_LOWEST + 12)
/** Returned by callback methods which does not need to be called
 * again because the client does not actually make use of them. */
#define VERR_COM_DONT_CALL_AGAIN                    (VERR_COM_NEMU_LOWEST + 13)
/** @} */

/** @name Nemu VMMDev Status codes
 * @{
 */
...
/** @name Nemu async I/O manager Status Codes
 * @{
 */
...
/** @name Nemu Virtual SCSI Status Codes
 * @{
 */
...
/** Stub process not found so it cannot be revalidated when nemudrv is opened
 * by the VM process. */
#define VERR_SUP_VP_STUB_NOT_FOUND                  (-5669)
/** Error opening the stub process for revalidation when nemudrv is opened by
 *  the VM process. */
#define VERR_SUP_VP_STUB_OPEN_ERROR                 (-5670)
/** Stub process thread not found during revalidation upon nemudrv opening by
 * the VM process. */
#define VERR_SUP_VP_STUB_THREAD_NOT_FOUND           (-5671)
/** Error opening the stub process thread for revalidation when nemudrv is
...
/** @name Nemu Extension Pack Status Codes
 * @{
 */
/** The host is not supported. Uninstall the extension pack.
 * Returned by the NEMUEXTPACKREG::pfnInstalled. */
 ...
 */
#define VERR_EXTPACK_NEMU_VERSION_MISMATCH          (-6001)
/** @} */


/** @name Nemu Guest Control Status Codes
 * @{
 */
...
/** @name Nemu Drag and Drop Status Codes
 * @{
 */
/** Guest side reported an error. */
