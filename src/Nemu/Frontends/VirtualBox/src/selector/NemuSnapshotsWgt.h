/* $Id: NemuSnapshotsWgt.h $ */
/** @file
 * Nemu Qt GUI - NemuSnapshotsWgt class declaration.
 */
...
#ifndef __NemuSnapshotsWgt_h__
#define __NemuSnapshotsWgt_h__
...
/* GUI includes: */
#include "NemuSnapshotsWgt.gen.h"
...
class NemuSnapshotsWgt : public QIWithRetranslateUI <QWidget>, public Ui::NemuSnapshotsWgt
{
    Q_OBJECT;

public:

    NemuSnapshotsWgt (QWidget *aParent);
