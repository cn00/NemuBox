...
typedef enum
{
     ...
     * Next Nemu: CapturingForVM, CapturingForProxy.
     */
     ...
     *
     * Next Host: PhysDetached.
     * Next Nemu: HeldByProxy or AttachingToVM on success,
     ...
     *            No filters.
     * Next Nemu: PhysDetached (timeout), HeldByProxy (failure).
     */
     ...
     *
     * Next Host: PhysDetachingFromVM.
     * Next Nemu: UsedByGuest, HeldByProxy (failure).
     */
     ...
     * Next Nemu: ReleasingToHost, HeldByProxy.
     */
    kHostUSBDeviceState_DetachingFromVM,

    /** The device has been physically removed while a VM used it.
     *
     * This is the device state while NemuSVC is doing IPC to the client (VM) telling it
     * to detach it.
     *
     * Next Host: None.
     * Next Nemu: PhysDetached
     */
