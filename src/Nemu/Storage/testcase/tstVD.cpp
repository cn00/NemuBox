/* $Id: tstVD.cpp $ */
/** @file
 * Simple Nemu HDD container test utility.
 */
...
static void writeSegmentsToDisk(PNEMUHDD pVD, void *pvBuf, PSEGMENT pSegment)
{
...
static int readAndCompareSegments(PNEMUHDD pVD, void *pvBuf, PSEGMENT pSegment)
{
    while (pSegment->u32Length)
    {
