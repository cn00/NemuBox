...
HRESULT Mouse::init (ConsoleMouseInterface *parent)
{
    ...
    mMouseEvent.init(mEventSource, NemuEventType_OnGuestMouse,
                     0, 0, 0, 0, 0, 0);
                             ...
                             LONG fButtons)
{
    ...
    if (fButtons != 0)
    {
        ...
        evDesc.init(mEventSource, NemuEventType_OnGuestMouse, mode, x, y,
                    dz, dw, fButtons);
        evDesc.fire(0);
    }
    else
    {
        mMouseEvent.reinit(NemuEventType_OnGuestMouse, mode, x, y, dz, dw,
                           fButtons);
        mMouseEvent.fire(0);
    }
}
                                  ...
                                  uint32_t u32ScanTime)
{
    ...
    NemuEventDesc evDesc;
    evDesc.init(mEventSource, NemuEventType_OnGuestMultiTouch,
