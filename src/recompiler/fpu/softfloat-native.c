...
void set_float_rounding_mode(int val STATUS_PARAM)
{
    ...
    (defined(CONFIG_SOLARIS) && (CONFIG_SOLARIS_VERSION < 10 || CONFIG_SOLARIS_VERSION == 11)) /* NEMU adds sol 11 */
    fpsetround(val);
#else
    fesetround(val);
#endif
...
# if defined(NEMU) && defined(HOST_BSD) /* Some defines which only apply to *BSD */
