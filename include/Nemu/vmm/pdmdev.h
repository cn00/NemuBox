 ...
 *
 * This structure is used when registering a device from NemuInitDevices() in HC
...
typedef struct PDMDEVHLPR3
{
     ...
     *
     * @returns Nemu status code which must be passed up to the VMM.
     * @param   pDevIns             The device instance.
     ...
     *
     * This is used by the macros found in Nemu/vmm/dbgftrace.h and is not
     ...
     * Resets the VM.
     *
     * @returns The appropriate Nemu status code to pass around on reset.
     * @param   pDevIns             The device instance.
     * @thread  The emulation thread.
     */
     ...
     * Suspends the VM.
     *
     * @returns The appropriate Nemu status code to pass around on suspend.
     * @param   pDevIns             The device instance.
     * @thread  The emulation thread.
     */
     ...
     *
     * @returns The appropriate Nemu status code to pass around.
     * @param   pDevIns             The device instance.
     ...
     * Power off the VM.
     *
     * @returns The appropriate Nemu status code to pass around on power off.
     * @param   pDevIns             The device instance.
     * @thread  The emulation thread.
     */
...
/**
 * NEMU_STRICT wrapper for pHlp->pfnDBGFStopV.
 *
 * @returns Nemu status code which must be passed up to the VMM.  This will be
...
/** Pointer to callbacks provided to the NemuDeviceRegister() call. */
typedef struct PDMDEVREGCB *PPDMDEVREGCB;

/**
 * Callbacks for NemuDeviceRegister().
 */
...
/**
 * The NemuDevicesRegister callback function.
 *
 ...
 */
typedef DECLCALLBACK(int) FNPDMNEMUDEVICESREGISTER(PPDMDEVREGCB pCallbacks, uint32_t u32Version);
