...
#ifndef ___Nemu_vmm_patm_h
#define ___Nemu_vmm_patm_h
...
VMMRC_INT_DECL(NEMUSTRICTRC)    PATMRCHandleWriteToPatchPage(PVM pVM, PCPUMCTXCORE pRegFrame, RTRCPTR GCPtr, uint32_t cbWrite);
