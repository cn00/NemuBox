...
#define PR_CreateThreadPool NemuNsprPR_CreateThreadPool
#define PR_QueueJobPR_QueueJob_Read NemuNsprPR_QueueJobPR_QueueJob_Read
#define PR_QueueJob NemuNsprPR_QueueJob
#define PR_QueueJob_Read NemuNsprPR_QueueJob_Read
#define PR_QueueJob_Write NemuNsprPR_QueueJob_Write
#define PR_QueueJob_Accept NemuNsprPR_QueueJob_Accept
#define PR_QueueJob_Connect NemuNsprPR_QueueJob_Connect
#define PR_QueueJob_Timer NemuNsprPR_QueueJob_Timer
#define PR_CancelJob NemuNsprPR_CancelJob
#define PR_JoinJob NemuNsprPR_JoinJob
#define PR_ShutdownThreadPool NemuNsprPR_ShutdownThreadPool
#define PR_JoinThreadPool NemuNsprPR_JoinThreadPool
