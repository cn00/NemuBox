...
# include "NemuDTraceLibCWrappers.h"
...
#ifndef NEMU /* stdout isn't a necessarily constant usable like this in C code. */
...
#ifdef NEMU
DECLEXPORT(int) RTCALL NemuDTraceMain(int argc, char **argv)
#else
int
