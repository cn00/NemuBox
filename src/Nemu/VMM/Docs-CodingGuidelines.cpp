 ...
 *
 * The guidelines extends the Nemu coding guidelines (@ref pg_nemu_guideline)
 ...
 *     extension).
 *
 * (2) The Nemu integer types are RTINT, RTUINT, RTGCINT, RTGCUINT,
 ...
 *
 * There are the general Nemu guidelines, see @ref sec_nemu_guideline_optional.
