...
#define XPT_NewHeader NemuNsxpXPT_NewHeader
#define XPT_NewStringZ NemuNsxpXPT_NewStringZ
#define XPT_NewAnnotation NemuNsxpXPT_NewAnnotation
#define XPT_SizeOfHeaderBlock NemuNsxpXPT_SizeOfHeaderBlock
#define XPT_NewInterfaceDescriptor NemuNsxpXPT_NewInterfaceDescriptor
#define XPT_FillInterfaceDirectoryEntry NemuNsxpXPT_FillInterfaceDirectoryEntry
#define XPT_FillMethodDescriptor NemuNsxpXPT_FillMethodDescriptor
#define XPT_FreeHeader NemuNsxpXPT_FreeHeader
#define XPT_ParseVersionString NemuNsxpXPT_ParseVersionString
#define XPT_DestroyInterfaceDirectoryEntry NemuNsxpXPT_DestroyInterfaceDirectoryEntry
#define XPT_FillParamDescriptor NemuNsxpXPT_FillParamDescriptor
#define XPT_FreeInterfaceDescriptor NemuNsxpXPT_FreeInterfaceDescriptor
#define XPT_InterfaceDescriptorAddConsts NemuNsxpXPT_InterfaceDescriptorAddConsts
#define XPT_InterfaceDescriptorAddMethods NemuNsxpXPT_InterfaceDescriptorAddMethods
#define XPT_InterfaceDescriptorAddTypes NemuNsxpXPT_InterfaceDescriptorAddTypes
#define XPT_GetInterfaceIndexByName NemuNsxpXPT_GetInterfaceIndexByName
#define XPT_NewString NemuNsxpXPT_NewString
#define XPT_SizeOfHeader NemuNsxpXPT_SizeOfHeader
