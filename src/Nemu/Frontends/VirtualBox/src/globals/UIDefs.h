/* $Id: UIDefs.h $ */
/** @file
 * Nemu Qt GUI - Global definitions.
 */
...
#ifndef NEMU_WITH_PRECOMPILED_HEADERS
/* Define GUI log group.
 * This define should go *before* Nemu/log.h include: */
...
namespace UIDefs
{
    ...
    extern QStringList NemuFileExts;
    extern QStringList NemuExtPackFileExts;
