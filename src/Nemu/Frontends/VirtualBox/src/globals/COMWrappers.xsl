...
<xsl:template name="declareEnums">
    ...
    <xsl:text> *&#x0A;</xsl:text>
    <xsl:text> * Source    : src/Nemu/Main/idl/VirtualBox.xidl&#x0A;</xsl:text>
    <xsl:text> * Generator : src/Nemu/Frontends/VirtualBox/src/globals/COMWrappers.xsl&#x0A;</xsl:text>
    <xsl:text> */&#x0A;&#x0A;</xsl:text>
