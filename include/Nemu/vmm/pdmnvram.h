...
#ifndef ___Nemu_vmm_pdmnvram_h_
#define ___Nemu_vmm_pdmnvram_h_
...
typedef struct PDMINVRAMCONNECTOR
{
     ...
     *
     * @returns Nemu status code, @a rc on success.
     * @param   pInterance      Pointer to this interface structure.
     * @param   rc              The Nemu status code for the whole store operation.
     */
