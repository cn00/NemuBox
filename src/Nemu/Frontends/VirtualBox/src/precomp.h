/* $Id: precomp.h $*/
/** @file
 * Nemu Qt GUI - Header used if NEMU_WITH_PRECOMPILED_HEADERS is active.
 */
...
#include <Nemu/NemuCocoa.h>
#include <Nemu/NemuGL2D.h>
//#include <Nemu/NemuKeyboard.h> - includes X11/X.h which causes trouble.
//#include <Nemu/NemuOGL.h> - only used once
//#include <Nemu/NemuVideo.h> - only used twice
#ifdef NEMU_WITH_VIDEOHWACCEL
//# include <Nemu/NemuVideo3D.h> - only used once
#endif
...
//#include <Nemu/err.h> - don't include err.h!
#include <Nemu/log.h>
#include <Nemu/sup.h>
//#include <Nemu/vd.h> - only used once
#include <Nemu/version.h>
#ifdef NEMU_WITH_VIDEOHWACCEL
//# include <Nemu/vmm/ssm.h> - only used once
#endif
...
/* Note! X.h and Xlib.h shall not be included as they may redefine None and
         Status respectively, both are user in Nemu enums.  Don't bother
...
/*
 * VirtualBox Qt GUI - Nemu* headers.
 */
#include "NemuAboutDlg.h"
//#include "NemuCocoaHelper.h"
//#include "NemuCocoaSpecialControls.h"
...
#include "NemuGuestRAMSlider.h"
//#include "NemuIChatTheaterWrapper.h"
