...
for func_name in keys:
    ...
    if func_name in commoncall_special:
        print "extern %s nemuDD_gl%s( %s );" % (return_type, func_name,
                                                apiutil.MakeDeclarationString( params ))
    else:
        if apiutil.MakeDeclarationString(params)=="void":
            print "extern %s nemuDD_gl%s( GLcontext *ctx );" % (return_type, func_name)
        else:
            print "extern %s nemuDD_gl%s( GLcontext *ctx, %s );" % (return_type, func_name,
                                                                    apiutil.MakeDeclarationString( params ))
