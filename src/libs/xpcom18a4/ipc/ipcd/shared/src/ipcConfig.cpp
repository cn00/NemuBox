...
#ifdef NEMU
static const char kDefaultSocketPrefix[] = "\\socket\\nemu-";
#else
...
#else
#ifdef NEMU
static const char kDefaultSocketPrefix[] = "/tmp/.nemu-";
#else
...
void IPC_GetDefaultSocketPath(char *buf, PRUint32 bufLen)
{
    ...
    logName = PR_GetEnv("NEMU_IPC_SOCKETID");
#if defined(NEMU) && defined(XP_UNIX)
