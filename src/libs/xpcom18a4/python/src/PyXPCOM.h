...
# ifdef _XOPEN_SOURCE
#  define NEMU_XOPEN_SOURCE_DEFINED _XOPEN_SOURCE
#  undef _XOPEN_SOURCE
# endif
...
# if !defined(_XOPEN_SOURCE) && defined(NEMU_XOPEN_SOURCE_DEFINED)
#  define _XOPEN_SOURCE NEMU_XOPEN_SOURCE_DEFINED
# endif
# undef NEMU_XOPEN_SOURCE_DEFINED
