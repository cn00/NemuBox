...
void HostDnsMonitor::pollGlobalExtraData()
{
    ...
    if (m->virtualbox && (uNow - m->uLastExtraDataPoll >= RT_NS_30SEC || m->uLastExtraDataPoll == 0))
    {
         ...
         */
        const com::Bstr bstrHostDNSOrderIgnoreKey("NemuInternal2/HostDNSOrderIgnore");
         ...
         */
        const com::Bstr bstrHostDNSSuffixesIgnoreKey("NemuInternal2/HostDNSSuffixesIgnore");
