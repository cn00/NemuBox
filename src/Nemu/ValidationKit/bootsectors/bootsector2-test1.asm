...
;   NemuManage setextradata bs-test1 NemuInternal/Devices/VMMDev/0/Config/TestingEnabled  1
;   NemuManage setextradata bs-test1 NemuInternal/Devices/VMMDev/0/Config/TestingMMIO  1
;
...
%include "Nemu/VMMDevTesting.mac"
