...
typedef struct NEMUGUESTCTRL_BUFFER_VALUE
{
    char *pszValue;
} NEMUGUESTCTRL_BUFFER_VALUE, *PNEMUGUESTCTRL_BUFFER_VALUE;
typedef std::map< RTCString, NEMUGUESTCTRL_BUFFER_VALUE > GuestBufferMap;
typedef std::map< RTCString, NEMUGUESTCTRL_BUFFER_VALUE >::iterator GuestBufferMapIter;
typedef std::map< RTCString, NEMUGUESTCTRL_BUFFER_VALUE >::const_iterator GuestBufferMapIterConst;
