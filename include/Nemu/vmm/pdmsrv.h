...
#ifndef ___Nemu_vmm_pdmsrv_h
#define ___Nemu_vmm_pdmsrv_h
 ...
 * NemuServicesRegister() (HC Ring-3). PDM will continue use till
...
/** Pointer to callbacks provided to the NemuServiceRegister() call. */
typedef struct PDMSRVREGCB *PPDMSRVREGCB;

/**
 * Callbacks for NemuServiceRegister().
 */
...
/**
 * The NemuServicesRegister callback function.
 *
 ...
 */
typedef DECLCALLBACK(int) FNPDMNEMUSERVICESREGISTER(PPDMSRVREGCB pCallbacks, uint32_t u32Version);
