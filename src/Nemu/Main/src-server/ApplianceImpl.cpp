...
g_osTypes[] =
{
    { ovf::CIMOSType_CIMOS_Unknown,                              NEMUOSTYPE_Unknown },
    { ovf::CIMOSType_CIMOS_OS2,                                  NEMUOSTYPE_OS2 },
    { ovf::CIMOSType_CIMOS_OS2,                                  NEMUOSTYPE_OS2Warp3 },
    { ovf::CIMOSType_CIMOS_OS2,                                  NEMUOSTYPE_OS2Warp4 },
    { ovf::CIMOSType_CIMOS_OS2,                                  NEMUOSTYPE_OS2Warp45 },
    { ovf::CIMOSType_CIMOS_MSDOS,                                NEMUOSTYPE_DOS },
    { ovf::CIMOSType_CIMOS_WIN3x,                                NEMUOSTYPE_Win31 },
    { ovf::CIMOSType_CIMOS_WIN95,                                NEMUOSTYPE_Win95 },
    { ovf::CIMOSType_CIMOS_WIN98,                                NEMUOSTYPE_Win98 },
    { ovf::CIMOSType_CIMOS_WINNT,                                NEMUOSTYPE_WinNT },
    { ovf::CIMOSType_CIMOS_WINNT,                                NEMUOSTYPE_WinNT4 },
    { ovf::CIMOSType_CIMOS_NetWare,                              NEMUOSTYPE_Netware },
    { ovf::CIMOSType_CIMOS_NovellOES,                            NEMUOSTYPE_Netware },
    { ovf::CIMOSType_CIMOS_Solaris,                              NEMUOSTYPE_Solaris },
    { ovf::CIMOSType_CIMOS_SunOS,                                NEMUOSTYPE_Solaris },
    { ovf::CIMOSType_CIMOS_FreeBSD,                              NEMUOSTYPE_FreeBSD },
    { ovf::CIMOSType_CIMOS_NetBSD,                               NEMUOSTYPE_NetBSD },
    { ovf::CIMOSType_CIMOS_QNX,                                  NEMUOSTYPE_QNX },
    { ovf::CIMOSType_CIMOS_Windows2000,                          NEMUOSTYPE_Win2k },
    { ovf::CIMOSType_CIMOS_WindowsMe,                            NEMUOSTYPE_WinMe },
    { ovf::CIMOSType_CIMOS_OpenBSD,                              NEMUOSTYPE_OpenBSD },
    { ovf::CIMOSType_CIMOS_WindowsXP,                            NEMUOSTYPE_WinXP },
    { ovf::CIMOSType_CIMOS_WindowsXPEmbedded,                    NEMUOSTYPE_WinXP },
    { ovf::CIMOSType_CIMOS_WindowsEmbeddedforPointofService,     NEMUOSTYPE_WinXP },
    { ovf::CIMOSType_CIMOS_MicrosoftWindowsServer2003,           NEMUOSTYPE_Win2k3 },
    { ovf::CIMOSType_CIMOS_MicrosoftWindowsServer2003_64,        NEMUOSTYPE_Win2k3_x64 },
    { ovf::CIMOSType_CIMOS_WindowsXP_64,                         NEMUOSTYPE_WinXP_x64 },
    { ovf::CIMOSType_CIMOS_WindowsVista,                         NEMUOSTYPE_WinVista },
    { ovf::CIMOSType_CIMOS_WindowsVista_64,                      NEMUOSTYPE_WinVista_x64 },
    { ovf::CIMOSType_CIMOS_MicrosoftWindowsServer2008,           NEMUOSTYPE_Win2k8 },
    { ovf::CIMOSType_CIMOS_MicrosoftWindowsServer2008_64,        NEMUOSTYPE_Win2k8_x64 },
    { ovf::CIMOSType_CIMOS_FreeBSD_64,                           NEMUOSTYPE_FreeBSD_x64 },
    { ovf::CIMOSType_CIMOS_MACOS,                                NEMUOSTYPE_MacOS },
    { ovf::CIMOSType_CIMOS_MACOS,                                NEMUOSTYPE_MacOS_x64 }, // there is no CIM 64-bit type for this
    { ovf::CIMOSType_CIMOS_MACOS,                                NEMUOSTYPE_MacOS106 },
    { ovf::CIMOSType_CIMOS_MACOS,                                NEMUOSTYPE_MacOS106_x64 },
    { ovf::CIMOSType_CIMOS_MACOS,                                NEMUOSTYPE_MacOS107_x64 },
    { ovf::CIMOSType_CIMOS_MACOS,                                NEMUOSTYPE_MacOS108_x64 },
    { ovf::CIMOSType_CIMOS_MACOS,                                NEMUOSTYPE_MacOS109_x64 },
    { ovf::CIMOSType_CIMOS_MACOS,                                NEMUOSTYPE_MacOS1010_x64 },
    { ovf::CIMOSType_CIMOS_MACOS,                                NEMUOSTYPE_MacOS1011_x64 },

    // Linuxes
    { ovf::CIMOSType_CIMOS_RedHatEnterpriseLinux,                NEMUOSTYPE_RedHat },
    { ovf::CIMOSType_CIMOS_RedHatEnterpriseLinux_64,             NEMUOSTYPE_RedHat_x64 },
    { ovf::CIMOSType_CIMOS_Solaris_64,                           NEMUOSTYPE_Solaris_x64 },
    { ovf::CIMOSType_CIMOS_SUSE,                                 NEMUOSTYPE_OpenSUSE },
    { ovf::CIMOSType_CIMOS_SLES,                                 NEMUOSTYPE_OpenSUSE },
    { ovf::CIMOSType_CIMOS_NovellLinuxDesktop,                   NEMUOSTYPE_OpenSUSE },
    { ovf::CIMOSType_CIMOS_SUSE_64,                              NEMUOSTYPE_OpenSUSE_x64 },
    { ovf::CIMOSType_CIMOS_SLES_64,                              NEMUOSTYPE_OpenSUSE_x64 },
    { ovf::CIMOSType_CIMOS_LINUX,                                NEMUOSTYPE_Linux },
    { ovf::CIMOSType_CIMOS_LINUX,                                NEMUOSTYPE_Linux22 },
    { ovf::CIMOSType_CIMOS_SunJavaDesktopSystem,                 NEMUOSTYPE_Linux },
    { ovf::CIMOSType_CIMOS_TurboLinux,                           NEMUOSTYPE_Turbolinux },
    { ovf::CIMOSType_CIMOS_TurboLinux_64,                        NEMUOSTYPE_Turbolinux_x64 },
    { ovf::CIMOSType_CIMOS_Mandriva,                             NEMUOSTYPE_Mandriva },
    { ovf::CIMOSType_CIMOS_Mandriva_64,                          NEMUOSTYPE_Mandriva_x64 },
    { ovf::CIMOSType_CIMOS_Ubuntu,                               NEMUOSTYPE_Ubuntu },
    { ovf::CIMOSType_CIMOS_Ubuntu_64,                            NEMUOSTYPE_Ubuntu_x64 },
    { ovf::CIMOSType_CIMOS_Debian,                               NEMUOSTYPE_Debian },
    { ovf::CIMOSType_CIMOS_Debian_64,                            NEMUOSTYPE_Debian_x64 },
    { ovf::CIMOSType_CIMOS_Linux_2_4_x,                          NEMUOSTYPE_Linux24 },
    { ovf::CIMOSType_CIMOS_Linux_2_4_x_64,                       NEMUOSTYPE_Linux24_x64 },
    { ovf::CIMOSType_CIMOS_Linux_2_6_x,                          NEMUOSTYPE_Linux26 },
    { ovf::CIMOSType_CIMOS_Linux_2_6_x_64,                       NEMUOSTYPE_Linux26_x64 },
    { ovf::CIMOSType_CIMOS_Linux_64,                             NEMUOSTYPE_Linux26_x64 },

    // types that we have support for but CIM doesn't
    { ovf::CIMOSType_CIMOS_Linux_2_6_x,                          NEMUOSTYPE_ArchLinux },
    { ovf::CIMOSType_CIMOS_Linux_2_6_x_64,                       NEMUOSTYPE_ArchLinux_x64 },
    { ovf::CIMOSType_CIMOS_Linux_2_6_x,                          NEMUOSTYPE_FedoraCore },
    { ovf::CIMOSType_CIMOS_Linux_2_6_x_64,                       NEMUOSTYPE_FedoraCore_x64 },
    { ovf::CIMOSType_CIMOS_Linux_2_6_x,                          NEMUOSTYPE_Gentoo },
    { ovf::CIMOSType_CIMOS_Linux_2_6_x_64,                       NEMUOSTYPE_Gentoo_x64 },
    { ovf::CIMOSType_CIMOS_Linux_2_6_x,                          NEMUOSTYPE_Xandros },
    { ovf::CIMOSType_CIMOS_Linux_2_6_x_64,                       NEMUOSTYPE_Xandros_x64 },
    { ovf::CIMOSType_CIMOS_Solaris,                              NEMUOSTYPE_OpenSolaris },
    { ovf::CIMOSType_CIMOS_Solaris_64,                           NEMUOSTYPE_OpenSolaris_x64 },

    // types added with CIM 2.25.0 follow:
    { ovf::CIMOSType_CIMOS_WindowsServer2008R2,                  NEMUOSTYPE_Win2k8 },           // duplicate, see above
//     { ovf::CIMOSType_CIMOS_VMwareESXi = 104,                                                 // we can't run ESX in a VM
    { ovf::CIMOSType_CIMOS_Windows7,                             NEMUOSTYPE_Win7 },
    { ovf::CIMOSType_CIMOS_Windows7,                             NEMUOSTYPE_Win7_x64 },         // there is no
                                                                                                // CIM 64-bit type for this
    { ovf::CIMOSType_CIMOS_CentOS,                               NEMUOSTYPE_RedHat },
    { ovf::CIMOSType_CIMOS_CentOS_64,                            NEMUOSTYPE_RedHat_x64 },
    { ovf::CIMOSType_CIMOS_OracleEnterpriseLinux,                NEMUOSTYPE_Oracle },
    { ovf::CIMOSType_CIMOS_OracleEnterpriseLinux_64,             NEMUOSTYPE_Oracle_x64 },
    { ovf::CIMOSType_CIMOS_eComStation,                          NEMUOSTYPE_ECS }

    // there are no CIM types for these, so these turn to "other" on export:
    //      NEMUOSTYPE_OpenBSD
    //      NEMUOSTYPE_OpenBSD_x64
    //      NEMUOSTYPE_NetBSD
    //      NEMUOSTYPE_NetBSD_x64
...
{
    {"Windows NT",    NEMUOSTYPE_WinNT4},
    {"Windows XP",    NEMUOSTYPE_WinXP},
    {"Windows 2000",  NEMUOSTYPE_Win2k},
    {"Windows 2003",  NEMUOSTYPE_Win2k3},
    {"Windows Vista", NEMUOSTYPE_WinVista},
    {"Windows 2008",  NEMUOSTYPE_Win2k8},
    {"SUSE",          NEMUOSTYPE_OpenSUSE},
    {"Novell",        NEMUOSTYPE_OpenSUSE},
    {"Red Hat",       NEMUOSTYPE_RedHat},
    {"Mandriva",      NEMUOSTYPE_Mandriva},
    {"Ubuntu",        NEMUOSTYPE_Ubuntu},
    {"Debian",        NEMUOSTYPE_Debian},
    {"QNX",           NEMUOSTYPE_QNX},
    {"Linux 2.4",     NEMUOSTYPE_Linux24},
    {"Linux 2.6",     NEMUOSTYPE_Linux26},
    {"Linux",         NEMUOSTYPE_Linux},
    {"OpenSolaris",   NEMUOSTYPE_OpenSolaris},
    {"Solaris",       NEMUOSTYPE_OpenSolaris},
    {"FreeBSD",       NEMUOSTYPE_FreeBSD},
    {"NetBSD",        NEMUOSTYPE_NetBSD},
    {"Windows 95",    NEMUOSTYPE_Win95},
    {"Windows 98",    NEMUOSTYPE_Win98},
    {"Windows Me",    NEMUOSTYPE_WinMe},
    {"Windows 3.",    NEMUOSTYPE_Win31},
    {"DOS",           NEMUOSTYPE_DOS},
    {"OS2",           NEMUOSTYPE_OS2}
};
...
{
    {"Windows XP",    NEMUOSTYPE_WinXP_x64},
    {"Windows 2003",  NEMUOSTYPE_Win2k3_x64},
    {"Windows Vista", NEMUOSTYPE_WinVista_x64},
    {"Windows 2008",  NEMUOSTYPE_Win2k8_x64},
    {"SUSE",          NEMUOSTYPE_OpenSUSE_x64},
    {"Novell",        NEMUOSTYPE_OpenSUSE_x64},
    {"Red Hat",       NEMUOSTYPE_RedHat_x64},
    {"Mandriva",      NEMUOSTYPE_Mandriva_x64},
    {"Ubuntu",        NEMUOSTYPE_Ubuntu_x64},
    {"Debian",        NEMUOSTYPE_Debian_x64},
    {"Linux 2.4",     NEMUOSTYPE_Linux24_x64},
    {"Linux 2.6",     NEMUOSTYPE_Linux26_x64},
    {"Linux",         NEMUOSTYPE_Linux26_x64},
    {"OpenSolaris",   NEMUOSTYPE_OpenSolaris_x64},
    {"Solaris",       NEMUOSTYPE_OpenSolaris_x64},
    {"FreeBSD",       NEMUOSTYPE_FreeBSD_x64},
};
 ...
 * @param cStr
 */
void convertCIMOSType2NemuOSType(Utf8Str &strType, ovf::CIMOSType_T c, const Utf8Str &cStr)
{
    ...
    if (c == ovf::CIMOSType_CIMOS_Other_64)
        strType = Global::OSTypeId(NEMUOSTYPE_Unknown_x64);
    else
        strType = Global::OSTypeId(NEMUOSTYPE_Unknown);
}
 ...
 * for the given OVF operating system type.
 * @returns CIM OS type.
 * @param pcszNemu  Our guest OS type identifier string.
 * @param fLongMode Whether long mode is enabled and a 64-bit CIM type is
 *                  preferred even if the Nemu guest type isn't 64-bit.
 */
ovf::CIMOSType_T convertNemuOSType2CIMOSType(const char *pcszNemu, BOOL fLongMode)
{
    for (size_t i = 0; i < RT_ELEMENTS(g_osTypes); ++i)
    {
        if (!RTStrICmp(pcszNemu, Global::OSTypeId(g_osTypes[i].osType)))
        {
            if (fLongMode && !(g_osTypes[i].osType & NEMUOSTYPE_x64))
            {
                NEMUOSTYPE enmDesiredOsType = (NEMUOSTYPE)((int)g_osTypes[i].osType | (int)NEMUOSTYPE_x64);
                size_t     j = i;
...
bool Appliance::i_isApplianceIdle()
{
    if (m->state == Data::ApplianceImporting)
        setError(NEMU_E_INVALID_OBJECT_STATE, tr("The appliance is busy importing files"));
    else if (m->state == Data::ApplianceExporting)
        setError(NEMU_E_INVALID_OBJECT_STATE, tr("The appliance is busy exporting files"));
    else
        return true;
...
HRESULT Appliance::i_searchUniqueVMName(Utf8Str& aName) const
{
    ...
    while (mVirtualBox->FindMachine(Bstr(tmpName).raw(), &machine) != NEMU_E_OBJECT_NOT_FOUND)
    {
        RTStrFree(tmpName);
...
HRESULT Appliance::i_searchUniqueDiskImageFilePath(Utf8Str& aName) const
{
    ...
    while (    RTPathExists(tmpName)
            || mVirtualBox->OpenMedium(Bstr(tmpName).raw(), DeviceType_HardDisk, AccessMode_ReadWrite,
                                       FALSE /* fForceNewUuid */,  &harddisk) != NEMU_E_OBJECT_NOT_FOUND)
    {
        RTStrFree(tmpName);
...
HRESULT VirtualSystemDescription::getDescription(std::vector<VirtualSystemDescriptionType_T> &aTypes,
                                                 ...
                                                 std::vector<com::Utf8Str> &aNemuValues,
...

{
    ...
    for (size_t i = 0; i < c; i++)
    {
        ...
        aNemuValues[i] = vsde.strNemuCurrent;
                                                  ...
                                                  std::vector<com::Utf8Str> &aValues)
{
         ...
         ++it, ++i)
    {
        ...
        switch (aWhich)
        {
            ...
            case VirtualSystemDescriptionValueType_Auto: aValues[i]  = vsde->strNemuCurrent; break;
...
HRESULT VirtualSystemDescription::setFinalValues(const std::vector<BOOL> &aEnabled,
                                                 const std::vector<com::Utf8Str> &aNemuValues,
                                                 const std::vector<com::Utf8Str> &aExtraConfigValues)
{
    ...
    if (    (aEnabled.size() != m->maDescriptions.size())
         || (aNemuValues.size() != m->maDescriptions.size())
         ...
         ++it, ++i)
    {
        ...
        if (aEnabled[i])
        {
            vsde.strNemuCurrent = aNemuValues[i];
...
HRESULT VirtualSystemDescription::addDescription(VirtualSystemDescriptionType_T aType,
                                                 const com::Utf8Str &aNemuValue,
                                                 const com::Utf8Str &aExtraConfigValue)

{
    AutoWriteLock alock(this COMMA_LOCKVAL_SRC_POS);
    i_addEntry(aType, "", aNemuValue, aNemuValue, 0, aExtraConfigValue);
    return S_OK;
}
                                          ...
                                          const Utf8Str &strExtraConfig /*= ""*/)
{
    ...
    vsde.strNemuSuggested           // remember original value
        = vsde.strNemuCurrent       // and set current value which can be overridden by setFinalValues()
        = aNemuValue;
 ...
 * contains a <nemu:Machine> element. This method then attempts to parse that and
 ...
 *
 * @param elmMachine <nemu:Machine> element with attributes and subelements from some
 *                  DOM tree.
 */
void VirtualSystemDescription::i_importNemuMachineXML(const xml::ElementNode &elmMachine)
{
...
/**
 * Returns the machine config created by importNemuMachineXML() or NULL if there's none.
 * @return
 */
