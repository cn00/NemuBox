...
# Generator: src/Nemu/Main/webservice/websrv-typemap.xsl
...
# Main namespace (which is mapped to nemu__ prefixes):
]]></xsl:text>
  <xsl:value-of select="concat('nemu = &quot;', $G_targetNamespace, '&quot;')" />
  <xsl:text>
