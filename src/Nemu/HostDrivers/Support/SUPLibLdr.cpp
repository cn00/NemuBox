                                                    ...
                                                    const char *pszSymbol, unsigned uSymbol, RTUINTPTR *pValue, void *pvUser)
{
    ...
    /*
     * Only SUPR0 and NemuVMMR0.r0
     */
    if (    pszModule
        &&  *pszModule
        &&  strcmp(pszModule, "NemuDrv.sys")
        &&  strcmp(pszModule, "NemuVMMR0.r0"))
    {
        AssertMsgFailed(("%s is importing from %s! (expected 'SUPR0.dll' or 'NemuVMMR0.r0', case-sensitive)\n", pArgs->pszModule, pszModule));
    ...
    /*
     * Check the NemuVMMR0.r0 module if loaded.
     */
                         ...
                         PRTERRINFO pErrInfo, void **ppvImageBase)
{
    ...
    const bool fIsVMMR0 = !strcmp(pszModule, "NemuVMMR0.r0");
...
{
    void *pvImageBase;
    return SUPR3LoadModule(pszFilename, "NemuVMMR0.r0", &pvImageBase, NULL /*pErrInfo*/);
}
