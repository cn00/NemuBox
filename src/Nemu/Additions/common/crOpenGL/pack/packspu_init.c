...
#if defined(RT_OS_WINDOWS) && defined(NEMU_WITH_WDDM)
static bool isNemuWDDMCrHgsmi(void)
{
#if defined(NEMU_WITH_CRHGSMI) && defined(IN_GUEST)
...
#endif /* RT_OS_WINDOWS && NEMU_WITH_WDDM */
                         ...
                         unsigned int num_contexts )
{
    ...
    packspuSetNemuConfiguration( child );

#if defined(WINDOWS) && defined(NEMU_WITH_WDDM)
    pack_spu.bIsWDDMCrHgsmi = isNemuWDDMCrHgsmi();
#endif
