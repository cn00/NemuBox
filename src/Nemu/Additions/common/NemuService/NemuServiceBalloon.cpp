/* $Id: NemuServiceBalloon.cpp $ */
/** @file
 * NemuService - Memory Ballooning.
 */
...
/** @page pg_vgsvc_memballoon NemuService - Memory Ballooning
 *
 * The Memory Ballooning subservice works with NemuGuest, PGM and GMM to
 ...
 * NemuGuest allocates kernel memory and donates it to the host, or this service
 * allocates process memory which NemuGuest then locks down and donates to the
