...
#define PR_SetError NemuNsprPR_SetError
#define PR_SetErrorText NemuNsprPR_SetErrorText
#define PR_GetError NemuNsprPR_GetError
#define PR_GetOSError NemuNsprPR_GetOSError
#define PR_GetErrorTextLength NemuNsprPR_GetErrorTextLength
#define PR_GetErrorText NemuNsprPR_GetErrorText
#define PR_ErrorToString NemuNsprPR_ErrorToString
#define PR_ErrorToName NemuNsprPR_ErrorToName
#define PR_ErrorLanguages NemuNsprPR_ErrorLanguages
#define PR_ErrorInstallTable NemuNsprPR_ErrorInstallTable
#define PR_ErrorInstallCallback NemuNsprPR_ErrorInstallCallback
