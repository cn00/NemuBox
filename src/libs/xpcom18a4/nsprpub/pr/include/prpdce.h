...
#define PRP_DestroyNakedCondVar NemuNsprPRP_DestroyNakedCondVar
#define PRP_NakedBroadcast NemuNsprPRP_NakedBroadcast
#define PRP_NakedNotify NemuNsprPRP_NakedNotify
#define PRP_NakedWait NemuNsprPRP_NakedWait
#define PRP_NewNakedCondVar NemuNsprPRP_NewNakedCondVar
#define PRP_TryLock NemuNsprPRP_TryLock
