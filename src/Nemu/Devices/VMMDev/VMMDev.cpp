 ...
 *
 * The main kernel component of the guest additions, NemuGuest, sets up a timer
...
#include <Nemu/err.h>
#include <Nemu/vmm/vm.h> /* for VM_IS_EMT */
#include <Nemu/dbg.h>
...
#endif
#ifndef NEMU_WITHOUT_TESTING_FEATURES
...
#define VMMDEV_SAVED_STATE_VERSION_NEMU_30                      11
...
#ifndef NEMU_DEVICE_STRUCT_TESTCASE
 ...
 */
static void vmmdevLogGuestOsInfo(NemuGuestInfo *pGuestInfo)
{
    const char *pszOs;
    switch (pGuestInfo->osType & ~NEMUOSTYPE_x64)
    {
        case NEMUOSTYPE_DOS:                              pszOs = "DOS";            break;
        case NEMUOSTYPE_Win31:                            pszOs = "Windows 3.1";    break;
        case NEMUOSTYPE_Win9x:                            pszOs = "Windows 9x";     break;
        case NEMUOSTYPE_Win95:                            pszOs = "Windows 95";     break;
        case NEMUOSTYPE_Win98:                            pszOs = "Windows 98";     break;
        case NEMUOSTYPE_WinMe:                            pszOs = "Windows Me";     break;
        case NEMUOSTYPE_WinNT:                            pszOs = "Windows NT";     break;
        case NEMUOSTYPE_WinNT4:                           pszOs = "Windows NT4";    break;
        case NEMUOSTYPE_Win2k:                            pszOs = "Windows 2k";     break;
        case NEMUOSTYPE_WinXP:                            pszOs = "Windows XP";     break;
        case NEMUOSTYPE_Win2k3:                           pszOs = "Windows 2k3";    break;
        case NEMUOSTYPE_WinVista:                         pszOs = "Windows Vista";  break;
        case NEMUOSTYPE_Win2k8:                           pszOs = "Windows 2k8";    break;
        case NEMUOSTYPE_Win7:                             pszOs = "Windows 7";      break;
        case NEMUOSTYPE_Win8:                             pszOs = "Windows 8";      break;
        case NEMUOSTYPE_Win2k12_x64 & ~NEMUOSTYPE_x64:    pszOs = "Windows 2k12";   break;
        case NEMUOSTYPE_Win81:                            pszOs = "Windows 8.1";    break;
        case NEMUOSTYPE_Win10:                            pszOs = "Windows 10";     break;
        case NEMUOSTYPE_OS2:                              pszOs = "OS/2";           break;
        case NEMUOSTYPE_OS2Warp3:                         pszOs = "OS/2 Warp 3";    break;
        case NEMUOSTYPE_OS2Warp4:                         pszOs = "OS/2 Warp 4";    break;
        case NEMUOSTYPE_OS2Warp45:                        pszOs = "OS/2 Warp 4.5";  break;
        case NEMUOSTYPE_ECS:                              pszOs = "OS/2 ECS";       break;
        case NEMUOSTYPE_OS21x:                            pszOs = "OS/2 2.1x";      break;
        case NEMUOSTYPE_Linux:                            pszOs = "Linux";          break;
        case NEMUOSTYPE_Linux22:                          pszOs = "Linux 2.2";      break;
        case NEMUOSTYPE_Linux24:                          pszOs = "Linux 2.4";      break;
        case NEMUOSTYPE_Linux26:                          pszOs = "Linux >= 2.6";   break;
        case NEMUOSTYPE_ArchLinux:                        pszOs = "ArchLinux";      break;
        case NEMUOSTYPE_Debian:                           pszOs = "Debian";         break;
        case NEMUOSTYPE_OpenSUSE:                         pszOs = "openSUSE";       break;
        case NEMUOSTYPE_FedoraCore:                       pszOs = "Fedora";         break;
        case NEMUOSTYPE_Gentoo:                           pszOs = "Gentoo";         break;
        case NEMUOSTYPE_Mandriva:                         pszOs = "Mandriva";       break;
        case NEMUOSTYPE_RedHat:                           pszOs = "RedHat";         break;
        case NEMUOSTYPE_Turbolinux:                       pszOs = "TurboLinux";     break;
        case NEMUOSTYPE_Ubuntu:                           pszOs = "Ubuntu";         break;
        case NEMUOSTYPE_Xandros:                          pszOs = "Xandros";        break;
        case NEMUOSTYPE_Oracle:                           pszOs = "Oracle Linux";   break;
        case NEMUOSTYPE_FreeBSD:                          pszOs = "FreeBSD";        break;
        case NEMUOSTYPE_OpenBSD:                          pszOs = "OpenBSD";        break;
        case NEMUOSTYPE_NetBSD:                           pszOs = "NetBSD";         break;
        case NEMUOSTYPE_Netware:                          pszOs = "Netware";        break;
        case NEMUOSTYPE_Solaris:                          pszOs = "Solaris";        break;
        case NEMUOSTYPE_OpenSolaris:                      pszOs = "OpenSolaris";    break;
        case NEMUOSTYPE_Solaris11_x64 & ~NEMUOSTYPE_x64:  pszOs = "Solaris 11";     break;
        case NEMUOSTYPE_MacOS:                            pszOs = "Mac OS X";       break;
        case NEMUOSTYPE_MacOS106:                         pszOs = "Mac OS X 10.6";  break;
        case NEMUOSTYPE_MacOS107_x64 & ~NEMUOSTYPE_x64:   pszOs = "Mac OS X 10.7";  break;
        case NEMUOSTYPE_MacOS108_x64 & ~NEMUOSTYPE_x64:   pszOs = "Mac OS X 10.8";  break;
        case NEMUOSTYPE_MacOS109_x64 & ~NEMUOSTYPE_x64:   pszOs = "Mac OS X 10.9";  break;
        case NEMUOSTYPE_MacOS1010_x64 & ~NEMUOSTYPE_x64:  pszOs = "Mac OS X 10.10"; break;
        case NEMUOSTYPE_MacOS1011_x64 & ~NEMUOSTYPE_x64:  pszOs = "Mac OS X 10.11"; break;
        case NEMUOSTYPE_Haiku:                            pszOs = "Haiku";          break;
    ...
    LogRel(("VMMDev: Guest Additions information report: Interface = 0x%08X osType = 0x%08X (%s, %u-bit)\n",
            ...
            pGuestInfo->osType & NEMUOSTYPE_x64 ? 64 : 32));
}
 ...
 *
 * @returns Nemu status code that the guest should see.
...
static int vmmdevReqHandler_ReportGuestInfo(PVMMDEV pThis, VMMDevRequestHeader *pRequestHeader)
{
    ...
    NemuGuestInfo const *pInfo = &((VMMDevReportGuestInfo *)pRequestHeader)->guestInfo;
...
static int vmmdevReqHandler_ReportGuestInfo2(PVMMDEV pThis, VMMDevRequestHeader *pReqHdr)
{
    ...
    NemuGuestInfo2 const *pInfo2 = &((VMMDevReportGuestInfo2 *)pReqHdr)->guestInfo;
    ...
    uint32_t uFullVersion = NEMU_FULL_VERSION_MAKE(pInfo2->additionsMajor, pInfo2->additionsMinor, pInfo2->additionsBuild);
    AssertMsgReturn(   NEMU_FULL_VERSION_GET_MAJOR(uFullVersion) == pInfo2->additionsMajor
                    && NEMU_FULL_VERSION_GET_MINOR(uFullVersion) == pInfo2->additionsMinor
                    && NEMU_FULL_VERSION_GET_BUILD(uFullVersion) == pInfo2->additionsBuild,
                    ("%u.%u.%u\n", pInfo2->additionsMajor, pInfo2->additionsMinor, pInfo2->additionsBuild),
                    VERR_OUT_OF_RANGE);
...
vmmdevAllocFacilityStatusEntry(PVMMDEV pThis, NemuGuestFacilityType enmFacility, bool fFixed, PCRTTIMESPEC pTimeSpecNow)
{
    ...
    if (pThis->cFacilityStatuses == RT_ELEMENTS(pThis->aFacilityStatuses))
    {
        ...
        while (i-- > 0)
        {
            if (   pThis->aFacilityStatuses[i].enmStatus == NemuGuestFacilityStatus_Inactive
    ...
    pThis->aFacilityStatuses[i].enmStatus    = NemuGuestFacilityStatus_Inactive;
 ...
 * @param   enmFacility     The facility type code.
 */
static PVMMDEVFACILITYSTATUSENTRY vmmdevGetFacilityStatusEntry(PVMMDEV pThis, NemuGuestFacilityType enmFacility)
{
...
static int vmmdevReqHandler_ReportGuestStatus(PVMMDEV pThis, VMMDevRequestHeader *pReqHdr)
{
    ...
    NemuGuestStatus *pStatus = &((VMMDevReportGuestStatus *)pReqHdr)->guestStatus;
    AssertMsgReturn(   pStatus->facility > NemuGuestFacilityType_Unknown
                    && pStatus->facility <= NemuGuestFacilityType_All,
                    ("%d\n", pStatus->facility),
                    VERR_INVALID_PARAMETER);
    AssertMsgReturn(pStatus->status == (NemuGuestFacilityStatus)(uint16_t)pStatus->status,
    ...
    RTTIMESPEC Now;
    RTTimeNow(&Now);
    if (pStatus->facility == NemuGuestFacilityType_All)
    {
        uint32_t i = pThis->cFacilityStatuses;
        while (i-- > 0)
        {
...
static int vmmdevReqHandler_SetPointerShape(PVMMDEV pThis, VMMDevRequestHeader *pReqHdr)
{
    ...
    bool fVisible = RT_BOOL(pReq->fFlags & NEMU_MOUSE_POINTER_VISIBLE);
    bool fAlpha   = RT_BOOL(pReq->fFlags & NEMU_MOUSE_POINTER_ALPHA);
    bool fShape   = RT_BOOL(pReq->fFlags & NEMU_MOUSE_POINTER_SHAPE);
...
static int vmmdevReqHandler_ReportGuestStats(PVMMDEV pThis, VMMDevRequestHeader *pReqHdr)
{
...
#ifdef LOG_ENABLED
    NemuGuestStatistics *pGuestStats = &pReq->guestStats;

    Log(("Current statistics:\n"));
    if (pGuestStats->u32StatCaps & NEMU_GUEST_STAT_CPU_LOAD_IDLE)
        Log(("CPU%u: CPU Load Idle          %-3d%%\n", pGuestStats->u32CpuId, pGuestStats->u32CpuLoad_Idle));

    if (pGuestStats->u32StatCaps & NEMU_GUEST_STAT_CPU_LOAD_KERNEL)
        Log(("CPU%u: CPU Load Kernel        %-3d%%\n", pGuestStats->u32CpuId, pGuestStats->u32CpuLoad_Kernel));

    if (pGuestStats->u32StatCaps & NEMU_GUEST_STAT_CPU_LOAD_USER)
        Log(("CPU%u: CPU Load User          %-3d%%\n", pGuestStats->u32CpuId, pGuestStats->u32CpuLoad_User));

    if (pGuestStats->u32StatCaps & NEMU_GUEST_STAT_THREADS)
        Log(("CPU%u: Thread                 %d\n", pGuestStats->u32CpuId, pGuestStats->u32Threads));

    if (pGuestStats->u32StatCaps & NEMU_GUEST_STAT_PROCESSES)
        Log(("CPU%u: Processes              %d\n", pGuestStats->u32CpuId, pGuestStats->u32Processes));

    if (pGuestStats->u32StatCaps & NEMU_GUEST_STAT_HANDLES)
        Log(("CPU%u: Handles                %d\n", pGuestStats->u32CpuId, pGuestStats->u32Handles));

    if (pGuestStats->u32StatCaps & NEMU_GUEST_STAT_MEMORY_LOAD)
    ...
    if (pGuestStats->u32StatCaps & NEMU_GUEST_STAT_PHYS_MEM_TOTAL)
        Log(("CPU%u: Total physical memory  %-4d MB\n", pGuestStats->u32CpuId, (pGuestStats->u32PhysMemTotal + (_1M/_4K)-1) / (_1M/_4K)));

    if (pGuestStats->u32StatCaps & NEMU_GUEST_STAT_PHYS_MEM_AVAIL)
        Log(("CPU%u: Free physical memory   %-4d MB\n", pGuestStats->u32CpuId, pGuestStats->u32PhysMemAvail / (_1M/_4K)));

    if (pGuestStats->u32StatCaps & NEMU_GUEST_STAT_PHYS_MEM_BALLOON)
        Log(("CPU%u: Memory balloon size    %-4d MB\n", pGuestStats->u32CpuId, pGuestStats->u32PhysMemBalloon / (_1M/_4K)));

    if (pGuestStats->u32StatCaps & NEMU_GUEST_STAT_MEM_COMMIT_TOTAL)
        Log(("CPU%u: Committed memory       %-4d MB\n", pGuestStats->u32CpuId, pGuestStats->u32MemCommitTotal / (_1M/_4K)));

    if (pGuestStats->u32StatCaps & NEMU_GUEST_STAT_MEM_KERNEL_TOTAL)
        Log(("CPU%u: Total kernel memory    %-4d MB\n", pGuestStats->u32CpuId, pGuestStats->u32MemKernelTotal / (_1M/_4K)));

    if (pGuestStats->u32StatCaps & NEMU_GUEST_STAT_MEM_KERNEL_PAGED)
        Log(("CPU%u: Paged kernel memory    %-4d MB\n", pGuestStats->u32CpuId, pGuestStats->u32MemKernelPaged / (_1M/_4K)));

    if (pGuestStats->u32StatCaps & NEMU_GUEST_STAT_MEM_KERNEL_NONPAGED)
        Log(("CPU%u: Nonpaged kernel memory %-4d MB\n", pGuestStats->u32CpuId, pGuestStats->u32MemKernelNonPaged / (_1M/_4K)));

    if (pGuestStats->u32StatCaps & NEMU_GUEST_STAT_MEM_SYSTEM_CACHE)
        Log(("CPU%u: System cache size      %-4d MB\n", pGuestStats->u32CpuId, pGuestStats->u32MemSystemCache / (_1M/_4K)));

    if (pGuestStats->u32StatCaps & NEMU_GUEST_STAT_PAGE_FILE_SIZE)
 ...
 * @param   pReqHdr         The header of the request to handle.
 * @since   3.1.0
 * @note    The ring-0 NemuGuestLib uses this to check whether
...
static int vmmdevReqHandler_WriteCoreDump(PVMMDEV pThis, VMMDevRequestHeader *pReqHdr)
{
    ...
    RTPathAppend(szCorePath, sizeof(szCorePath), "Nemu.core");
...
static DECLCALLBACK(int) vmmdevLoadExec(PPDMDEVINS pDevIns, PSSMHANDLE pSSM, uint32_t uVersion, uint32_t uPass)
{
    ...
    /* config */
    if (uVersion > VMMDEV_SAVED_STATE_VERSION_NEMU_30)
    {
        bool f;
    ...
    if (uVersion > VMMDEV_SAVED_STATE_VERSION_MISSING_FACILITY_STATUSES)
    {
        ...
        for (uint32_t i = 0; i < cFacilityStatuses; i++)
        {
            ...
            PVMMDEVFACILITYSTATUSENTRY pEntry = vmmdevGetFacilityStatusEntry(pThis, (NemuGuestFacilityType)uFacility);
            ...
            pEntry->enmStatus = (NemuGuestFacilityStatus)uStatus;
...
static DECLCALLBACK(void) vmmdevReset(PPDMDEVINS pDevIns)
{
    ...
    const bool fVersionChanged = pThis->fu32AdditionsOk
                              ...
                              || pThis->guestInfo.osType != NEMUOSTYPE_Unknown;
    if (fVersionChanged)
    ...
    while (iFacility-- > 0)
    {
        pThis->aFacilityStatuses[iFacility].enmStatus  = NemuGuestFacilityStatus_Inactive;
...
static DECLCALLBACK(int) vmmdevConstruct(PPDMDEVINS pDevIns, int iInstance, PCFGMNODE pCfg)
{
    ...
    RTTIMESPEC TimeStampNow;
    RTTimeNow(&TimeStampNow);
    vmmdevAllocFacilityStatusEntry(pThis, NemuGuestFacilityType_NemuGuestDriver, true /*fFixed*/, &TimeStampNow);
    vmmdevAllocFacilityStatusEntry(pThis, NemuGuestFacilityType_NemuService,     true /*fFixed*/, &TimeStampNow);
    vmmdevAllocFacilityStatusEntry(pThis, NemuGuestFacilityType_NemuTrayClient,  true /*fFixed*/, &TimeStampNow);
    vmmdevAllocFacilityStatusEntry(pThis, NemuGuestFacilityType_Seamless,        true /*fFixed*/, &TimeStampNow);
    vmmdevAllocFacilityStatusEntry(pThis, NemuGuestFacilityType_Graphics,        true /*fFixed*/, &TimeStampNow);
     ...
     * OpenBSD guest without requiring NemuGuest and NemuService to be ported
...
#endif /* !NEMU_DEVICE_STRUCT_TESTCASE */
