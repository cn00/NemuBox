 ...
 * the hyper heap!
 *
 * @returns Nemu status code (VMSetError called).
 * @param   pVM                 The cross context VM structure.
...
static int cpumR3CpuIdPlantHypervisorLeaves(PCPUM pCpum, PCPUMCPUIDCONFIG pConfig)
{
    ...
    NewLeaf.uEbx         = 0x786f4256 /* 'Nemu' */;
    NewLeaf.uEcx         = 0x786f4256 /* 'Nemu' */;
    NewLeaf.uEdx         = 0x786f4256 /* 'Nemu' */;
    NewLeaf.fFlags       = 0;
 ...
 *
 * @returns Nemu status code (error message raised).
...
int cpumR3LoadCpuIdPre32(PVM pVM, PSSMHANDLE pSSM, uint32_t uVersion)
{
     ...
     * leaves because we've been allowed more is newer version of Nemu.
     */
    uint32_t cElements;
...
/** @} */
# endif /* NEMU_WITH_RAW_MODE || DOXYGEN_RUNNING */
