...
#define PR_AddWaitFileDesc NemuNsprPR_AddWaitFileDesc
#define PR_CancelWaitFileDesc NemuNsprPR_CancelWaitFileDesc
#define PR_CancelWaitGroup NemuNsprPR_CancelWaitGroup
#define PR_CreateWaitGroup NemuNsprPR_CreateWaitGroup
#define PR_CreateMWaitEnumerator NemuNsprPR_CreateMWaitEnumerator
#define PR_DestroyWaitGroup NemuNsprPR_DestroyWaitGroup
#define PR_DestroyMWaitEnumerator NemuNsprPR_DestroyMWaitEnumerator
#define PR_EnumerateWaitGroup NemuNsprPR_EnumerateWaitGroup
#define PR_WaitRecvReady NemuNsprPR_WaitRecvReady
