 ...
 *      - NemuDev - Special PCI Device which serves as an interface between
 ...
 *          - @ref pg_dev_vusb_old
 *  - Host Drivers.
 *      - SUPDRV - The Support driver (aka NemuDrv).
 *          - @ref pg_sup
 *      - @ref pg_netflt
 *      - @ref pg_netadp
 *      - NemuUSB - The USB support driver.
 *      - @ref pg_netflt
 *      - @ref pg_rawpci
 *  - Host Services.
 ...
 *      - NemuHeadless - The headless frontend.
 *      - NemuManage - The CLI.
 *      - NemuShell - An interactive shell written in python.
 *      - NemuSDL - A very simple GUI.
 *      - NemuBFE - A bare metal edition which does not use COM/XPCOM (barely
 *        maintained atm).
