...
class TestVm(object):
    ...
    def getReconfiguredVm(self, oTestDrv, cCpus, sVirtMode, sParavirtMode = None):
        ...
        Nemu VM object that is only present when rc is True.
        """
                ...
                if self.is64bitRequired() and not fHostSupports64bit:
                    ...
                    if oSession is not None:
                        ...
                        if sParavirtMode is not None and oSession.fpApiVer >= 5.0:
                            adParavirtProviders = {
                                g_ksParavirtProviderNone   : nemucon.ParavirtProvider_None,
                                g_ksParavirtProviderDefault: nemucon.ParavirtProvider_Default,
                                g_ksParavirtProviderLegacy : nemucon.ParavirtProvider_Legacy,
                                g_ksParavirtProviderMinimal: nemucon.ParavirtProvider_Minimal,
                                g_ksParavirtProviderHyperV : nemucon.ParavirtProvider_HyperV,
                                g_ksParavirtProviderKVM    : nemucon.ParavirtProvider_KVM,
                            };
        ...
        for oTestVm in self.aoTestVms:
            ...
            if oTestVm.fSnapshotRestoreCurrent:
                ...
                if eNic0AttachType is not None:
                    ...
                    eMyNic0AttachType = nemucon.NetworkAttachmentType_NAT;
                elif oTestVm.sNic0AttachType == 'bridged':
                    eMyNic0AttachType = nemucon.NetworkAttachmentType_Bridged;
                else:
