/* $Id: UIDnDHandler.h $ */
/** @file
 * Nemu Qt GUI - UIDnDHandler class declaration..
 */
...
public:
    ...
    static KDnDAction          toNemuDnDAction(Qt::DropAction action);
    static QVector<KDnDAction> toNemuDnDActions(Qt::DropActions actions);
