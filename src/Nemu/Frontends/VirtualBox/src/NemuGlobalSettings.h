/* $Id: NemuGlobalSettings.h $ */
/** @file
 * Nemu Qt GUI - NemuGlobalSettingsData, NemuGlobalSettings class declarations.
 */
...
#ifndef __NemuGlobalSettings_h__
#define __NemuGlobalSettings_h__
...
public:
    ...
    NemuGlobalSettingsData();
    NemuGlobalSettingsData( const NemuGlobalSettingsData &that );
    virtual ~NemuGlobalSettingsData();
    bool operator==( const NemuGlobalSettingsData &that ) const;
...
private:
    ...
    friend class NemuGlobalSettings;
};

/////////////////////////////////////////////////////////////////////////////

class NemuGlobalSettings : public QObject, public CIShared <NemuGlobalSettingsData>
{
    Q_OBJECT
...
public:
    ...
    NemuGlobalSettings (bool null = true)
        : CIShared <NemuGlobalSettingsData> (null) {}
    NemuGlobalSettings (const NemuGlobalSettings &that)
        : QObject(), CIShared <NemuGlobalSettingsData> (that) {}
    NemuGlobalSettings &operator= (const NemuGlobalSettings &that) {
        CIShared <NemuGlobalSettingsData>::operator= (that);
        return *this;
    }
    ...
    void load (CVirtualBox &nemu);
    void save (CVirtualBox &nemu) const;
...
#endif // __NemuGlobalSettings_h__
