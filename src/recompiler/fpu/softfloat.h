...
#if (defined(__i386__) || defined(__x86_64__)) && (!defined(CONFIG_BSD) || defined(NEMU)) /** @todo NEMU: not correct on windows */
#define FLOATX80
#endif
#endif /* !CONFIG_SOFTFLOAT */

#if defined(NEMU) && (!defined(FLOATX80) || defined(CONFIG_SOFTFLOAT))
# error misconfigured
#endif
