...
#include <Nemu/vd.h>
#include <Nemu/vd-image-backend.h>
#include <Nemu/vd-cache-backend.h>
#include <Nemu/vd-filter-backend.h>
...
typedef struct VDBACKENDREGISTER
{
     ...
     */
    DECLR3CALLBACKMEMBER(int, pfnRegisterImage, (void *pvUser, PCNEMUHDDBACKEND pBackend));
