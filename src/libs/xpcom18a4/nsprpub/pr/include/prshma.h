...
#define PR_OpenAnonFileMap NemuNsprPR_OpenAnonFileMap
#define PR_ProcessAttrSetInheritableFileMap NemuNsprPR_ProcessAttrSetInheritableFileMap
#define PR_GetInheritedFileMap NemuNsprPR_GetInheritedFileMap
#define PR_ExportFileMapAsString NemuNsprPR_ExportFileMapAsString
#define PR_ImportFileMapFromString NemuNsprPR_ImportFileMapFromString
