...
#ifndef ___Nemu_vmm_stam_h
#define ___Nemu_vmm_stam_h
...
#if defined(NEMU_WITHOUT_RELEASE_STATISTICS) && defined(NEMU_WITH_STATISTICS)
# error "Both NEMU_WITHOUT_RELEASE_STATISTICS and NEMU_WITH_STATISTICS are defined! Make up your mind!"
#endif
...
/** @def STAM_REL_STATS
 * Code for inclusion only when NEMU_WITH_STATISTICS is defined.
 * @param   code    A code block enclosed in {}.
 */
#ifndef NEMU_WITHOUT_RELEASE_STATISTICS
