/* $Id: NemuCertUtil.cpp $ */
/** @file
 * NemuCertUtil - Nemu Certificate Utility - Windows Only.
 */
...
static RTEXITCODE cmdRemoveTrustedPublisher(int argc, char **argv)
{
    ...
    while ((rc = RTGetOpt(&GetState, &ValueUnion)))
    {
        ...
        {
            case 'h':
                RTPrintf("Usage: NemuCertUtil remove-trusted-publisher [--root <root-cert>] <trusted-cert>\n");
                break;
...
static RTEXITCODE cmdAddTrustedPublisher(int argc, char **argv)
{
    ...
    while ((rc = RTGetOpt(&GetState, &ValueUnion)))
    {
        ...
        {
            case 'h':
                RTPrintf("Usage: NemuCertUtil add-trusted-publisher [--root <root-cert>] <trusted-cert>\n");
                break;
