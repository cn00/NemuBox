/* $Id: NemuGuestR3LibVideo.cpp $ */
/** @file
 * NemuGuestR3Lib - Ring-3 Support Library for VirtualBox guest additions, Video.
 */
...
#include <Nemu/log.h>
#include <Nemu/HostServices/GuestPropertySvc.h>  /* For Save and RetrieveVideoMode */
                                              ...
                                              bool fAck)
{
    ...
    /* NEEDS TESTING: test below with current Additions on Nemu 4.1 or older. */
...
{
#if defined(NEMU_WITH_GUEST_PROPS)
