/* $Id: NemuDTraceLibCWrappers.h $ */
/** @file
 * NemuDTraceTLibCWrappers.h - IPRT wrappers/fake for lib C stuff.
 *
 * Contributed by: bird
 */
...
#ifndef ___NemuDTraceLibCWrappers_h___
#define ___NemuDTraceLibCWrappers_h___
...
/* For various stupid reasons, these are duplicated in NemuDTraceTypes.h. */
#undef bcopy
