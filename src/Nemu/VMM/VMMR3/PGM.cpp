 ...
 * to who has mapped what I think, since both NemuVMMR0.r0 and RTR0MemObj will keep
...
#ifdef NEMU_WITH_PREALLOC_RAM_BY_DEFAULT
                            true
#else
                            false
#endif
 ...
 *
 * @returns Nemu status code. May suspend or power off the VM on error, but this
 ...
 *
 * @returns Nemu status code, fully asserted.
 * @param   pVCpu   The cross context virtual CPU structure.
 */
 ...
 * @returns Nemu error status after asserting on integrity breach.
 * @param   pVM     The cross context VM structure.
 */
