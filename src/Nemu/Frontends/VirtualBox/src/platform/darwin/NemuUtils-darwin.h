/* $Id: NemuUtils-darwin.h $ */
/** @file
 * Nemu Qt GUI - Declarations of utility classes and functions for handling Darwin specific tasks.
 */
...
#ifndef ___NemuUtils_darwin_h
#define ___NemuUtils_darwin_h
