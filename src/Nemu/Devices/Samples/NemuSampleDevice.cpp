 ...
 */
typedef struct NEMUSAMPLEDEVICE
{
    uint32_t    Whatever;
} NEMUSAMPLEDEVICE;
typedef NEMUSAMPLEDEVICE *PNEMUSAMPLEDEVICE;
...
static DECLCALLBACK(int) devSampleConstruct(PPDMDEVINS pDevIns, int iInstance, PCFGMNODE pCfg)
{
     ...
     */
    PNEMUSAMPLEDEVICE pThis = PDMINS_2_DATA(pDevIns, PNEMUSAMPLEDEVICE);
    pThis->Whatever = 0;
...
{
    LogFlow(("NemuSampleDevice::NemuDevicesRegister: u32Version=%#x pCallbacks->u32Version=%#x\n", u32Version, pCallbacks->u32Version));
