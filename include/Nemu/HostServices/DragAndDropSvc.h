...
#ifndef ___Nemu_HostService_DragAndDropSvc_h
#define ___Nemu_HostService_DragAndDropSvc_h
 ...
 */
#define NEMU_DRAG_AND_DROP_MODE_OFF           0
#define NEMU_DRAG_AND_DROP_MODE_HOST_TO_GUEST 1
#define NEMU_DRAG_AND_DROP_MODE_GUEST_TO_HOST 2
#define NEMU_DRAG_AND_DROP_MODE_BIDIRECTIONAL 3
...
enum eHostFn
{
     ...
     *  Note: Only for protocol version 2 and up (>= Nemu 5.0). */
...
enum eGuestFn
{
     ...
     *  Note: Available since protocol version 2 (Nemu 5.0). */
...
typedef struct NEMUDNDHGACTIONMSG
{
...
typedef struct NEMUDNDHGLEAVEMSG
{
    NemuGuestHGCMCallInfo hdr;
    /**
     * HG Leave event.
...
typedef struct NEMUDNDHGCANCELMSG
{
    NemuGuestHGCMCallInfo hdr;
...
typedef struct NEMUDNDHGSENDDATAMSG
{
    NemuGuestHGCMCallInfo hdr;
...
} NEMUDNDHGSENDDATAMSG;

typedef struct NEMUDNDHGSENDMOREDATAMSG
{
    NemuGuestHGCMCallInfo hdr;
    ...
    HGCMFunctionParameter pvData;       /* OUT ptr */
    HGCMFunctionParameter cbData;       /* OUT uint32_t */
} NEMUDNDHGSENDMOREDATAMSG;

typedef struct NEMUDNDHGSENDDIRMSG
{
    NemuGuestHGCMCallInfo hdr;
 ...
 */
typedef struct NEMUDNDHGSENDFILEHDRMSG
{
    NemuGuestHGCMCallInfo hdr;
 ...
 */
typedef struct NEMUDNDHGSENDFILEDATAMSG
{
    NemuGuestHGCMCallInfo hdr;
    ...
    union
    {
        ...
        struct
        {
            /** Note: pvName is now part of the NEMUDNDHGSENDFILEHDRMSG message. */
            /** Note: cbName is now part of the NEMUDNDHGSENDFILEHDRMSG message. */
            /** Context ID. Unused at the moment. */
            HGCMFunctionParameter uContext;     /* OUT uint32_t */
            HGCMFunctionParameter pvData;       /* OUT ptr */
            HGCMFunctionParameter cbData;       /* OUT uint32_t */
            /** Note: fMode is now part of the NEMUDNDHGSENDFILEHDRMSG message. */
        } v2;
    } u;

} NEMUDNDHGSENDFILEDATAMSG;

typedef struct NEMUDNDGHREQPENDINGMSG
{
    NemuGuestHGCMCallInfo hdr;
     ...
     */
    HGCMFunctionParameter uScreenId;    /* OUT uint32_t */
} NEMUDNDGHREQPENDINGMSG;

typedef struct NEMUDNDGHDROPPEDMSG
{
    NemuGuestHGCMCallInfo hdr;
 ...
 */
typedef struct NEMUDNDNEXTMSGMSG
{
    NemuGuestHGCMCallInfo hdr;
 ...
 * GUEST_DND_CONNECT
 */
typedef struct NEMUDNDCONNECTMSG
{
    NemuGuestHGCMCallInfo hdr;
 ...
 * GUEST_DND_HG_ACK_OP
 */
typedef struct NEMUDNDHGACKOPMSG
{
    NemuGuestHGCMCallInfo hdr;
 ...
 */
typedef struct NEMUDNDHGREQDATAMSG
{
    NemuGuestHGCMCallInfo hdr;
...
typedef struct NEMUDNDHGEVTPROGRESSMSG
{
    NemuGuestHGCMCallInfo hdr;
 ...
 */
typedef struct NEMUDNDGHACKPENDINGMSG
{
    NemuGuestHGCMCallInfo hdr;
 ...
 */
typedef struct NEMUDNDGHSENDDATAMSG
{
    NemuGuestHGCMCallInfo hdr;
 ...
 */
typedef struct NEMUDNDGHSENDDIRMSG
{
    NemuGuestHGCMCallInfo hdr;
 ...
 * HOST_DND_GH_SND_FILE_HDR
 */
typedef struct NEMUDNDHGSENDFILEHDRMSG NEMUDNDGHSENDFILEHDRMSG;
 ...
 */
typedef struct NEMUDNDGHSENDFILEDATAMSG
{
    NemuGuestHGCMCallInfo hdr;
 ...
 */
typedef struct NEMUDNDGHEVTERRORMSG
{
    NemuGuestHGCMCallInfo hdr;

    HGCMFunctionParameter rc;               /* OUT uint32_t */
} NEMUDNDGHEVTERRORMSG;
...
typedef struct NEMUDNDCBHEADERDATA
{
    /** Magic number to identify the structure. */
    uint32_t                    u32Magic;
    /** Context ID to identify callback data. */
    uint32_t                    u32ContextID;
} NEMUDNDCBHEADERDATA, *PNEMUDNDCBHEADERDATA;

typedef struct NEMUDNDCBHGGETNEXTHOSTMSG
{
    /** Callback data header. */
    NEMUDNDCBHEADERDATA         hdr;
    uint32_t                    uMsg;
    uint32_t                    cParms;
} NEMUDNDCBHGGETNEXTHOSTMSG, *PNEMUDNDCBHGGETNEXTHOSTMSG;

typedef struct NEMUDNDCBHGGETNEXTHOSTMSGDATA
{
    /** Callback data header. */
    NEMUDNDCBHEADERDATA         hdr;
    uint32_t                    uMsg;
    uint32_t                    cParms;
    PNEMUHGCMSVCPARM            paParms;
} NEMUDNDCBHGGETNEXTHOSTMSGDATA, *PNEMUDNDCBHGGETNEXTHOSTMSGDATA;

typedef struct NEMUDNDCBHGACKOPDATA
{
    /** Callback data header. */
    NEMUDNDCBHEADERDATA         hdr;
    uint32_t                    uAction;
} NEMUDNDCBHGACKOPDATA, *PNEMUDNDCBHGACKOPDATA;

typedef struct NEMUDNDCBHGREQDATADATA
{
    /** Callback data header. */
    NEMUDNDCBHEADERDATA         hdr;
    char                       *pszFormat;
    uint32_t                    cbFormat;
} NEMUDNDCBHGREQDATADATA, *PNEMUDNDCBHGREQDATADATA;

typedef struct NEMUDNDCBHGEVTPROGRESSDATA
{
    /** Callback data header. */
    NEMUDNDCBHEADERDATA         hdr;
    ...
    uint32_t                    uStatus;
    uint32_t                    rc;
} NEMUDNDCBHGEVTPROGRESSDATA, *PNEMUDNDCBHGEVTPROGRESSDATA;

typedef struct NEMUDNDCBGHACKPENDINGDATA
{
    /** Callback data header. */
    NEMUDNDCBHEADERDATA         hdr;
    uint32_t                    uDefAction;
    ...
    char                       *pszFormat;
    uint32_t                    cbFormat;
} NEMUDNDCBGHACKPENDINGDATA, *PNEMUDNDCBGHACKPENDINGDATA;

typedef struct NEMUDNDCBSNDDATADATA
{
    /** Callback data header. */
    NEMUDNDCBHEADERDATA         hdr;
    void                       *pvData;
...
} NEMUDNDCBSNDDATADATA, *PNEMUDNDCBSNDDATADATA;

typedef struct NEMUDNDCBSNDDIRDATA
{
    /** Callback data header. */
    NEMUDNDCBHEADERDATA         hdr;
    char                       *pszPath;
    uint32_t                    cbPath;
    uint32_t                    fMode;
} NEMUDNDCBSNDDIRDATA, *PNEMUDNDCBSNDDIRDATA;

/*  Note: Only for protocol version 2 and up (>= Nemu 5.0). */
typedef struct NEMUDNDCBSNDFILEHDRDATA
{
    /** Callback data header. */
    NEMUDNDCBHEADERDATA         hdr;
    /** File path (name). */
    ...
    uint32_t                    fFlags;
} NEMUDNDCBSNDFILEHDRDATA, *PNEMUDNDCBSNDFILEHDRDATA;

typedef struct NEMUDNDCBSNDFILEDATADATA
{
    /** Callback data header. */
    NEMUDNDCBHEADERDATA         hdr;
    ...
    union
    {
        ...
        /* Note: Protocol version 2 has the file attributes (name, size,
                 mode, ...) in the NEMUDNDCBSNDFILEHDRDATA structure. */
    } u;
} NEMUDNDCBSNDFILEDATADATA, *PNEMUDNDCBSNDFILEDATADATA;

typedef struct NEMUDNDCBEVTERRORDATA
{
    /** Callback data header. */
    NEMUDNDCBHEADERDATA         hdr;
    int32_t                     rc;
} NEMUDNDCBEVTERRORDATA, *PNEMUDNDCBEVTERRORDATA;

} /* namespace DragAndDropSvc */

#endif  /* !___Nemu_HostService_DragAndDropSvc_h */
