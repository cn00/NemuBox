; $Id$
; @file
; NemuGuestAdditionsUninstall.nsh - Guest Additions uninstallation.
;
...
Function ${un}UninstallCommon
  ...
  ; Remove common files
  Delete /REBOOTOK "$INSTDIR\NemuDrvInst.exe"
...
!endif
  ...
  Delete /REBOOTOK "$INSTDIR\NemuGINA.dll"
...
!if $%BUILD_TARGET_ARCH% == "x86"       ; 32-bit
  RMDir /REBOOTOK "$PROGRAMFILES32\$%NEMU_VENDOR_SHORT%"
!else   ; 64-bit
  RMDir /REBOOTOK "$PROGRAMFILES64\$%NEMU_VENDOR_SHORT%"
!endif
