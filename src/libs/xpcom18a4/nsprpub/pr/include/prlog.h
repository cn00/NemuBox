...
#define PR_NewLogModule NemuNsprPR_NewLogModule
#define PR_SetLogFile NemuNsprPR_SetLogFile
#define PR_SetLogBuffering NemuNsprPR_SetLogBuffering
#define PR_LogPrint NemuNsprPR_LogPrint
#define PR_LogFlush NemuNsprPR_LogFlush
#define PR_Assert NemuNsprPR_Assert
