/** @file
 * NemuGuest - VirtualBox Guest Additions Driver Interface, 16-bit (OS/2) header.
 */
...
#ifndef ___Nemu_NemuGuest16_h
#define ___Nemu_NemuGuest16_h

#define RT_BIT(bit)                             (1UL << (bit))


/** @defgroup grp_nemuguest_16bit   Edition for 16-bit Compilers
 * @ingroup grp_nemuguest
 * @{
 */


#define NEMUGUEST_DEVICE_NAME                   "nemugst$"

/* aka NEMUGUESTOS2IDCCONNECT */
...
#define NEMUGUEST_IOCTL_WAITEVENT               2
#define NEMUGUEST_IOCTL_VMMREQUEST              3
#define NEMUGUEST_IOCTL_CTL_FILTER_MASK         4
#define NEMUGUEST_IOCTL_SET_MOUSE_STATUS        10
#define NEMUGUEST_IOCTL_OS2_IDC_DISCONNECT      48
...
typedef struct _NemuGuestWaitEventInfo
{
