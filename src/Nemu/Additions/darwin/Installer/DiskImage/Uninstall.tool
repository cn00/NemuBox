...
unload "org.virtualbox.additions.nemuservice" "/Library/LaunchDaemons" "root"
unload "org.virtualbox.additions.nemuclient" "/Library/LaunchAgents" `whoami`
...
sudo -p "Please enter %u's password (removing files and directories):" rm -rf "/Library/Extensions/NemuGuest.kext"
sudo -p "Please enter %u's password (removing files and directories):" rm -rf "/Library/LaunchAgents/org.virtualbox.additions.nemuclient.plist"
sudo -p "Please enter %u's password (removing files and directories):" rm -rf "/Library/LaunchDaemons/org.virtualbox.additions.nemuservice.plist"
