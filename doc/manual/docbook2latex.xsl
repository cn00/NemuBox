...
\begin{center}
\includegraphics[width=4cm]{images/nemulogo.png}
\end{center}%
\vspace{10mm}
...
\tableofcontents
  ...
  <xsl:template match="cmdsynopsis">
    ...
    <xsl:text>&#x0a;</xsl:text>
    <xsl:if test="parent::remark[@role='NemuManage-overview']">
    ...
    <!-- Special overview trick for the current NemuManage command overview. -->
    <xsl:if test="parent::remark[@role='NemuManage-overview']">
