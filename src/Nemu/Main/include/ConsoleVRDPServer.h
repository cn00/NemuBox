...
/** @file
 * Nemu Console VRDE Server Helper class and implementation of IVRDEServerInfo
 */
...
#include <Nemu/RemoteDesktop/VRDEImage.h>
#include <Nemu/RemoteDesktop/VRDEMousePtr.h>
#include <Nemu/RemoteDesktop/VRDESCard.h>
#include <Nemu/RemoteDesktop/VRDETSMF.h>
#define VRDE_VIDEOIN_WITH_VRDEINTERFACE /* Get the VRDE interface definitions. */
#include <Nemu/RemoteDesktop/VRDEVideoIn.h>
#include <Nemu/RemoteDesktop/VRDEInput.h>
