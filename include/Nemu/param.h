...
#ifndef ___Nemu_param_h
#define ___Nemu_param_h

#include <iprt/param.h>
#include <iprt/cdefs.h>


/** @defgroup   grp_nemu_param  Nemu Parameter Definition
 * @{
 */

/** The maximum number of pages that can be allocated and mapped
 * by various MM, PGM and SUP APIs. */
#define NEMU_MAX_ALLOC_PAGE_COUNT   (256U * _1M / PAGE_SIZE)

/** @def NEMU_WITH_PAGE_SHARING
...
# define NEMU_WITH_PAGE_SHARING     /* ASM-NOINC */
#endif                              /* ASM-NOINC */


/** @defgroup   grp_nemu_param_mm  Memory Monitor Parameters
 * @{
 */
...
/** @defgroup   grp_nemu_param_pgm  Page Manager Parameters
 * @{
 */
...
/** @defgroup   grp_nemu_param_vmm  VMM Parameters
 * @{
 */
/** VMM stack size. */
#ifdef RT_OS_DARWIN
...
/** @defgroup   grp_nemu_pci        PCI Identifiers
 * @{ */
/** VirtualBox PCI vendor ID. */
#define NEMU_PCI_VENDORID           (0x80ee)

/** @name VirtualBox graphics card identifiers
 * @{ */
#define NEMU_VENDORID               NEMU_PCI_VENDORID   /**< @todo wonderful choice of name! Please squeeze a _VGA_ or something in there, please. */
#define NEMU_DEVICEID               (0xbeef)            /**< @todo ditto. */
#define NEMU_VESA_VENDORID          NEMU_PCI_VENDORID
#define NEMU_VESA_DEVICEID          (0xbeef)
/** @} */

/** @name VMMDev PCI card identifiers
 * @{ */
#define VMMDEV_VENDORID             NEMU_PCI_VENDORID
...
/** @defgroup grp_nemu_param_misc  Misc
 * @{ */
...
#define NEMU_MAX_GSO_SIZE           0xfff0
