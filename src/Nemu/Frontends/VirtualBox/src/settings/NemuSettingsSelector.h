/* $Id: NemuSettingsSelector.h $ */
/** @file
 * Nemu Qt GUI - NemuSettingsSelector class declaration.
 */
...
#ifndef __NemuSettingsSelector_h__
#define __NemuSettingsSelector_h__
...
class NemuSettingsSelector: public QObject
{
    Q_OBJECT;

public:

    NemuSettingsSelector (QWidget *aParent = NULL);
    ~NemuSettingsSelector();
...
class NemuSettingsTreeViewSelector: public NemuSettingsSelector
{
    Q_OBJECT;

public:

    NemuSettingsTreeViewSelector (QWidget *aParent = NULL);
...
class NemuSettingsToolBarSelector: public NemuSettingsSelector
{
    Q_OBJECT;

public:

    NemuSettingsToolBarSelector (QWidget *aParent = NULL);
...
#endif /* __NemuSettingsSelector_h__ */
