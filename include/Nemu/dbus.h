...
#ifndef ___Nemu_dbus_h
#define ___Nemu_dbus_h
...
#define NEMU_DBUS_GENERATE_HEADER

#include <Nemu/dbus-calls.h>

#undef NEMU_DBUS_GENERATE_HEADER

#endif /* ___Nemu_DBus_h not defined */
