/* $Id: NemuNetSend.h $ */
/** @file
 * A place to share code and definitions between NemuNetAdp and NemuNetFlt host drivers.
 */
...
/** @todo move this to src/Nemu/HostDrivers/darwin as a .cpp file. */
#ifndef ___Nemu_NemuNetSend_h
#define ___Nemu_NemuNetSend_h
 ...
 *
 * Most of this function was copied from nemuNetFltDarwinMBufFromSG().
 *
 ...
 */
DECLINLINE(int) NemuNetSendDummy(ifnet_t pIfNet)
{
    int rc = VINF_SUCCESS;
