...
/** @file
 * Nemu Qt GUI - UIMediumTypeChangeDialog class implementation.
 */
    ...
    : QIWithRetranslateUI<QIDialog>(pParent)
{
    ...
    m_medium = nemuGlobal().medium(strMediumId).medium();
...
void UIMediumTypeChangeDialog::retranslateUi()
{
    ...
    m_pLabel->setText(tr("<p>You are about to change the settings of the disk image file <b>%1</b>.</p>"
                      ...
                      .arg(NemuGlobal::removeAccelMark(m_pButtonBox->button(QDialogButtonBox::Ok)->text()))
                      .arg(NemuGlobal::removeAccelMark(m_pButtonBox->button(QDialogButtonBox::Cancel)->text())));
