 ...
 *
 * NOTE: This file is part of both NemuC.dll and NemuSVC.exe.
 */
...
const Global::OSType Global::sOSTypes[] =
{
    ...
    { "Other",   "Other",             "Other",              "Other/Unknown",
      NEMUOSTYPE_Unknown,         NEMUOSHINT_NONE,
    ...
    { "Other",   "Other",             "Other_64",           "Other/Unknown (64-bit)",
      NEMUOSTYPE_Unknown_x64,      NEMUOSHINT_64BIT | NEMUOSHINT_PAE | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC,
        64,   4,  2 * _1G64, NetworkAdapterType_Am79C973, 0, StorageControllerType_PIIX4, StorageBus_IDE,
      StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_STAC9700 },
    { "Windows", "Microsoft Windows", "Windows31",          "Windows 3.1",
      NEMUOSTYPE_Win31,           NEMUOSHINT_FLOPPY,
    ...
    { "Windows", "Microsoft Windows", "Windows95",          "Windows 95",
      NEMUOSTYPE_Win95,           NEMUOSHINT_FLOPPY,
        64,   4,  2 * _1G64, NetworkAdapterType_Am79C973, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_SB16, AudioCodecType_SB16  },
    { "Windows", "Microsoft Windows", "Windows98",          "Windows 98",
      NEMUOSTYPE_Win98,           NEMUOSHINT_FLOPPY,
        64,   4,  2 * _1G64, NetworkAdapterType_Am79C973, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_SB16, AudioCodecType_SB16  },
    { "Windows", "Microsoft Windows", "WindowsMe",          "Windows ME",
      NEMUOSTYPE_WinMe,           NEMUOSHINT_FLOPPY | NEMUOSHINT_USBTABLET,
    ...
    { "Windows", "Microsoft Windows", "WindowsNT4",         "Windows NT 4",
      NEMUOSTYPE_WinNT4,          NEMUOSHINT_NONE,
    ...
    { "Windows", "Microsoft Windows", "Windows2000",        "Windows 2000",
      NEMUOSTYPE_Win2k,            NEMUOSHINT_USBTABLET,
    ...
    { "Windows", "Microsoft Windows", "WindowsXP",          "Windows XP (32-bit)",
      NEMUOSTYPE_WinXP,            NEMUOSHINT_USBTABLET,
    ...
    { "Windows", "Microsoft Windows", "WindowsXP_64",       "Windows XP (64-bit)",
      NEMUOSTYPE_WinXP_x64,       NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_USBTABLET,
    ...
    { "Windows", "Microsoft Windows", "Windows2003",        "Windows 2003 (32-bit)",
      NEMUOSTYPE_Win2k3,           NEMUOSHINT_USBTABLET,
    ...
    { "Windows", "Microsoft Windows", "Windows2003_64",     "Windows 2003 (64-bit)",
      NEMUOSTYPE_Win2k3_x64,      NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_USBTABLET,
    ...
    { "Windows", "Microsoft Windows", "WindowsVista",       "Windows Vista (32-bit)",
      NEMUOSTYPE_WinVista,         NEMUOSHINT_USBTABLET,
    ...
    { "Windows", "Microsoft Windows", "WindowsVista_64",    "Windows Vista (64-bit)",
      NEMUOSTYPE_WinVista_x64,    NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_USBTABLET,
       512,  16, 25 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_IntelAhci, StorageBus_SATA,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_HDA, AudioCodecType_STAC9221  },
    { "Windows", "Microsoft Windows", "Windows2008",        "Windows 2008 (32-bit)",
      NEMUOSTYPE_Win2k8,           NEMUOSHINT_USBTABLET,
       512,  16, 25 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_IntelAhci, StorageBus_SATA,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_HDA, AudioCodecType_STAC9221  },
    { "Windows", "Microsoft Windows", "Windows2008_64",     "Windows 2008 (64-bit)",
      NEMUOSTYPE_Win2k8_x64,      NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_USBTABLET,
       512,  16, 25 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_IntelAhci, StorageBus_SATA,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_HDA, AudioCodecType_STAC9221  },
    { "Windows", "Microsoft Windows", "Windows7",           "Windows 7 (32-bit)",
      NEMUOSTYPE_Win7,             NEMUOSHINT_USBTABLET,
       512,  16, 25 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_IntelAhci, StorageBus_SATA,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_HDA, AudioCodecType_STAC9221  },
    { "Windows", "Microsoft Windows", "Windows7_64",        "Windows 7 (64-bit)",
      NEMUOSTYPE_Win7_x64,        NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_USBTABLET,
       512,  16, 25 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_IntelAhci, StorageBus_SATA,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_HDA, AudioCodecType_STAC9221  },
    { "Windows", "Microsoft Windows", "Windows8",           "Windows 8 (32-bit)",
      NEMUOSTYPE_Win8,             NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_USBTABLET | NEMUOSHINT_PAE,
    ...
    { "Windows", "Microsoft Windows", "Windows8_64",        "Windows 8 (64-bit)",
      NEMUOSTYPE_Win8_x64,        NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_USBTABLET,
    ...
    { "Windows", "Microsoft Windows", "Windows81",          "Windows 8.1 (32-bit)",
      NEMUOSTYPE_Win81,            NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_USBTABLET | NEMUOSHINT_PAE,
       1024,128, 25 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_IntelAhci, StorageBus_SATA,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_HDA, AudioCodecType_STAC9221  },
    { "Windows", "Microsoft Windows", "Windows81_64",       "Windows 8.1 (64-bit)",
      NEMUOSTYPE_Win81_x64,       NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_USBTABLET,
       2048,128, 25 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_IntelAhci, StorageBus_SATA,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_HDA, AudioCodecType_STAC9221  },
    { "Windows", "Microsoft Windows", "Windows2012_64",     "Windows 2012 (64-bit)",
      NEMUOSTYPE_Win2k12_x64,     NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_USBTABLET,
       2048,128, 25 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_IntelAhci, StorageBus_SATA,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_HDA, AudioCodecType_STAC9221  },
    { "Windows", "Microsoft Windows", "Windows10",          "Windows 10 (32-bit)",
      NEMUOSTYPE_Win10,            NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_USBTABLET | NEMUOSHINT_PAE,
    ...
    { "Windows", "Microsoft Windows", "Windows10_64",       "Windows 10 (64-bit)",
      NEMUOSTYPE_Win10_x64,       NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_USBTABLET,
    ...
    { "Windows", "Microsoft Windows", "WindowsNT",          "Other Windows (32-bit)",
      NEMUOSTYPE_WinNT,           NEMUOSHINT_NONE,
       512,  16, 20 * _1G64, NetworkAdapterType_Am79C973, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_STAC9700  },
    { "Windows", "Microsoft Windows", "WindowsNT_64",       "Other Windows (64-bit)",
      NEMUOSTYPE_WinNT_x64,       NEMUOSHINT_64BIT | NEMUOSHINT_PAE | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_USBTABLET,
       512,  16, 20 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_STAC9700  },
    { "Linux",   "Linux",             "Linux22",            "Linux 2.2",
      NEMUOSTYPE_Linux22,         NEMUOSHINT_RTCUTC,
        64,   4,  2 * _1G64, NetworkAdapterType_Am79C973, 0, StorageControllerType_PIIX4, StorageBus_IDE,
    ...
    { "Linux",   "Linux",             "Linux24",            "Linux 2.4 (32-bit)",
      NEMUOSTYPE_Linux24,         NEMUOSHINT_RTCUTC,
       128,   4,  4 * _1G64, NetworkAdapterType_Am79C973, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "Linux24_64",         "Linux 2.4 (64-bit)",
      NEMUOSTYPE_Linux24_x64,     NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_RTCUTC,
    ...
    { "Linux",   "Linux",             "Linux26",            "Linux 2.6 / 3.x / 4.x (32-bit)",
      NEMUOSTYPE_Linux26,         NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
    ...
    { "Linux",   "Linux",             "Linux26_64",         "Linux 2.6 / 3.x / 4.x (64-bit)",
      NEMUOSTYPE_Linux26_x64,     NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
       256,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "ArchLinux",          "Arch Linux (32-bit)",
      NEMUOSTYPE_ArchLinux,       NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
    ...
    { "Linux",   "Linux",             "ArchLinux_64",       "Arch Linux (64-bit)",
      NEMUOSTYPE_ArchLinux_x64,   NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
       768,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "Debian",             "Debian (32-bit)",
      NEMUOSTYPE_Debian,          NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
       768,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "Debian_64",          "Debian (64-bit)",
      NEMUOSTYPE_Debian_x64,      NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
       768,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980},
    { "Linux",   "Linux",             "OpenSUSE",           "openSUSE (32-bit)",
      NEMUOSTYPE_OpenSUSE,        NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
       768,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "OpenSUSE_64",        "openSUSE (64-bit)",
      NEMUOSTYPE_OpenSUSE_x64,    NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
       768,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "Fedora",             "Fedora (32-bit)",
      NEMUOSTYPE_FedoraCore,      NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
       768,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "Fedora_64",          "Fedora (64-bit)",
      NEMUOSTYPE_FedoraCore_x64,  NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
       768,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "Gentoo",             "Gentoo (32-bit)",
      NEMUOSTYPE_Gentoo,          NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
       768,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "Gentoo_64",          "Gentoo (64-bit)",
      NEMUOSTYPE_Gentoo_x64,      NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
       768,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "Mandriva",           "Mandriva (32-bit)",
      NEMUOSTYPE_Mandriva,        NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
    ...
    { "Linux",   "Linux",             "Mandriva_64",        "Mandriva (64-bit)",
      NEMUOSTYPE_Mandriva_x64,    NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
       512,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "RedHat",             "Red Hat (32-bit)",
      NEMUOSTYPE_RedHat,          NEMUOSHINT_RTCUTC | NEMUOSHINT_PAE,
       768,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "RedHat_64",          "Red Hat (64-bit)",
      NEMUOSTYPE_RedHat_x64,      NEMUOSHINT_64BIT | NEMUOSHINT_PAE | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_RTCUTC,
       768,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "Turbolinux",         "Turbolinux (32-bit)",
      NEMUOSTYPE_Turbolinux,      NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
    ...
    { "Linux",   "Linux",             "Turbolinux_64",      "Turbolinux (64-bit)",
      NEMUOSTYPE_Turbolinux_x64,  NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
       384,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "Ubuntu",             "Ubuntu (32-bit)",
      NEMUOSTYPE_Ubuntu,          NEMUOSHINT_RTCUTC | NEMUOSHINT_PAE | NEMUOSHINT_USBTABLET,
       768,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "Ubuntu_64",          "Ubuntu (64-bit)",
      NEMUOSTYPE_Ubuntu_x64,      NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
       768,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "Xandros",            "Xandros (32-bit)",
      NEMUOSTYPE_Xandros,         NEMUOSHINT_RTCUTC,
       256,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "Xandros_64",         "Xandros (64-bit)",
      NEMUOSTYPE_Xandros_x64,     NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_RTCUTC,
       256,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "Oracle",             "Oracle (32-bit)",
      NEMUOSTYPE_Oracle,          NEMUOSHINT_RTCUTC | NEMUOSHINT_PAE,
    ...
    { "Linux",   "Linux",             "Oracle_64",          "Oracle (64-bit)",
      NEMUOSTYPE_Oracle_x64,      NEMUOSHINT_64BIT | NEMUOSHINT_PAE | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_RTCUTC,
       768,  12, 12 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_AD1980  },
    { "Linux",   "Linux",             "Linux",              "Other Linux (32-bit)",
      NEMUOSTYPE_Linux,           NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
    ...
    { "Linux",   "Linux",             "Linux_64",           "Other Linux (64-bit)",
      NEMUOSTYPE_Linux_x64,       NEMUOSHINT_64BIT | NEMUOSHINT_PAE | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
       512,  12,  8 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_STAC9700  },
    { "Solaris", "Solaris",           "Solaris",            "Oracle Solaris 10 5/09 and earlier (32-bit)",
      NEMUOSTYPE_Solaris,         NEMUOSHINT_NONE,
    ...
    { "Solaris", "Solaris",           "Solaris_64",         "Oracle Solaris 10 5/09 and earlier (64-bit)",
      NEMUOSTYPE_Solaris_x64,     NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC,
    ...
    { "Solaris", "Solaris",           "OpenSolaris",        "Oracle Solaris 10 10/09 and later (32-bit)",
      NEMUOSTYPE_OpenSolaris,     NEMUOSHINT_USBTABLET,
    ...
    { "Solaris", "Solaris",           "OpenSolaris_64",     "Oracle Solaris 10 10/09 and later (64-bit)",
      NEMUOSTYPE_OpenSolaris_x64, NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_USBTABLET,
    ...
    { "Solaris", "Solaris",           "Solaris11_64",       "Oracle Solaris 11 (64-bit)",
      NEMUOSTYPE_Solaris11_x64, NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_USBTABLET,
      1536,  12, 16 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_IntelAhci, StorageBus_SATA,
        StorageControllerType_IntelAhci, StorageBus_SATA, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_STAC9700  },
    { "BSD",     "BSD",               "FreeBSD",            "FreeBSD (32-bit)",
      NEMUOSTYPE_FreeBSD,         NEMUOSHINT_NONE,
       128,   4,  2 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_STAC9700  },
    { "BSD",     "BSD",               "FreeBSD_64",         "FreeBSD (64-bit)",
      NEMUOSTYPE_FreeBSD_x64,     NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC,
       128,   4,  2 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_STAC9700  },
    { "BSD",     "BSD",               "OpenBSD",            "OpenBSD (32-bit)",
      NEMUOSTYPE_OpenBSD,         NEMUOSHINT_HWVIRTEX,
        64,   4,  2 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_STAC9700  },
    { "BSD",     "BSD",               "OpenBSD_64",         "OpenBSD (64-bit)",
      NEMUOSTYPE_OpenBSD_x64,     NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC,
        64,   4,  2 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_STAC9700  },
    { "BSD",     "BSD",               "NetBSD",             "NetBSD (32-bit)",
      NEMUOSTYPE_NetBSD,          NEMUOSHINT_RTCUTC,
        64,   4,  2 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_STAC9700  },
    { "BSD",     "BSD",               "NetBSD_64",          "NetBSD (64-bit)",
      NEMUOSTYPE_NetBSD_x64,      NEMUOSHINT_64BIT | NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_RTCUTC,
        64,   4,  2 * _1G64, NetworkAdapterType_I82540EM, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_STAC9700  },
    { "OS2",     "IBM OS/2",          "OS2Warp3",           "OS/2 Warp 3",
      NEMUOSTYPE_OS2Warp3,        NEMUOSHINT_HWVIRTEX | NEMUOSHINT_FLOPPY,
        48,   4,  1 * _1G64, NetworkAdapterType_Am79C973, 1, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_SB16, AudioCodecType_SB16  },
    { "OS2",     "IBM OS/2",          "OS2Warp4",           "OS/2 Warp 4",
      NEMUOSTYPE_OS2Warp4,        NEMUOSHINT_HWVIRTEX | NEMUOSHINT_FLOPPY,
    ...
    { "MacOS",   "Mac OS X",          "MacOS",              "Mac OS X (32-bit)",
      NEMUOSTYPE_MacOS,           NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_EFI | NEMUOSHINT_PAE
                                | NEMUOSHINT_USBHID | NEMUOSHINT_HPET | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
    ...
    { "MacOS",   "Mac OS X",          "MacOS_64",           "Mac OS X (64-bit)",
      NEMUOSTYPE_MacOS_x64,       NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_EFI | NEMUOSHINT_PAE |  NEMUOSHINT_64BIT
                                | NEMUOSHINT_USBHID | NEMUOSHINT_HPET | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
      2048,   4, 20 * _1G64, NetworkAdapterType_I82545EM, 0,
      StorageControllerType_IntelAhci, StorageBus_SATA, StorageControllerType_IntelAhci, StorageBus_SATA,
      ChipsetType_ICH9, AudioControllerType_HDA, AudioCodecType_STAC9221  },
    { "MacOS",   "Mac OS X",          "MacOS106",           "Mac OS X 10.6 Snow Leopard (32-bit)",
      NEMUOSTYPE_MacOS106,        NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_EFI | NEMUOSHINT_PAE
                                | NEMUOSHINT_USBHID | NEMUOSHINT_HPET | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
      2048,   4, 20 * _1G64, NetworkAdapterType_I82545EM, 0,
       StorageControllerType_IntelAhci, StorageBus_SATA, StorageControllerType_IntelAhci, StorageBus_SATA,
      ChipsetType_ICH9, AudioControllerType_HDA, AudioCodecType_STAC9221  },
    { "MacOS",   "Mac OS X",          "MacOS106_64",        "Mac OS X 10.6 Snow Leopard (64-bit)",
      NEMUOSTYPE_MacOS106_x64,    NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_EFI | NEMUOSHINT_PAE |  NEMUOSHINT_64BIT
                                | NEMUOSHINT_USBHID | NEMUOSHINT_HPET | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
      2048,   4, 20 * _1G64, NetworkAdapterType_I82545EM, 0,
      StorageControllerType_IntelAhci, StorageBus_SATA, StorageControllerType_IntelAhci, StorageBus_SATA,
      ChipsetType_ICH9, AudioControllerType_HDA, AudioCodecType_STAC9221  },
    { "MacOS",   "Mac OS X",          "MacOS107_64",        "Mac OS X 10.7 Lion (64-bit)",
      NEMUOSTYPE_MacOS107_x64,    NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_EFI | NEMUOSHINT_PAE |  NEMUOSHINT_64BIT
                                | NEMUOSHINT_USBHID | NEMUOSHINT_HPET | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
      2048,   4, 20 * _1G64, NetworkAdapterType_I82545EM, 0,
      StorageControllerType_IntelAhci, StorageBus_SATA, StorageControllerType_IntelAhci, StorageBus_SATA,
      ChipsetType_ICH9, AudioControllerType_HDA, AudioCodecType_STAC9221  },
    { "MacOS",   "Mac OS X",          "MacOS108_64",        "Mac OS X 10.8 Mountain Lion (64-bit)",  /* Aka "Mountain Kitten". */
      NEMUOSTYPE_MacOS108_x64,    NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_EFI | NEMUOSHINT_PAE |  NEMUOSHINT_64BIT
                                | NEMUOSHINT_USBHID | NEMUOSHINT_HPET | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
      2048,   4, 20 * _1G64, NetworkAdapterType_I82545EM, 0,
      StorageControllerType_IntelAhci, StorageBus_SATA, StorageControllerType_IntelAhci, StorageBus_SATA,
      ChipsetType_ICH9, AudioControllerType_HDA, AudioCodecType_STAC9221  },
    { "MacOS",   "Mac OS X",          "MacOS109_64",        "Mac OS X 10.9 Mavericks (64-bit)", /* Not to be confused with McCain. */
      NEMUOSTYPE_MacOS109_x64,    NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_EFI | NEMUOSHINT_PAE |  NEMUOSHINT_64BIT
                                | NEMUOSHINT_USBHID | NEMUOSHINT_HPET | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
      2048,   4, 20 * _1G64, NetworkAdapterType_I82545EM, 0,
      StorageControllerType_IntelAhci, StorageBus_SATA, StorageControllerType_IntelAhci, StorageBus_SATA,
      ChipsetType_ICH9, AudioControllerType_HDA, AudioCodecType_STAC9221  },
    { "MacOS",   "Mac OS X",          "MacOS1010_64",       "Mac OS X 10.10 Yosemite (64-bit)",
      NEMUOSTYPE_MacOS1010_x64,   NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_EFI | NEMUOSHINT_PAE |  NEMUOSHINT_64BIT
                                | NEMUOSHINT_USBHID | NEMUOSHINT_HPET | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
      2048,   4, 20 * _1G64, NetworkAdapterType_I82545EM, 0,
      StorageControllerType_IntelAhci, StorageBus_SATA, StorageControllerType_IntelAhci, StorageBus_SATA,
      ChipsetType_ICH9, AudioControllerType_HDA, AudioCodecType_STAC9221  },
    { "MacOS",   "Mac OS X",          "MacOS1011_64",       "Mac OS X 10.11 El Capitan (64-bit)",
      NEMUOSTYPE_MacOS1011_x64,   NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_EFI | NEMUOSHINT_PAE |  NEMUOSHINT_64BIT
                                | NEMUOSHINT_USBHID | NEMUOSHINT_HPET | NEMUOSHINT_RTCUTC | NEMUOSHINT_USBTABLET,
      2048,   4, 20 * _1G64, NetworkAdapterType_I82545EM, 0,
      StorageControllerType_IntelAhci, StorageBus_SATA, StorageControllerType_IntelAhci, StorageBus_SATA,
      ChipsetType_ICH9, AudioControllerType_HDA, AudioCodecType_STAC9221  },
    { "Other",   "Other",             "DOS",                "DOS",
      NEMUOSTYPE_DOS,             NEMUOSHINT_FLOPPY | NEMUOSHINT_NOUSB,
        32,   4,  500 * _1M, NetworkAdapterType_Am79C973, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_SB16, AudioCodecType_SB16  },
    { "Other",   "Other",             "Netware",            "Netware",
      NEMUOSTYPE_Netware,         NEMUOSHINT_HWVIRTEX,
       512,   4,  4 * _1G64, NetworkAdapterType_Am79C973, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_STAC9700  },
    { "Other",   "Other",             "L4",                 "L4",
      NEMUOSTYPE_L4,              NEMUOSHINT_NONE,
        64,   4,  2 * _1G64, NetworkAdapterType_Am79C973, 0, StorageControllerType_PIIX4, StorageBus_IDE,
        StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_STAC9700  },
    { "Other",   "Other",             "QNX",                "QNX",
#ifdef NEMU_WITH_RAW_RING1
      NEMUOSTYPE_QNX,             NEMUOSHINT_NONE,
#else
      NEMUOSTYPE_QNX,             NEMUOSHINT_HWVIRTEX,
#endif
       512,   4,  4 * _1G64, NetworkAdapterType_Am79C973, 0, StorageControllerType_PIIX4, StorageBus_IDE,
      StorageControllerType_PIIX4, StorageBus_IDE, ChipsetType_PIIX3, AudioControllerType_AC97, AudioCodecType_STAC9700  },
    { "Other",   "Other",             "JRockitVE",          "JRockitVE",
        NEMUOSTYPE_JRockitVE,     NEMUOSHINT_HWVIRTEX | NEMUOSHINT_IOAPIC | NEMUOSHINT_PAE,
...
/**
 * Returns an OS Type ID for the given NEMUOSTYPE value.
 *
 ...
 */
/* static */
const char *Global::OSTypeId(NEMUOSTYPE aOSType)
{
...
/*static*/ int
Global::nemuStatusCodeFromCOM(HRESULT aComStatus)
{
    switch (aComStatus)
    {
        ...
        case NEMU_E_OBJECT_NOT_FOUND:           return VERR_COM_OBJECT_NOT_FOUND;
        case NEMU_E_INVALID_VM_STATE:           return VERR_COM_INVALID_VM_STATE;
        case NEMU_E_VM_ERROR:                   return VERR_COM_VM_ERROR;
        case NEMU_E_FILE_ERROR:                 return VERR_COM_FILE_ERROR;
        case NEMU_E_IPRT_ERROR:                 return VERR_COM_IPRT_ERROR;
        case NEMU_E_PDM_ERROR:                  return VERR_COM_PDM_ERROR;
        case NEMU_E_INVALID_OBJECT_STATE:       return VERR_COM_INVALID_OBJECT_STATE;
        case NEMU_E_HOST_ERROR:                 return VERR_COM_HOST_ERROR;
        case NEMU_E_NOT_SUPPORTED:              return VERR_COM_NOT_SUPPORTED;
        case NEMU_E_XML_ERROR:                  return VERR_COM_XML_ERROR;
        case NEMU_E_INVALID_SESSION_STATE:      return VERR_COM_INVALID_SESSION_STATE;
        case NEMU_E_OBJECT_IN_USE:              return VERR_COM_OBJECT_IN_USE;
...
/*static*/ HRESULT
Global::nemuStatusCodeToCOM(int aNemuStatus)
{
    switch (aNemuStatus)
    {
        ...
        case VERR_COM_OBJECT_NOT_FOUND:         return NEMU_E_OBJECT_NOT_FOUND;
        case VERR_COM_INVALID_VM_STATE:         return NEMU_E_INVALID_VM_STATE;
        case VERR_COM_VM_ERROR:                 return NEMU_E_VM_ERROR;
        case VERR_COM_FILE_ERROR:               return NEMU_E_FILE_ERROR;
        case VERR_COM_IPRT_ERROR:               return NEMU_E_IPRT_ERROR;
        case VERR_COM_PDM_ERROR:                return NEMU_E_PDM_ERROR;
        case VERR_COM_INVALID_OBJECT_STATE:     return NEMU_E_INVALID_OBJECT_STATE;
        case VERR_COM_HOST_ERROR:               return NEMU_E_HOST_ERROR;
        case VERR_COM_NOT_SUPPORTED:            return NEMU_E_NOT_SUPPORTED;
        case VERR_COM_XML_ERROR:                return NEMU_E_XML_ERROR;
        case VERR_COM_INVALID_SESSION_STATE:    return NEMU_E_INVALID_SESSION_STATE;
        case VERR_COM_OBJECT_IN_USE:            return NEMU_E_OBJECT_IN_USE;
        ...
        default:
            AssertMsgFailed(("%Rrc\n", aNemuStatus));
            if (RT_SUCCESS(aNemuStatus))
                return S_OK;

            /* try categorize it */
            if (   aNemuStatus < 0
                && (   aNemuStatus > -1000
                    || (aNemuStatus < -22000 && aNemuStatus > -32766) )
               )
                return NEMU_E_IPRT_ERROR;
            if (    aNemuStatus <  VERR_PDM_NO_SUCH_LUN / 100 * 10
                &&  aNemuStatus >  VERR_PDM_NO_SUCH_LUN / 100 * 10 - 100)
                return NEMU_E_PDM_ERROR;
            if (    aNemuStatus <= -1000
                &&  aNemuStatus >  -5000 /* wrong, but so what... */)
                return NEMU_E_VM_ERROR;
