...
#define PR_Yield NemuNsprPR_Yield
#define PR_Select NemuNsprPR_Select
#define PR_FD_ZERO NemuNsprPR_FD_ZERO
#define PR_FD_SET NemuNsprPR_FD_SET
#define PR_FD_CLR NemuNsprPR_FD_CLR
#define PR_FD_ISSET NemuNsprPR_FD_ISSET
#define PR_FD_NSET NemuNsprPR_FD_NSET
#define PR_FD_NCLR NemuNsprPR_FD_NCLR
#define PR_FD_NISSET NemuNsprPR_FD_NISSET
#define PR_Stat NemuNsprPR_Stat
