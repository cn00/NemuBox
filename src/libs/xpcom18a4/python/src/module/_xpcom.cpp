...
# endif
# ifdef NEMU_PYXPCOM_VERSIONED
#  if   PY_VERSION_HEX >= 0x02080000
#   define MODULE_NAME    MANGLE_MODULE_NAME("NemuPython2_8")
#   define initNemuPython MANGLE_MODULE_INIT(initNemuPython2_8)

#  elif PY_VERSION_HEX >= 0x02070000
#   define MODULE_NAME    MANGLE_MODULE_NAME("NemuPython2_7")
#   define initNemuPython MANGLE_MODULE_INIT(initNemuPython2_7)

#  elif PY_VERSION_HEX >= 0x02060000
#   define MODULE_NAME    MANGLE_MODULE_NAME("NemuPython2_6")
#   define initNemuPython MANGLE_MODULE_INIT(initNemuPython2_6)

#  elif PY_VERSION_HEX >= 0x02050000
#   define MODULE_NAME 	  MANGLE_MODULE_NAME("NemuPython2_5")
#   define initNemuPython MANGLE_MODULE_INIT(initNemuPython2_5)

#  elif PY_VERSION_HEX >= 0x02040000
#   define MODULE_NAME    MANGLE_MODULE_NAME("NemuPython2_4")
#   define initNemuPython MANGLE_MODULE_INIT(initNemuPython2_4)

#  elif PY_VERSION_HEX >= 0x02030000
#   define MODULE_NAME    MANGLE_MODULE_NAME("NemuPython2_3")
#   define initNemuPython MANGLE_MODULE_INIT(initNemuPython2_3)
#  else
#   error "Fix module versioning."
#  endif
# else
#  define MODULE_NAME 	  MANGLE_MODULE_NAME("NemuPython")
#  define initNemuPython  MANGLE_MODULE_INIT(initNemuPython)
# endif
#else
...
extern "C" NS_EXPORT
void
initNemuPython() { /* NOTE! This name is redefined at the top of the file! */
  static bool s_nemuInited = false;
  if (!s_nemuInited) {
    int rc = 0;

#if defined(NEMU_PATH_APP_PRIVATE_ARCH) && defined(NEMU_PATH_SHARED_LIBS)
    rc = RTR3InitDll(RTR3INIT_FLAGS_UNOBTRUSIVE);
#else
    const char *home = getenv("NEMU_PROGRAM_PATH");
    if (home) {
