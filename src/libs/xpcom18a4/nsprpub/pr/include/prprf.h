...
#define PR_snprintf NemuNsprPR_snprintf
#define PR_vsnprintf NemuNsprPR_vsnprintf
#define PR_smprintf NemuNsprPR_smprintf
#define PR_smprintf_free NemuNsprPR_smprintf_free
#define PR_sprintf_append NemuNsprPR_sprintf_append
#define PR_sxprintf NemuNsprPR_sxprintf
#define PR_fprintf NemuNsprPR_fprintf
#define PR_vsmprintf NemuNsprPR_vsmprintf
#define PR_vsprintf_append NemuNsprPR_vsprintf_append
#define PR_vsxprintf NemuNsprPR_vsxprintf
#define PR_vfprintf NemuNsprPR_vfprintf
#define PR_sscanf NemuNsprPR_sscanf
