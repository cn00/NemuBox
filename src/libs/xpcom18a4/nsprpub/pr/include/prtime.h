...
#define PR_Now NemuNsprPR_Now
#define PR_ExplodeTime NemuNsprPR_ExplodeTime
#define PR_ImplodeTime NemuNsprPR_ImplodeTime
#define PR_NormalizeTime NemuNsprPR_NormalizeTime
#define PR_LocalTimeParameters NemuNsprPR_LocalTimeParameters
#define PR_GMTParameters NemuNsprPR_GMTParameters
#define PR_USPacificTimeParameters NemuNsprPR_USPacificTimeParameters
#define PR_ParseTimeString NemuNsprPR_ParseTimeString
#define PR_FormatTime NemuNsprPR_FormatTime
#define PR_FormatTimeUSEnglish NemuNsprPR_FormatTimeUSEnglish
