...
#ifndef ___darwin_NemuCocoaApplication_h
#define ___darwin_NemuCocoaApplication_h
 ...
 */
typedef bool (*PFNNEMUCACALLBACK)(const void *pvCocoaEvent, const void *pvCarbonEvent, void *pvUser);
...
public:
    ...
    void registerForNativeEvents(uint32_t fMask, PFNNEMUCACALLBACK pfnCallback, void *pvUser);
    /** Unregister native @a pfnCallback of the @a pvUser taking event @a fMask into account. */
    void unregisterForNativeEvents(uint32_t fMask, PFNNEMUCACALLBACK pfnCallback, void *pvUser);
...
#endif /* ___darwin_NemuCocoaApplication_h */
