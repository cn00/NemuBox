...
*********************************************************************************************************************************/
/** The service name. */
#define SUPSVC_SERVICE_NAME             "NemuSupSvc"
...
{
    HANDLE hEventLog = RegisterEventSource(NULL /* local computer */, "NemuSupSvc");
...
{
    RTPrintf("NemuSupSvc: The \"interrogate\" action is not implemented.\n");
    return 1;
}
...
{
    RTPrintf("NemuSupSvc: The \"stop\" action is not implemented.\n");
    return 1;
}
...
{
    RTPrintf("NemuSupSvc: The \"continue\" action is not implemented.\n");
    return 1;
}
...
{
    RTPrintf("NemuSupSvc: The \"pause\" action is not implemented.\n");
    return 1;
}
...
{
    RTPrintf("NemuSupSvc: The \"start\" action is not implemented.\n");
    return 1;
}
...
{
    RTPrintf("NemuSupSvc: The \"qdescription\" action is not implemented.\n");
    return 1;
}
...
{
    RTPrintf("NemuSupSvc: The \"qconfig\" action is not implemented.\n");
    return 1;
}
...
{
    RTPrintf("NemuSupSvc: The \"disable\" action is not implemented.\n");
    return 1;
}

static int supSvcWinEnable(int argc, char **argv)
{
    RTPrintf("NemuSupSvc: The \"enable\" action is not implemented.\n");
    return 1;
}
...
static int supSvcWinShowHelp(void)
{
    ...
    RTPrintf("Usage:\n"
             ...
             "NemuSupSvc\n"
             "      Runs the service.\n"
             "NemuSupSvc <version|-v|--version> [-brief]\n"
             "      Displays the version.\n"
             "NemuSupSvc <help|-?|-h|--help> [...]\n"
             "      Displays this help screen.\n"
             "\n"
             "NemuSupSvc <install|/RegServer|/i>\n"
             "      Installs the service.\n"
             "NemuSupSvc <install|delete|/UnregServer|/u>\n"
...
/**
 * NemuSUPSvc main(), Windows edition.
 *
 *
...
int main(int argc, char **argv)
{
     ...
     */
#ifdef DEBUG_bird
    RTEnvSet("NEMU_LOG", "sup=~0");
    RTEnvSet("NEMU_LOG_DEST", "file=E:\\temp\\NemuSupSvc.log");
    RTEnvSet("NEMU_LOG_FLAGS", "unbuffered thread msprog");
#endif
