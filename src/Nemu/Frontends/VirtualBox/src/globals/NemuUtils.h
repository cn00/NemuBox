/* $Id: NemuUtils.h $ */
/** @file
 * Nemu Qt GUI - Declarations of utility classes and functions.
 */
...
#ifndef ___NemuUtils_h___
#define ___NemuUtils_h___
...
private:
    ...
    static ProxyState proxyStateFromString(const QString &strState)
    {
        ...
        states["ProxyDisabled"] = ProxyState_Disabled; // New since Nemu 5.0
        states["proxyEnabled"]  = ProxyState_Enabled;  // Old since Nemu 4.1
        states["ProxyEnabled"]  = ProxyState_Enabled;  // New since Nemu 5.0
