...
/** @file
 * Nemu audio devices: Mac OS X CoreAudio audio driver.
 */
...
typedef struct COREAUDIOSTREAMOUT
{
    ...
    /* Stream description which is selected for using by Nemu */
                                                 ...
                                                 uint32_t *pcSamples)
{
     ...
     * export NEMU_COREAUDIO_OUTPUT_DEVICE_UID=AppleHDAEngineOutput:0
     * to set it. */
