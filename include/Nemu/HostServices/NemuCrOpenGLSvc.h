...
#ifndef ___Nemu_HostService_NemuCrOpenGLSvc_h
#define ___Nemu_HostService_NemuCrOpenGLSvc_h
...
AssertCompileSize(CRNEMUHGSMIHDR, 16);
...
} CRNEMUHGCMSETSCALEFACTOR;

typedef struct
{
    bool     fUnscaledHiDPI;
} CRNEMUHGCMSETUNSCALEDHIDPIOUTPUT;
