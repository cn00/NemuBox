...
void PACK_APIENTRY crPackGetAttachedObjectsARB(NemuGLhandleARB containerObj, GLsizei maxCount, GLsizei * count, NemuGLhandleARB * obj, int * writeback)
{
	CR_GET_PACKER_CONTEXT(pc);
	unsigned char *data_ptr;
	(void) pc;
	...
	WRITE_DATA(8, NemuGLhandleARB, containerObj);
	WRITE_DATA(12, GLsizei, maxCount);
	WRITE_NETWORK_POINTER(16, (void *) count);
	WRITE_NETWORK_POINTER(24, (void *) writeback);
	WRITE_OPCODE(pc, CR_EXTEND_OPCODE);
...
void PACK_APIENTRY crPackGetInfoLogARB(NemuGLhandleARB obj, GLsizei maxLength, GLsizei * length, GLcharARB * infoLog, int * writeback)
{
	CR_GET_PACKER_CONTEXT(pc);
	unsigned char *data_ptr;
	(void) pc;
	...
	WRITE_DATA(8, NemuGLhandleARB, obj);
