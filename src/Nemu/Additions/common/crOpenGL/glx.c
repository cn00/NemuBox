...
#ifndef NEMU_NO_NATIVEGL  /* Currently not used */
...
#ifndef NEMU_NO_NATIVEGL /* Old code */
DECLEXPORT(XVisualInfo *)
NEMUGLXTAG(glXChooseVisual)( Display *dpy, int screen, int *attribList )
{
    XVisualInfo *vis;
    int *attrib;
    int visBits = 0;
 ...
 */
DECLEXPORT(void)
NEMUGLXTAG(glXCopyContext)( Display *dpy, GLXContext src, GLXContext dst, 
...
NEMUGLXTAG(glXCreateContext)(Display *dpy, XVisualInfo *vis, GLXContext share, Bool direct)
{
...
#ifndef NEMU_NO_NATIVEGL  /* We only care about the host capabilities, not the guest. */
...
DECLEXPORT(void) NEMUGLXTAG(glXDestroyContext)( Display *dpy, GLXContext ctx )
{
    (void) dpy;
...
DECLEXPORT(Bool) NEMUGLXTAG(glXMakeCurrent)( Display *dpy, GLXDrawable drawable, GLXContext ctx )
{
    ContextInfo *context;
    WindowInfo *window;
    Bool retVal;
...
DECLEXPORT(GLXPixmap) NEMUGLXTAG(glXCreateGLXPixmap)( Display *dpy, XVisualInfo *vis, Pixmap pixmap )
{
    stubInit();
    return NEMUGLXTAG(glXCreatePixmap)(dpy, (GLXFBConfig)vis->visualid, pixmap, NULL);
}

DECLEXPORT(void) NEMUGLXTAG(glXDestroyGLXPixmap)( Display *dpy, GLXPixmap pix )
{
    NEMUGLXTAG(glXDestroyPixmap)(dpy, pix);
}

#ifndef NEMU_NO_NATIVEGL  /* old code */
DECLEXPORT(int) NEMUGLXTAG(glXGetConfig)( Display *dpy, XVisualInfo *vis, int attrib, int *value )
{
    struct VisualInfo *v;
    int visBits;
...
DECLEXPORT(GLXContext) NEMUGLXTAG(glXGetCurrentContext)( void )
{
...
DECLEXPORT(GLXDrawable) NEMUGLXTAG(glXGetCurrentDrawable)(void)
{
    return currentDrawable;
}

DECLEXPORT(Display *) NEMUGLXTAG(glXGetCurrentDisplay)(void)
{
    return currentDisplay;
}

DECLEXPORT(Bool) NEMUGLXTAG(glXIsDirect)(Display *dpy, GLXContext ctx)
{
    (void) dpy;
    (void) ctx;
    crDebug("->glXIsDirect");
...
DECLEXPORT(Bool) NEMUGLXTAG(glXQueryExtension)(Display *dpy, int *errorBase, int *eventBase)
{
    (void) dpy;
    (void) errorBase;
    (void) eventBase;
...
DECLEXPORT(Bool) NEMUGLXTAG(glXQueryVersion)( Display *dpy, int *major, int *minor )
{
    (void) dpy;
    *major = 1;
    *minor = 3;
...
DECLEXPORT(void) NEMUGLXTAG(glXSwapBuffers)( Display *dpy, GLXDrawable drawable )
{
    WindowInfo *window = stubGetWindowInfo(dpy, drawable);
    stubSwapBuffers( window, 0 );

#ifdef NEMU_TEST_MEGOO
...
#ifndef NEMU_NO_NATIVEGL
DECLEXPORT(void) NEMUGLXTAG(glXUseXFont)( Font font, int first, int count, int listBase )
{
    ContextInfo *context = stubGetCurrentContext();
...
DECLEXPORT(void) NEMUGLXTAG(glXWaitGL)( void )
{
...
DECLEXPORT(void) NEMUGLXTAG(glXWaitX)( void )
{
    static int first_call = 1;
...
DECLEXPORT(const char *) NEMUGLXTAG(glXQueryExtensionsString)( Display *dpy, int screen )
{
...
DECLEXPORT(const char *) NEMUGLXTAG(glXGetClientString)( Display *dpy, int name )
{
    const char *retval;
    (void) dpy;
    (void) name;
...
DECLEXPORT(const char *) NEMUGLXTAG(glXQueryServerString)( Display *dpy, int screen, int name )
{
    const char *retval;
    (void) dpy;
    (void) screen;
...
DECLEXPORT(CR_GLXFuncPtr) NEMUGLXTAG(glXGetProcAddressARB)( const GLubyte *name )
{
    return (CR_GLXFuncPtr) crGetProcAddress( (const char *) name );
}

DECLEXPORT(CR_GLXFuncPtr) NEMUGLXTAG(glXGetProcAddress)( const GLubyte *name )
{
    return (CR_GLXFuncPtr) crGetProcAddress( (const char *) name );
}
...
NEMUGLXTAG(glXCreateGLXPbufferSGIX)(Display *dpy, GLXFBConfigSGIX config,
...
DECLEXPORT(void) NEMUGLXTAG(glXDestroyGLXPbufferSGIX)(Display *dpy, GLXPbuffer pbuf)
{
    (void) dpy;
    (void) pbuf;
...
DECLEXPORT(void) NEMUGLXTAG(glXSelectEventSGIX)(Display *dpy, GLXDrawable drawable, unsigned long mask)
{
    (void) dpy;
    (void) drawable;
    (void) mask;
...
DECLEXPORT(void) NEMUGLXTAG(glXGetSelectedEventSGIX)(Display *dpy, GLXDrawable drawable, unsigned long *mask)
{
    (void) dpy;
    (void) drawable;
    (void) mask;
...
DECLEXPORT(int) NEMUGLXTAG(glXQueryGLXPbufferSGIX)(Display *dpy, GLXPbuffer pbuf,
...
DECLEXPORT(int) NEMUGLXTAG(glXGetFBConfigAttribSGIX)(Display *dpy, GLXFBConfig config,
                                                     int attribute, int *value)
{
    return NEMUGLXTAG(glXGetFBConfigAttrib)(dpy, config, attribute, value);
}

DECLEXPORT(GLXFBConfigSGIX *) 
NEMUGLXTAG(glXChooseFBConfigSGIX)(Display *dpy, int screen,
                                  int *attrib_list, int *nelements)
{
    return NEMUGLXTAG(glXChooseFBConfig)(dpy, screen, attrib_list, nelements);
}

DECLEXPORT(GLXPixmap) 
NEMUGLXTAG(glXCreateGLXPixmapWithConfigSGIX)(Display *dpy,
                                             GLXFBConfig config,
                                             Pixmap pixmap)
{
    return NEMUGLXTAG(glXCreatePixmap)(dpy, config, pixmap, NULL);
}

DECLEXPORT(GLXContext) 
NEMUGLXTAG(glXCreateContextWithConfigSGIX)(Display *dpy, GLXFBConfig config,
                                           int render_type,
                                           ...
                                           Bool direct)
{
    ...
    else
    {
        ...
        vis = NEMUGLXTAG(glXGetVisualFromFBConfigSGIX)(dpy, config);
        if (!vis)
        {
            crWarning("glXCreateContextWithConfigSGIX: no visuals for %p", config);
            return NULL;
        }
        ret =  NEMUGLXTAG(glXCreateContext)(dpy, vis, share_list, direct);
        XFree(vis);
        return ret;
    }
}
...
DECLEXPORT(XVisualInfo *) 
NEMUGLXTAG(glXGetVisualFromFBConfigSGIX)(Display *dpy,
                                         GLXFBConfig config)
{
    return NEMUGLXTAG(glXGetVisualFromFBConfig)(dpy, config);
}

DECLEXPORT(GLXFBConfigSGIX)
NEMUGLXTAG(glXGetFBConfigFromVisualSGIX)(Display *dpy, XVisualInfo *vis)
{
    if (!vis)
    {
        return NULL;
    ...
    return (GLXFBConfigSGIX) NEMUGLXTAG(glXGetVisualFromFBConfig)(dpy, (GLXFBConfig)vis->visualid);
}
...
NEMUGLXTAG(glXChooseFBConfig)(Display *dpy, int screen, ATTRIB_TYPE *attrib_list, int *nelements)
{
    ATTRIB_TYPE *attrib;
    intptr_t fbconfig = 0;
    ...
    if (!attrib_list)
    {
        return NEMUGLXTAG(glXGetFBConfigs)(dpy, screen, nelements);
    }
...
DECLEXPORT(GLXContext) 
NEMUGLXTAG(glXCreateNewContext)(Display *dpy, GLXFBConfig config, int render_type, GLXContext share_list, Bool direct)
{
    XVisualInfo *vis;
    ...
    vis = NEMUGLXTAG(glXGetVisualFromFBConfig)(dpy, config);
    return NEMUGLXTAG(glXCreateContext)(dpy, vis, share_list, direct);
}

DECLEXPORT(GLXPbuffer) 
NEMUGLXTAG(glXCreatePbuffer)(Display *dpy, GLXFBConfig config, ATTRIB_TYPE *attrib_list)
{
    (void) dpy;
    (void) config;
    (void) attrib_list;
 ...
 */
DECLEXPORT(GLXPixmap) 
NEMUGLXTAG(glXCreatePixmap)(Display *dpy, GLXFBConfig config, Pixmap pixmap, const ATTRIB_TYPE *attrib_list)
{
    ATTRIB_TYPE *attrib;
    XVisualInfo *pVis;
    GLX_Pixmap_t *pGlxPixmap;
    ...
    pVis = NEMUGLXTAG(glXGetVisualFromFBConfig)(dpy, config);
    if (!pVis)
    {
...
NEMUGLXTAG(glXCreateWindow)(Display *dpy, GLXFBConfig config, Window win, ATTRIB_TYPE *attrib_list)
{
    GLXFBConfig *realcfg;
    int nconfigs;
    (void) config;
...
DECLEXPORT(void) NEMUGLXTAG(glXDestroyPbuffer)(Display *dpy, GLXPbuffer pbuf)
{
    (void) dpy;
    (void) pbuf;
...
DECLEXPORT(void) NEMUGLXTAG(glXDestroyPixmap)(Display *dpy, GLXPixmap pixmap)
{
    stubFindPixmapParms_t parms;
...
DECLEXPORT(void) NEMUGLXTAG(glXDestroyWindow)(Display *dpy, GLXWindow win)
{
    (void) dpy;
    (void) win;
...
DECLEXPORT(GLXDrawable) NEMUGLXTAG(glXGetCurrentReadDrawable)(void)
{
    return currentReadDrawable;
}

DECLEXPORT(int) NEMUGLXTAG(glXGetFBConfigAttrib)(Display *dpy, GLXFBConfig config, int attribute, int *value)
{
    XVisualInfo * pVisual;
    const char * pExt;

    pVisual =  NEMUGLXTAG(glXGetVisualFromFBConfig)(dpy, config);
    if (!pVisual)
    {
...
#if !defined(NEMU_NO_NATIVEGL) || 1 /* need fbconfigs atleast for depths 24 and 32 */
DECLEXPORT(GLXFBConfig *) NEMUGLXTAG(glXGetFBConfigs)(Display *dpy, int screen, int *nelements)
{
...
DECLEXPORT(void) NEMUGLXTAG(glXGetSelectedEvent)(Display *dpy, GLXDrawable draw, unsigned long *event_mask)
{
    (void) dpy;
    (void) draw;
    (void) event_mask;
...
DECLEXPORT(XVisualInfo *) NEMUGLXTAG(glXGetVisualFromFBConfig)(Display *dpy, GLXFBConfig config)
{
    (void) dpy;
    (void) config;
...
DECLEXPORT(Bool) NEMUGLXTAG(glXMakeContextCurrent)(Display *display, GLXDrawable draw, GLXDrawable read, GLXContext ctx)
{
    currentReadDrawable = read;
    return NEMUGLXTAG(glXMakeCurrent)(display, draw, ctx);
}

DECLEXPORT(int) NEMUGLXTAG(glXQueryContext)(Display *dpy, GLXContext ctx, int attribute, int *value)
{
    (void) dpy;
    (void) ctx;
    (void) attribute;
...
DECLEXPORT(void) NEMUGLXTAG(glXQueryDrawable)(Display *dpy, GLXDrawable draw, int attribute, unsigned int *value)
{
    (void) dpy;
    (void) draw;
    (void) attribute;
...
DECLEXPORT(void) NEMUGLXTAG(glXSelectEvent)(Display *dpy, GLXDrawable draw, unsigned long event_mask)
{
    (void) dpy;
    (void) draw;
    (void) event_mask;
...
DECLEXPORT(void) NEMUGLXTAG(glXBindTexImageEXT)(Display *dpy, GLXDrawable draw, int buffer, const int *attrib_list)
{
    static int cnt=0;
    XImage dummyimg;
    ContextInfo *context = stubGetCurrentContext();
...
DECLEXPORT(void) NEMUGLXTAG(glXReleaseTexImageEXT)(Display *dpy, GLXDrawable draw, int buffer)
{
    (void) dpy;
    (void) draw;
    (void) buffer;
...
DECLEXPORT(int) NEMUGLXTAG(glXBindChannelToWindowSGIX)(Display *dpy, int scrn, int chan, Window w)
{
    (void) dpy;
    (void) scrn;
    (void) chan;
...
DECLEXPORT(int) NEMUGLXTAG(glXChannelRectSGIX)(Display *dpy, int scrn, int chan, int x , int y, int w, int h)
{
    (void) dpy;
    (void) scrn;
    (void) chan;
...
DECLEXPORT(int) NEMUGLXTAG(glXQueryChannelRectSGIX)(Display *dpy, int scrn, int chan, int *x, int *y, int *w, int *h)
{
    (void) dpy;
    (void) scrn;
    (void) chan;
...
DECLEXPORT(int) NEMUGLXTAG(glXQueryChannelDeltasSGIX)(Display *dpy, int scrn, int chan, int *dx, int *dy, int *dw, int *dh)
{
    (void) dpy;
    (void) scrn;
    (void) chan;
...
DECLEXPORT(int) NEMUGLXTAG(glXChannelRectSyncSGIX)(Display *dpy, int scrn, int chan, GLenum synctype)
{
    (void) dpy;
    (void) scrn;
    (void) chan;
...
DECLEXPORT(const char *) NEMUGLXTAG(glXGetDriverConfig)(const char *driverName)
{
    return NULL;
}

DECLEXPORT(void) NEMUGLXTAG(glXFreeMemoryMESA)(Display *dpy, int scrn, void *pointer)
{
    (void) dpy;
    (void) scrn;
    (void) pointer;
...
DECLEXPORT(GLXContext) NEMUGLXTAG(glXImportContextEXT)(Display *dpy, GLXContextID contextID)
{
    (void) dpy;
    (void) contextID;
    return NULL;
...
DECLEXPORT(GLXContextID) NEMUGLXTAG(glXGetContextIDEXT)(const GLXContext ctx)
{
    (void) ctx;
    return 0;
}

DECLEXPORT(Bool) NEMUGLXTAG(glXMakeCurrentReadSGI)(Display *display, GLXDrawable draw, GLXDrawable read, GLXContext ctx)
{
    return NEMUGLXTAG(glXMakeContextCurrent)(display, draw, read, ctx);
}

DECLEXPORT(const char *) NEMUGLXTAG(glXGetScreenDriver)(Display *dpy, int scrNum)
{
    static char *screendriver = "nemuvideo";
    return screendriver;
}

DECLEXPORT(Display *) NEMUGLXTAG(glXGetCurrentDisplayEXT)(void)
{
    return NEMUGLXTAG(glXGetCurrentDisplay());
}

DECLEXPORT(void) NEMUGLXTAG(glXFreeContextEXT)(Display *dpy, GLXContext ctx)
{
    NEMUGLXTAG(glXDestroyContext(dpy, ctx));
}

/*Mesa internal*/
DECLEXPORT(int) NEMUGLXTAG(glXQueryContextInfoEXT)(Display *dpy, GLXContext ctx)
{
    (void) dpy;
    (void) ctx;
    return 0;
...
DECLEXPORT(void *) NEMUGLXTAG(glXAllocateMemoryMESA)(Display *dpy, int scrn,
...
DECLEXPORT(GLuint) NEMUGLXTAG(glXGetMemoryOffsetMESA)(Display *dpy, int scrn, const void *pointer)
{
    (void) dpy;
    (void) scrn;
    (void) pointer;
...
DECLEXPORT(GLXPixmap) NEMUGLXTAG(glXCreateGLXPixmapMESA)(Display *dpy, XVisualInfo *visual, Pixmap pixmap, Colormap cmap)
{
    (void) dpy;
    (void) visual;
    (void) pixmap;
