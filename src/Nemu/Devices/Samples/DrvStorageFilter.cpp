...
/** @file
 * Nemu storage filter driver sample.
 */
 ...
 */
extern "C" DECLEXPORT(int) NemuDriversRegister(PPDMDRVREGCB pCallbacks, uint32_t u32Version)
{
    LogFlow(("NemuSampleDriver::NemuDriversRegister: u32Version=%#x pCallbacks->u32Version=%#x\n",
