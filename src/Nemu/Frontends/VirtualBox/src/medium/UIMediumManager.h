...
/** @file
 * Nemu Qt GUI - UIMediumManager class declaration.
 */
...
private slots:
    ...
    /** Handles NemuGlobal::sigMediumCreated signal. */
    void sltHandleMediumCreated(const QString &strMediumID);
    /** Handles NemuGlobal::sigMediumDeleted signal. */
    void sltHandleMediumDeleted(const QString &strMediumID);

    /** Handles NemuGlobal::sigMediumEnumerationStarted signal. */
    void sltHandleMediumEnumerationStart();
    /** Handles NemuGlobal::sigMediumEnumerated signal. */
    void sltHandleMediumEnumerated(const QString &strMediumID);
    /** Handles NemuGlobal::sigMediumEnumerationFinished signal. */
