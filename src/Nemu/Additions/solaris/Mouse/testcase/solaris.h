/* $Id: solaris.h $ */
/** @file
 * NemuGuest - Guest Additions Driver for Solaris - testcase stubs.
 */
...
#ifndef ___NemuGuestTestCaseSolaris_h
#define ___NemuGuestTestCaseSolaris_h
...
#define _init nemuguestSolarisInit
extern int nemuguestSolarisInit(void);
#define _fini nemuguestSolarisFini
extern int nemuguestSolarisFini(void);
#define _info nemuguestSolarisInfo
extern int nemuguestSolarisInfo(struct modinfo *pModInfo);
...
#if 0
#define NemuGuestCreateKernelSession(...) VINF_SUCCESS
#define NemuGuestCreateUserSession(...) VINF_SUCCESS
#define NemuGuestCloseSession(...) do {} while(0)
#define NemuGuestInitDevExt(...) VINF_SUCCESS
#define NemuGuestDeleteDevExt(...) do {} while(0)
#define NemuGuestCommonIOCtl(...) VINF_SUCCESS
#define NemuGuestCommonISR(...) true
...
#endif  /* ___NemuGuestTestCaseSolaris_h */
