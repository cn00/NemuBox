...
#ifndef ___NemuNetBaseService_h___
#define ___NemuNetBaseService_h___

#include <iprt/critsect.h>


class NemuNetHlpUDPService
{
public:
...
{
public:
    NemuNetALock(NemuNetLockee *a_lck):m_lck(a_lck)
    {
        if (m_lck)
            m_lck->syncEnter();
    }
...
class NemuNetBaseService: public NemuNetHlpUDPService, public NemuNetLockee
{
public:
    NemuNetBaseService(const std::string& aName, const std::string& aNetworkName);
    virtual ~NemuNetBaseService();
