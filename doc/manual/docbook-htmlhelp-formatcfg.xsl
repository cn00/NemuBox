...
<xsl:import href="@NEMU_PATH_DOCBOOK@/htmlhelp/htmlhelp.xsl"/>
<xsl:import href="@NEMU_PATH_MANUAL_SRC@/common-formatcfg.xsl"/>
<xsl:import href="@NEMU_PATH_MANUAL_SRC@/common-html-formatcfg.xsl"/>

<xsl:include href="@NEMU_PATH_MANUAL_OUT_LANG@/titlepage-htmlhelp.xsl"/>
