...
# define NEMU_XPG6_TMP_DEF
# define _XPG6
#endif
#if defined(RT_OS_SOLARIS) && defined(__USE_LEGACY_PROTOTYPES__)
# define NEMU_LEGACY_PROTO_TMP_DEF
# undef __USE_LEGACY_PROTOTYPES__
#endif
#include <iconv.h>
#if defined(NEMU_XPG6_TMP_DEF)
# undef _XPG6
# undef NEMU_XPG6_TMP_DEF
#endif
#if defined(NEMU_LEGACY_PROTO_TMP_DEF)
# define  __USE_LEGACY_PROTOTYPES__
# undef NEMU_LEGACY_PROTO_TMP_DEF
#endif
