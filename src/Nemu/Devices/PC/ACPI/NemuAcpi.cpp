/* $Id: NemuAcpi.cpp $ */
/** @file
 * NemuAcpi - VirtualBox ACPI manipulation functionality.
 */
...
/* nemu.dsl - input to generate proper DSDT on the fly */
# include <nemudsl.hex>
#else
/* Statically compiled AML */
# include <nemuaml.hex>
# include <nemussdt-standard.hex>
# include <nemussdt-cpuhotplug.hex>
#endif
