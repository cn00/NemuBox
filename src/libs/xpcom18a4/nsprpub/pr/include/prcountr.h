...
#define PR_CreateCounter NemuNsprPR_CreateCounter
#define PR_DestroyCounter NemuNsprPR_DestroyCounter
#define PR_GetCounterHandleFromName NemuNsprPR_GetCounterHandleFromName
#define PR_GetCounterNameFromHandle NemuNsprPR_GetCounterNameFromHandle
#define PR_IncrementCounter NemuNsprPR_IncrementCounter
#define PR_DecrementCounter NemuNsprPR_DecrementCounter
#define PR_AddToCounter NemuNsprPR_AddToCounter
#define PR_SubtractFromCounter NemuNsprPR_SubtractFromCounter
#define PR_GetCounter NemuNsprPR_GetCounter
#define PR_SetCounter NemuNsprPR_SetCounter
#define PR_FindNextCounterQname NemuNsprPR_FindNextCounterQname
#define PR_FindNextCounterRname NemuNsprPR_FindNextCounterRname
