/* $Id: vscsi.h $ */
/** @file
 * Nemu storage drivers - Virtual SCSI driver
 */
...
#ifndef ___Nemu_vscsi_h
#define ___Nemu_vscsi_h
...
#ifdef IN_RING0
# error "There are no Nemu VSCSI APIs available in Ring-0 Host Context!"
#endif
...
typedef struct VSCSILUNIOCALLBACKS
{
     ...
     *
     * @returns Nemu status status code.
 ...
 */
NEMUDDU_DECL(int) VSCSIDeviceCreate(PVSCSIDEVICE phVScsiDevice,
 ...
 */
NEMUDDU_DECL(int) VSCSIDeviceDestroy(VSCSIDEVICE hVScsiDevice);
 ...
 */
NEMUDDU_DECL(int) VSCSIDeviceLunAttach(VSCSIDEVICE hVScsiDevice, VSCSILUN hVScsiLun, uint32_t iLun);
 ...
 */
NEMUDDU_DECL(int) VSCSIDeviceLunDetach(VSCSIDEVICE hVScsiDevice, uint32_t iLun,
 ...
 */
NEMUDDU_DECL(int) VSCSIDeviceLunQueryType(VSCSIDEVICE hVScsiDevice, uint32_t iLun,
 ...
 */
NEMUDDU_DECL(int) VSCSIDeviceReqEnqueue(VSCSIDEVICE hVScsiDevice, VSCSIREQ hVScsiReq);
 ...
 */
NEMUDDU_DECL(int) VSCSIDeviceReqCreate(VSCSIDEVICE hVScsiDevice, PVSCSIREQ phVScsiReq,
 ...
 */
NEMUDDU_DECL(int) VSCSILunCreate(PVSCSILUN phVScsiLun, VSCSILUNTYPE enmLunType,
 ...
 */
NEMUDDU_DECL(int) VSCSILunDestroy(VSCSILUN hVScsiLun);
 ...
 * @param   hVScsiLun               The virtual SCSI LUN handle to destroy.
 */
NEMUDDU_DECL(int) VSCSILunMountNotify(VSCSILUN hVScsiLun);
 ...
 * @param   hVScsiLun               The virtual SCSI LUN handle to destroy.
 */
NEMUDDU_DECL(int) VSCSILunUnmountNotify(VSCSILUN hVScsiLun);
 ...
 */
NEMUDDU_DECL(int) VSCSIIoReqCompleted(VSCSIIOREQ hVScsiIoReq, int rcIoReq, bool fRedoPossible);
 ...
 */
NEMUDDU_DECL(VSCSIIOREQTXDIR) VSCSIIoReqTxDirGet(VSCSIIOREQ hVScsiIoReq);
 ...
 */
NEMUDDU_DECL(int) VSCSIIoReqParamsGet(VSCSIIOREQ hVScsiIoReq, uint64_t *puOffset,
 ...
 */
NEMUDDU_DECL(int) VSCSIIoReqUnmapParamsGet(VSCSIIOREQ hVScsiIoReq, PCRTRANGE *ppaRanges,
                                           unsigned *pcRanges);

/** @}  */
RT_C_DECLS_END

#endif /* ___Nemu_vscsi_h */
