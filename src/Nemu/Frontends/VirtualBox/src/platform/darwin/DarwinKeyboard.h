/* $Id:  $ */
/** @file
 * Nemu Qt GUI - Common GUI Library - Darwin Keyboard routines.
 *
...
/** The scancode mask. */
#define NEMUKEY_SCANCODE_MASK       0x007f
/** Extended key. */
#define NEMUKEY_EXTENDED            0x0080
/** Modifier key. */
#define NEMUKEY_MODIFIER            0x0400
/** Lock key (like num lock and caps lock). */
#define NEMUKEY_LOCK                0x0800
