...
#define PR_CreateAlarm NemuNsprPR_CreateAlarm
#define PR_DestroyAlarm NemuNsprPR_DestroyAlarm
#define PR_SetAlarm NemuNsprPR_SetAlarm
#define PR_ResetAlarm NemuNsprPR_ResetAlarm
