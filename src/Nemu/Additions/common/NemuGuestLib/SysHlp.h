/* $Id: SysHlp.h $ */
/** @file
 * NemuGuestLibR0 - System dependent helpers internal header.
 */
...
#ifndef ___NemuGuestLib_SysHlp_h
#define ___NemuGuestLib_SysHlp_h
...
/**
 * Answers whether the NemuGuest driver is opened
 *
 * @param pDriver      Pointer to the driver structure.
 *
