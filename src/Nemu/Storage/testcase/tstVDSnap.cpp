/** @file
 *
 * Snapshot Nemu HDD container test utility.
 */
...
static int tstVDSnapWrite(PNEMUHDD pVD, PVDDISKSEG paDiskSegments,
...
static int tstVDSnapReadVerify(PNEMUHDD pVD, PVDDISKSEG paDiskSegments, uint32_t cDiskSegments, uint64_t cbDisk)
{
    int rc = VINF_SUCCESS;
