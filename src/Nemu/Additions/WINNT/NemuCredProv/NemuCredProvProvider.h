...
#ifndef ___NEMU_CREDPROV_PROVIDER_H___
#define ___NEMU_CREDPROV_PROVIDER_H___
...
class NemuCredProvProvider : public ICredentialProvider
{
public:
    ...
    friend HRESULT NemuCredProvProviderCreate(REFIID riid, __deref_out void **ppv);

protected:

    NemuCredProvProvider(void);
    virtual ~NemuCredProvProvider(void);
...
private:
    ...
    NemuCredProvCredential                  *m_pCred;
    /** Poller thread for credential lookup. */
    NemuCredProvPoller                      *m_pPoller;
...
#endif /* !___NEMU_CREDPROV_PROVIDER_H___ */
