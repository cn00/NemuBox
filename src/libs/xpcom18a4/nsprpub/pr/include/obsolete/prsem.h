...
#define PR_NewSem NemuNsprPR_NewSem
#define PR_DestroySem NemuNsprPR_DestroySem
#define PR_WaitSem NemuNsprPR_WaitSem
#define PR_PostSem NemuNsprPR_PostSem
#define PR_GetValueSem NemuNsprPR_GetValueSem
