 ...
 *  Generator : src/Nemu/Main/idl/xpcidl.xsl
 *
...
struct INemuSVCAvailabilityChangedEvent;
...
typedef struct INemuSVCAvailabilityChangedEvent INemuSVCAvailabilityChangedEvent;
...
#define NEMUEVENTTYPE_IID_STR "0d67e79e-b7b1-4919-aab3-b36866075515"
...
struct IVirtualSystemDescription_vtbl
{
    ...
    nsresult (*GetDescription)(
        ...
        PRUint32 *aNemuValuesSize,
        PRUnichar *** aNemuValues,
...
#ifdef IN_NEMUXPCOMC
# define NEMUXPCOMC_DECL(type)  PR_EXPORT(type)
#else
# define NEMUXPCOMC_DECL(type)  PR_IMPORT(type)
#endif
 ...
 * Use NemuGetFunctions() to obtain the pointer to it.
 */
typedef struct NEMUXPCOMC
{
...
/** Pointer to a const NemuXPCOMC function table. */
typedef NEMUXPCOMC const *PCNEMUXPCOM;

/** The current interface version.
 * For use with NemuGetXPCOMCFunctions and to be found in
 * NEMUXPCOMC::uVersion. */
#define NEMU_XPCOMC_VERSION     0x00020000U

NEMUXPCOMC_DECL(PCNEMUXPCOM) NemuGetXPCOMCFunctions(unsigned uVersion);
/** Typedef for NemuGetXPCOMCFunctions. */
typedef PCNEMUXPCOM (*PFNNEMUGETXPCOMCFUNCTIONS)(unsigned uVersion);

/** The symbol name of NemuGetXPCOMCFunctions. */
#if defined(__OS2__)
