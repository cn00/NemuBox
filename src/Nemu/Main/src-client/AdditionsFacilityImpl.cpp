...
const AdditionsFacility::FacilityInfo AdditionsFacility::s_aFacilityInfo[8] =
{
    ...
    { "VirtualBox Base Driver", AdditionsFacilityType_NemuGuestDriver, AdditionsFacilityClass_Driver },
    { "Auto Logon", AdditionsFacilityType_AutoLogon, AdditionsFacilityClass_Feature },
    { "VirtualBox System Service", AdditionsFacilityType_NemuService, AdditionsFacilityClass_Service },
    { "VirtualBox Desktop Integration", AdditionsFacilityType_NemuTrayClient, AdditionsFacilityClass_Program },
