...
/**
 * Nemu internal struct. to passback to EMT rendezvous callback while enabling
 * the KVM wall-clock.
 */
 ...
 */
static DECLCALLBACK(NEMUSTRICTRC) gimR3KvmEnableWallClockCallback(PVM pVM, PVMCPU pVCpu, void *pvData)
{
    Assert(pvData);
