...
#ifndef ___Nemu_shflsvc_h
#define ___Nemu_shflsvc_h
...
/** Read symlink destination (as of Nemu 4.0) */
#define SHFL_FN_READLINK            (18)
/** Create symlink (as of Nemu 4.0) */
#define SHFL_FN_SYMLINK             (19)
/** Ask host to show symlinks (as of Nemu 4.0) */
...
/** Allow the guest to create symbolic links (as of Nemu 4.0) */
...
typedef struct _NemuSFQueryMappings
{
...
/** Parameters structure. */
typedef struct _NemuSFQueryMapName
{
    NemuGuestHGCMCallInfo callInfo;
...
/** Parameters structure. */
typedef struct _NemuSFMapFolder_Old
{
    NemuGuestHGCMCallInfo callInfo;
...
/** Parameters structure. */
typedef struct _NemuSFMapFolder
{
    NemuGuestHGCMCallInfo callInfo;
...
/** Parameters structure. */
typedef struct _NemuSFUnmapFolder
{
    NemuGuestHGCMCallInfo callInfo;
...
/** Parameters structure. */
typedef struct _NemuSFReadLink
{
    NemuGuestHGCMCallInfo callInfo;
...
/** Parameters structure. */
typedef struct _NemuSFInformation
{
    NemuGuestHGCMCallInfo callInfo;
