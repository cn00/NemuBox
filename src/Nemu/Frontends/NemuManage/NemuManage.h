/* $Id: NemuManage.h $ */
/** @file
 * NemuManage - VirtualBox command-line interface, internal header file.
 */
...
#ifndef ___H_NEMUMANAGE
#define ___H_NEMUMANAGE
...
extern bool g_fDetailedProgress;        // in NemuManage.cpp
...
#ifndef NEMU_ONLY_DOCS
unsigned int getMaxNics(IVirtualBox* nemu, IMachine* mach);
#endif
