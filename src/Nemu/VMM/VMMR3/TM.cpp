...
#ifndef NEMU_WITHOUT_NS_ACCOUNTING
...
static DECLCALLBACK(NEMUSTRICTRC) tmR3CpuTickParavirtDisable(PVM pVM, PVMCPU pVCpu, void *pvData);
...
#ifndef NEMU_WITHOUT_NS_ACCOUNTING
# if defined(NEMU_WITH_STATISTICS) || defined(NEMU_WITH_NS_ACCOUNTING_STATS)
 ...
 *
 * @returns Nemu status code, all errors are asserted.
 * @param   pVM         The cross context VM structure.
...
#endif /* !NEMU_WITHOUT_NS_ACCOUNTING */
 ...
 */
static DECLCALLBACK(NEMUSTRICTRC) tmR3CpuTickParavirtEnable(PVM pVM, PVMCPU pVCpuEmt, void *pvData)
{
 ...
 */
static DECLCALLBACK(NEMUSTRICTRC) tmR3CpuTickParavirtDisable(PVM pVM, PVMCPU pVCpuEmt, void *pvData)
{
