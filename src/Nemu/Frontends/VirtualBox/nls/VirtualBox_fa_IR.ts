...
<context>
    ...
    <message>
        <source>The VirtualBox Linux kernel driver (nemudrv) is either not loaded or there is a permission problem with /dev/nemudrv. Please reinstall the kernel module by executing&lt;br/&gt;&lt;br/&gt;  &lt;font color=blue&gt;&apos;/etc/init.d/nemudrv setup&apos;&lt;/font&gt;&lt;br/&gt;&lt;br/&gt;as root. If it is available in your distribution, you should install the DKMS package first. This package keeps track of Linux kernel changes and recompiles the nemudrv kernel module if necessary.</source>
        <translation type="obsolete">درایور هسته لینوکس ويرچوال باکس (nemudrv) بارگیری نشده است یا مشکلی با سطح دسترسی /dev/nemudrv دارد. لطفا مدل هسته را با اِجرای راه انداز&lt;br/&gt;&lt;br/&gt;  &lt;font color=blue&gt;&apos;/etc/init.d/nemudrv setup&apos;&lt;/font&gt;&lt;br/&gt;&lt;br/&gt;بعنوان ریشه مجددا نصب نمایید. اگر آن در توزیع شما موجود باشد، شما اول باید بسته دی کی اِم اِس را نصب کنید. این بسته تغییرات هسته لینوکس را ردگیری و ذخیره میکند و مدل هسته  nemudrv در صورت نیاز مجددا کامپایل میکند.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>لیست همه پوشه های قابل دسترسی به این ماشین. برای دسترسی به پوشه اشتراکی از &apos;net use x: \\nemusvr\share&apos; استفاده کنید که نام دارد &lt;i&gt;share&lt;/i&gt; از سیستم عامل شبیه داس, یا &apos;mount -t nemusf share mount_point&apos; برای دسترسی آن از سیستم عامل لینوکس. این ویژگی نیاز به افزونه مهمان دارد.</translation>
    </message>
    <message>
        <source>Name</source>
        <translation>نام</translation>
...
<context>
    ...
    <message>
        ...
        <translation>ویرچوال باکس اکنون اجازه دسترسی به دستگاه یو ایس بی را ندارد.  این را میتوانید با افزودن کاربر خود به گروه &apos;nemuusers&apos; تغییر دهید.  لطفا برای توضیحات جزئی تر راهنمای کاربری را ببینید</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;p&gt;یک خطای خطرناک حین اِجرای ماشین مجازی رخ داده و اِجرای ماشین متوقف شده است.&lt;/p&gt;&lt;p&gt;برای راهنمایی، لطفا بخش انجمن را در &lt;a href=https://www.virtualbox.org&gt;https://www.virtualbox.org&lt;/a&gt; ببینید یا با پشتیبانی تماس بگیرید. لطفا محتویات فایل وقایع &lt;tt&gt;Nemu.log&lt;/tt&gt; را ارئه دهید، که میتوانید آنها را در دایرکتوری وقایع پیدا کنید ، همچنین توضیح دهید در حین انجام چه کاری این خطا رخ داد. توجه کنید که شما میتوانید فایل های بالا را با انتخاب &lt;b&gt;نمایش وقایع&lt;/b&gt; از منوی &lt;b&gt;ماشین&lt;/b&gt; در پنجره اصلی ویرچوال باکس دسترسی داشته باشید.&lt;/p&gt;&lt;p&gt;دکمه &lt;b&gt;تأیید&lt;/b&gt; برای قطع برق ماشین فشار دهید.&lt;/p&gt;</translation>
    </message>
    <message>
