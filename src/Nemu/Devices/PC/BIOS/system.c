        ...
        case 0x20: // coded by osmaker aka K.J.
            if(EDX == 0x534D4150) {
...
#ifndef NEMU /* The following excludes 0xf0000000 thru 0xffffffff. Trust DevPcBios.cpp to get this right. */
...
#ifdef NEMU     /* We've already used the CMOS entries for SATA.
                ...
                switch(BX)
                {
...
#ifndef NEMU /** @todo Upstream suggests the following, needs checking. (see next as well) */
                    ...
                    case 2:
#ifdef NEMU
                        /* Mark the BIOS as reserved. Nemu doesn't currently
                    ...
                    case 5:
                     ...
                     case 6:
                        ...
                        break;
                    case 7:
#ifdef NEMU /* Don't succeeded if no memory above 4 GB.  */
