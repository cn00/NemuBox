...
*   Header Files                                                                                                                 *
*********************************************************************************************************************************/
#define NEMU_DEVICE_STRUCT_TESTCASE
#define NEMU_WITH_HGCM                  /* grumble */
#undef LOG_GROUP
...
# ifdef NEMU_WITH_EHCI_IMPL
#  undef LOG_GROUP
#  include "../USB/DevEHCI.cpp"
# endif
# ifdef NEMU_WITH_XHCI_IMPL
#  undef LOG_GROUP
...
# endif /* VNET_TX_DELAY */
    ...
    GEN_CHECK_SIZE(NEMUSCSI);
    GEN_CHECK_OFF(NEMUSCSI, regIdentify);
    GEN_CHECK_OFF(NEMUSCSI, uTargetDevice);
    GEN_CHECK_OFF(NEMUSCSI, uTxDir);
    GEN_CHECK_OFF(NEMUSCSI, cbCDB);
    GEN_CHECK_OFF(NEMUSCSI, abCDB);
    GEN_CHECK_OFF(NEMUSCSI, abCDB[11]);
    GEN_CHECK_OFF(NEMUSCSI, iCDB);
    GEN_CHECK_OFF(NEMUSCSI, pbBuf);
    GEN_CHECK_OFF(NEMUSCSI, cbBuf);
    GEN_CHECK_OFF(NEMUSCSI, iBuf);
    GEN_CHECK_OFF(NEMUSCSI, fBusy);
    GEN_CHECK_OFF(NEMUSCSI, enmState);
#endif
    ...
    GEN_CHECK_OFF(BUSLOGIC, NemuSCSI);
    ...
    GEN_CHECK_OFF(LSILOGICSCSI, NemuSCSI);
