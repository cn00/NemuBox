...
/** @file
 * Nemu Qt GUI - UIMachineLogicNormal class implementation.
 */
...
void UIMachineLogicNormal::sltToggleMenuBar()
{
    ...
    gEDataManager->setMenuBarEnabled(!fEnabled, nemuGlobal().managedVMUuid());
}
#endif /* !RT_OS_DARWIN */
...
void UIMachineLogicNormal::sltToggleStatusBar()
{
    ...
    gEDataManager->setStatusBarEnabled(!fEnabled, nemuGlobal().managedVMUuid());
}
