...
/** @file
 *
 * Nemu HDD container test utility - scripting engine.
 */
 ...
 * code. Could be used as a scripting language for the Nemu debugger for example or in the scm
 ...
 *
 * @returns Nemu status code passed.
 */
