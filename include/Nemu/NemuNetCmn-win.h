/* $Id: NemuNetCmn-win.h $ */
/** @file
 * NemuNetCmn-win.h - NDIS6 Networking Driver Common Definitions, Windows-specific code.
 */
/*
...
DECLHIDDEN(void) nemuNetCmnWinDumpOidRequest(const char *pcszFunction, PNDIS_OID_REQUEST pRequest)
{
