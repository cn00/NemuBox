...
/** @file
 * Nemu Qt GUI - UIMessageCenter class declaration.
 */
...
public:
    ...
    void cannotLoadGlobalConfig(const CVirtualBox &nemu, const QString &strError) const;
    void cannotSaveGlobalConfig(const CVirtualBox &nemu) const;
    void cannotFindMachineByName(const CVirtualBox &nemu, const QString &strName) const;
    void cannotFindMachineById(const CVirtualBox &nemu, const QString &strId) const;
    ...
    void cannotSetExtraData(const CVirtualBox &nemu, const QString &strKey, const QString &strValue);
    ...
    void cannotOpenMachine(const CVirtualBox &nemu, const QString &strMachinePath) const;
    ...
    void cannotCreateNATNetwork(const CVirtualBox &nemu, QWidget *pParent = 0);
    void cannotRemoveNATNetwork(const CVirtualBox &nemu, const QString &strNetworkName, QWidget *pParent = 0);
    void cannotCreateDHCPServer(const CVirtualBox &nemu, QWidget *pParent = 0);
    void cannotRemoveDHCPServer(const CVirtualBox &nemu, const QString &strInterfaceName, QWidget *pParent = 0);
    ...
    void cannotOpenMedium(const CVirtualBox &nemu, UIMediumType type, const QString &strLocation, QWidget *pParent = 0) const;
    ...
    void cannotCreateMachine(const CVirtualBox &nemu, QWidget *pParent = 0) const;
    void cannotRegisterMachine(const CVirtualBox &nemu, const QString &strMachineName, QWidget *pParent = 0) const;
    ...
    void cannotCreateHardDiskStorage(const CVirtualBox &nemu, const QString &strLocation,QWidget *pParent = 0) const;
    ...
    void warnAboutNemuSVCUnavailable() const;
    ...
    void askUserToDownloadExtensionPack(const QString &strExtPackName, const QString &strExtPackVersion, const QString &strNemuVersion) const;
