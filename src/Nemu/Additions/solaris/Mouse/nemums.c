...
/** The module name. */
#define DEVICE_NAME              "nemums"
/** The module description as seen in 'modinfo'. */
#define DEVICE_DESC              "NemuMouseIntegr"
...
/**
 * Notification callback, called when the NemuGuest mouse pointer is moved.
...
{
    RTTEST hTest;
    int rc = RTTestInitAndCreate("tstNemuGuest-solaris", &hTest);
    if (rc)
        return rc;
    RTTestBanner(hTest);
    test_init(hTest);
