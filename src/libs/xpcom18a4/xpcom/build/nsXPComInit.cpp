...
NS_GetFrozenFunctions(XPCOMFunctions *functions, const char* libraryPath)
{
    ...
    GET_FUNC(init,                  InitFunc,                       "NemuNsxpNS_InitXPCOM2");
    GET_FUNC(shutdown,              ShutdownFunc,                   "NemuNsxpNS_ShutdownXPCOM");
    GET_FUNC(getServiceManager,     GetServiceManagerFunc,          "NemuNsxpNS_GetServiceManager");
    GET_FUNC(getComponentManager,   GetComponentManagerFunc,        "NemuNsxpNS_GetComponentManager");
    GET_FUNC(getComponentRegistrar, GetComponentRegistrarFunc,      "NemuNsxpNS_GetComponentRegistrar");
    GET_FUNC(getMemoryManager,      GetMemoryManagerFunc,           "NemuNsxpNS_GetMemoryManager");
    GET_FUNC(newLocalFile,          NewLocalFileFunc,               "NemuNsxpNS_NewLocalFile");
    GET_FUNC(newNativeLocalFile,    NewNativeLocalFileFunc,         "NemuNsxpNS_NewNativeLocalFile");
    GET_FUNC(registerExitRoutine,   RegisterXPCOMExitRoutineFunc,   "NemuNsxpNS_RegisterXPCOMExitRoutine");
    GET_FUNC(unregisterExitRoutine, UnregisterXPCOMExitRoutineFunc, "NemuNsxpNS_UnregisterXPCOMExitRoutine");
#else /* !NEMU_WITH_XPCOM_NAMESPACE_CLEANUP */
...
#ifdef NEMU_WITH_XPCOM_NAMESPACE_CLEANUP
        GET_FUNC(getDebug,          GetDebugFunc,                   "NemuNsxpNS_GetDebug");
        GET_FUNC(getTraceRefcnt,    GetTraceRefcntFunc,             "NemuNsxpNS_GetTraceRefcnt");
#else /* !NEMU_WITH_XPCOM_NAMESPACE_CLEANUP */
...
#ifdef NEMU_WITH_XPCOM_NAMESPACE_CLEANUP
        GET_FUNC(stringContainerInit,    StringContainerInitFunc,        "NemuNsxpNS_StringContainerInit");
        GET_FUNC(stringContainerFinish,  StringContainerFinishFunc,      "NemuNsxpNS_StringContainerFinish");
        GET_FUNC(stringGetData,          StringGetDataFunc,              "NemuNsxpNS_StringGetData");
        GET_FUNC(stringSetData,          StringSetDataFunc,              "NemuNsxpNS_StringSetData");
        GET_FUNC(stringSetDataRange,     StringSetDataRangeFunc,         "NemuNsxpNS_StringSetDataRange");
        GET_FUNC(stringCopy,             StringCopyFunc,                 "NemuNsxpNS_StringCopy");
        GET_FUNC(cstringContainerInit,   CStringContainerInitFunc,       "NemuNsxpNS_CStringContainerInit");
        GET_FUNC(cstringContainerFinish, CStringContainerFinishFunc,     "NemuNsxpNS_CStringContainerFinish");
        GET_FUNC(cstringGetData,         CStringGetDataFunc,             "NemuNsxpNS_CStringGetData");
        GET_FUNC(cstringSetData,         CStringSetDataFunc,             "NemuNsxpNS_CStringSetData");
        GET_FUNC(cstringSetDataRange,    CStringSetDataRangeFunc,        "NemuNsxpNS_CStringSetDataRange");
        GET_FUNC(cstringCopy,            CStringCopyFunc,                "NemuNsxpNS_CStringCopy");
        GET_FUNC(cstringToUTF16,         CStringToUTF16,                 "NemuNsxpNS_CStringToUTF16");
        GET_FUNC(utf16ToCString,         UTF16ToCString,                 "NemuNsxpNS_UTF16ToCString");
        GET_FUNC(stringCloneData,        StringCloneDataFunc,            "NemuNsxpNS_StringCloneData");
        GET_FUNC(cstringCloneData,       CStringCloneDataFunc,           "NemuNsxpNS_CStringCloneData");
#else /* !NEMU_WITH_XPCOM_NAMESPACE_CLEANUP */
