...
void SERVER_DISPATCH_APIENTRY crServerDispatchDeleteObjectARB(NemuGLhandleARB obj)
{
...
NemuGLhandleARB SERVER_DISPATCH_APIENTRY crServerDispatchGetHandleARB( GLenum pname )
{
    NemuGLhandleARB retval;
