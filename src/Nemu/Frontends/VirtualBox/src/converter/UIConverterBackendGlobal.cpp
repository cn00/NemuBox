...
/** @file
 * Nemu Qt GUI - UIConverterBackendGlobal implementation.
 */
...
template<> QString toString(const SizeSuffix &sizeSuffix)
{
    ...
    switch (sizeSuffix)
    {
        case SizeSuffix_Byte:     strResult = QApplication::translate("NemuGlobal", "B", "size suffix Bytes"); break;
        case SizeSuffix_KiloByte: strResult = QApplication::translate("NemuGlobal", "KB", "size suffix KBytes=1024 Bytes"); break;
        case SizeSuffix_MegaByte: strResult = QApplication::translate("NemuGlobal", "MB", "size suffix MBytes=1024 KBytes"); break;
        case SizeSuffix_GigaByte: strResult = QApplication::translate("NemuGlobal", "GB", "size suffix GBytes=1024 MBytes"); break;
        case SizeSuffix_TeraByte: strResult = QApplication::translate("NemuGlobal", "TB", "size suffix TBytes=1024 GBytes"); break;
        case SizeSuffix_PetaByte: strResult = QApplication::translate("NemuGlobal", "PB", "size suffix PBytes=1024 TBytes"); break;
        default:
        {
...
template<> SizeSuffix fromString<SizeSuffix>(const QString &strSizeSuffix)
{
    ...
    list.insert(QApplication::translate("NemuGlobal", "B", "size suffix Bytes"),               SizeSuffix_Byte);
    list.insert(QApplication::translate("NemuGlobal", "KB", "size suffix KBytes=1024 Bytes"),  SizeSuffix_KiloByte);
    list.insert(QApplication::translate("NemuGlobal", "MB", "size suffix MBytes=1024 KBytes"), SizeSuffix_MegaByte);
    list.insert(QApplication::translate("NemuGlobal", "GB", "size suffix GBytes=1024 MBytes"), SizeSuffix_GigaByte);
    list.insert(QApplication::translate("NemuGlobal", "TB", "size suffix TBytes=1024 GBytes"), SizeSuffix_TeraByte);
    list.insert(QApplication::translate("NemuGlobal", "PB", "size suffix PBytes=1024 TBytes"), SizeSuffix_PetaByte);
...
template<> QString toString(const StorageSlot &storageSlot)
{
    ...
    switch (storageSlot.bus)
    {
        ...
        {
            int iMaxPort = nemuGlobal().virtualBox().GetSystemProperties().GetMaxPortCountForStorageBus(storageSlot.bus);
            int iMaxDevice = nemuGlobal().virtualBox().GetSystemProperties().GetMaxDevicesPerPortForStorageBus(storageSlot.bus);
            ...
            if (storageSlot.port == 0 && storageSlot.device == 0)
                strResult = QApplication::translate("NemuGlobal", "IDE Primary Master", "StorageSlot");
            else if (storageSlot.port == 0 && storageSlot.device == 1)
                strResult = QApplication::translate("NemuGlobal", "IDE Primary Slave", "StorageSlot");
            else if (storageSlot.port == 1 && storageSlot.device == 0)
                strResult = QApplication::translate("NemuGlobal", "IDE Secondary Master", "StorageSlot");
            else if (storageSlot.port == 1 && storageSlot.device == 1)
                strResult = QApplication::translate("NemuGlobal", "IDE Secondary Slave", "StorageSlot");
            break;
        }
        case KStorageBus_SATA:
        {
            ...
            strResult = QApplication::translate("NemuGlobal", "SATA Port %1", "StorageSlot").arg(storageSlot.port);
            break;
        }
        case KStorageBus_SCSI:
        {
            ...
            strResult = QApplication::translate("NemuGlobal", "SCSI Port %1", "StorageSlot").arg(storageSlot.port);
            break;
        }
        case KStorageBus_SAS:
        {
            ...
            strResult = QApplication::translate("NemuGlobal", "SAS Port %1", "StorageSlot").arg(storageSlot.port);
            break;
        }
        case KStorageBus_Floppy:
        {
            ...
            strResult = QApplication::translate("NemuGlobal", "Floppy Device %1", "StorageSlot").arg(storageSlot.device);
            break;
        }
        case KStorageBus_USB:
        {
            ...
            strResult = QApplication::translate("NemuGlobal", "USB Port %1", "StorageSlot").arg(storageSlot.port);
            break;
        }
        default:
        {
...
template<> StorageSlot fromString<StorageSlot>(const QString &strStorageSlot)
{
    ...
    list[0] = QApplication::translate("NemuGlobal", "IDE Primary Master", "StorageSlot");
    list[1] = QApplication::translate("NemuGlobal", "IDE Primary Slave", "StorageSlot");
    list[2] = QApplication::translate("NemuGlobal", "IDE Secondary Master", "StorageSlot");
    list[3] = QApplication::translate("NemuGlobal", "IDE Secondary Slave", "StorageSlot");
    list[4] = QApplication::translate("NemuGlobal", "SATA Port %1", "StorageSlot");
    list[5] = QApplication::translate("NemuGlobal", "SCSI Port %1", "StorageSlot");
    list[6] = QApplication::translate("NemuGlobal", "SAS Port %1", "StorageSlot");
    list[7] = QApplication::translate("NemuGlobal", "Floppy Device %1", "StorageSlot");
    list[8] = QApplication::translate("NemuGlobal", "USB Port %1", "StorageSlot");
    int index = -1;
    QRegExp regExp;
    ...
    switch (index)
    {
        ...
        case 3:
        {
            ...
            int iMaxPort = nemuGlobal().virtualBox().GetSystemProperties().GetMaxPortCountForStorageBus(bus);
            int iMaxDevice = nemuGlobal().virtualBox().GetSystemProperties().GetMaxDevicesPerPortForStorageBus(bus);
...
template<> QString toString(const DetailsElementType &detailsElementType)
{
    ...
    {
        case DetailsElementType_General:     strResult = QApplication::translate("NemuGlobal", "General", "DetailsElementType"); break;
        case DetailsElementType_Preview:     strResult = QApplication::translate("NemuGlobal", "Preview", "DetailsElementType"); break;
        case DetailsElementType_System:      strResult = QApplication::translate("NemuGlobal", "System", "DetailsElementType"); break;
        case DetailsElementType_Display:     strResult = QApplication::translate("NemuGlobal", "Display", "DetailsElementType"); break;
        case DetailsElementType_Storage:     strResult = QApplication::translate("NemuGlobal", "Storage", "DetailsElementType"); break;
        case DetailsElementType_Audio:       strResult = QApplication::translate("NemuGlobal", "Audio", "DetailsElementType"); break;
        case DetailsElementType_Network:     strResult = QApplication::translate("NemuGlobal", "Network", "DetailsElementType"); break;
        case DetailsElementType_Serial:      strResult = QApplication::translate("NemuGlobal", "Serial ports", "DetailsElementType"); break;
#ifdef NEMU_WITH_PARALLEL_PORTS
        case DetailsElementType_Parallel:    strResult = QApplication::translate("NemuGlobal", "Parallel ports", "DetailsElementType"); break;
#endif /* NEMU_WITH_PARALLEL_PORTS */
        case DetailsElementType_USB:         strResult = QApplication::translate("NemuGlobal", "USB", "DetailsElementType"); break;
        case DetailsElementType_SF:          strResult = QApplication::translate("NemuGlobal", "Shared folders", "DetailsElementType"); break;
        case DetailsElementType_UI:          strResult = QApplication::translate("NemuGlobal", "User interface", "DetailsElementType"); break;
        case DetailsElementType_Description: strResult = QApplication::translate("NemuGlobal", "Description", "DetailsElementType"); break;
        default:
        {
...
template<> DetailsElementType fromString<DetailsElementType>(const QString &strDetailsElementType)
{
    ...
    keys << QApplication::translate("NemuGlobal", "General", "DetailsElementType");        values << DetailsElementType_General;
    keys << QApplication::translate("NemuGlobal", "Preview", "DetailsElementType");        values << DetailsElementType_Preview;
    keys << QApplication::translate("NemuGlobal", "System", "DetailsElementType");         values << DetailsElementType_System;
    keys << QApplication::translate("NemuGlobal", "Display", "DetailsElementType");        values << DetailsElementType_Display;
    keys << QApplication::translate("NemuGlobal", "Storage", "DetailsElementType");        values << DetailsElementType_Storage;
    keys << QApplication::translate("NemuGlobal", "Audio", "DetailsElementType");          values << DetailsElementType_Audio;
    keys << QApplication::translate("NemuGlobal", "Network", "DetailsElementType");        values << DetailsElementType_Network;
    keys << QApplication::translate("NemuGlobal", "Serial ports", "DetailsElementType");   values << DetailsElementType_Serial;
#ifdef NEMU_WITH_PARALLEL_PORTS
    keys << QApplication::translate("NemuGlobal", "Parallel ports", "DetailsElementType"); values << DetailsElementType_Parallel;
#endif /* NEMU_WITH_PARALLEL_PORTS */
    keys << QApplication::translate("NemuGlobal", "USB", "DetailsElementType");            values << DetailsElementType_USB;
    keys << QApplication::translate("NemuGlobal", "Shared folders", "DetailsElementType"); values << DetailsElementType_SF;
    keys << QApplication::translate("NemuGlobal", "User interface", "DetailsElementType"); values << DetailsElementType_UI;
    keys << QApplication::translate("NemuGlobal", "Description", "DetailsElementType");    values << DetailsElementType_Description;
    /* Invalid type for unknown words: */
