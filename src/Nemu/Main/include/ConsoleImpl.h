/* $Id: ConsoleImpl.h $ */
/** @file
 * Nemu Console COM Class definition
 */
...
#include <Nemu/RemoteDesktop/VRDE.h>
#include <Nemu/vmm/pdmdrv.h>
#ifdef NEMU_WITH_GUEST_PROPS
# include <Nemu/HostServices/GuestPropertySvc.h>  /* For the property notification callback */
#endif

#ifdef RT_OS_WINDOWS
# include "../src-server/win/NemuComEvents.h"
#endif
...
public:
     ...
     * @aram   strCfg    The config for the disks.
     *
