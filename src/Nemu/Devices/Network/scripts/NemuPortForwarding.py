...
# > python NemuPortForwarding.py --vm winXP -a 1 -p TCP -l 8080 -g 80 -P www
# generates sequence of API calls, equivalent to:
# > NemuManage setextradata "winXP"
#        "NemuInternal/Devices/pcnet/0/LUN#0/Config/www/Protocol" TCP
# > NemuManage setextradata "winXP"
#        "NemuInternal/Devices/pcnet/0/LUN#0/Config/www/GuestPort" 80
# > NemuManage setextradata "winXP"
#        "NemuInternal/Devices/pcnet/0/LUN#0/Config/www/HostPort" 8080
################################################################################
...
def main(argv):
    ...
    if profile_name == None:
        profile_name = generate_profile_name(options.proto.upper(),
                                            options.host_port,
                                            options.guest_port)
    config = "NemuInternal/Devices/" + name + "/"
