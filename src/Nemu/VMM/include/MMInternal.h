 ...
 */
#if !defined(MMR3HEAP_WITH_STATISTICS) && defined(NEMU_WITH_STATISTICS)
 ...
 */
#if !defined(MMUKHEAP_WITH_STATISTICS) && defined(NEMU_WITH_STATISTICS)
...
#endif /* !NEMU_WITH_2X_4GB_ADDR_SPACE */
