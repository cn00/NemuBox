...
#define PR_SetLibraryPath NemuNsprPR_SetLibraryPath
#define PR_GetLibraryPath NemuNsprPR_GetLibraryPath
#define PR_GetLibraryName NemuNsprPR_GetLibraryName
#define PR_FreeLibraryName NemuNsprPR_FreeLibraryName
#define PR_LoadLibrary NemuNsprPR_LoadLibrary
#define PR_LoadLibraryWithFlags NemuNsprPR_LoadLibraryWithFlags
#define PR_UnloadLibrary NemuNsprPR_UnloadLibrary
#define PR_FindSymbol NemuNsprPR_FindSymbol
#define PR_FindFunctionSymbol NemuNsprPR_FindFunctionSymbol
#define PR_FindSymbolAndLibrary NemuNsprPR_FindSymbolAndLibrary
#define PR_FindFunctionSymbolAndLibrary NemuNsprPR_FindFunctionSymbolAndLibrary
#define PR_LoadStaticLibrary NemuNsprPR_LoadStaticLibrary
#define PR_GetLibraryFilePathname NemuNsprPR_GetLibraryFilePathname
