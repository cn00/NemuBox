...
/** @def NEMU_WITH_WIN_PARPORT_SUP *
 * Indicates whether to use the generic direct hardware access or host specific
 * code to access the parallel port.
 */
#if defined(RT_OS_LINUX)
# undef NEMU_WITH_WIN_PARPORT_SUP
#elif defined(RT_OS_WINDOWS)
#else
# error "Not ported"
#endif

#if defined(NEMU_WITH_WIN_PARPORT_SUP) && defined(IN_RING0)
# include <iprt/asm-amd64-x86.h>
#endif

#if defined(NEMU_WITH_WIN_PARPORT_SUP) && defined(IN_RING3)
# include <Windows.h>
# include <setupapi.h>
# include <cfgmgr32.h>
# include <iprt/mem.h>
...
typedef struct DRVHOSTPARALLEL
{
    ...
    /** Device Handle */
    RTFILE                        hFileDevice;
#ifndef NEMU_WITH_WIN_PARPORT_SUP
...
#ifdef NEMU_WITH_WIN_PARPORT_SUP
    /** Data register. */
    uint32_t                      u32LptAddr;
    /** Status register. */
...
#endif /* NEMU_WITH_WIN_PARPORT_SUP */
...
# ifndef NEMU_WITH_WIN_PARPORT_SUP
    ...
    return rc;
# else  /* NEMU_WITH_WIN_PARPORT_SUP */
    return VINF_SUCCESS;
# endif /* NEMU_WITH_WIN_PARPORT_SUP */
}
...
const PDMDRVREG g_DrvHostParallel =
{
    ...
    /* fFlags */
# if defined(NEMU_WITH_WIN_PARPORT_SUP)
