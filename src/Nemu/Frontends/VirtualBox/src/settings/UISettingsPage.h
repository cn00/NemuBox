/* $Id: UISettingsPage.h $ */
/** @file
 * Nemu Qt GUI - UISettingsPage class declaration.
 */
...
struct UISettingsDataGlobal
{
    ...
    UISettingsDataGlobal(const CSystemProperties &properties, const NemuGlobalSettings &settings)
        : m_properties(properties), m_settings(settings) {}
    CSystemProperties m_properties;
    NemuGlobalSettings m_settings;
};
