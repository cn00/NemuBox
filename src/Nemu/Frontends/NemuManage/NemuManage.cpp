/* $Id: NemuManage.cpp $ */
/** @file
 * NemuManage - VirtualBox's command-line interface.
 */
...
#define VBMG_CMD_TODO HELP_CMD_NEMUMANAGE_INVALID
...
typedef struct VBMGCMD
{
    ...
    enum HELP_CMD_NEMUMANAGE    enmCmdHelp;
    /** The handler. */
    RTEXITCODE                (*pfnHandler)(HandlerArg *pArg);
    /** VBMG_CMD_F_XXX,    */
    uint32_t                    fFlags;
} VBMGCMD;
/** Pointer to a const NemuManage command descriptor. */
