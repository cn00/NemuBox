...
#define PR_StringToNetAddr NemuNsprPR_StringToNetAddr
#define PR_NetAddrToString NemuNsprPR_NetAddrToString
#define PR_GetHostByName NemuNsprPR_GetHostByName
#define PR_GetIPNodeByName NemuNsprPR_GetIPNodeByName
#define PR_GetHostByAddr NemuNsprPR_GetHostByAddr
#define PR_EnumerateHostEnt NemuNsprPR_EnumerateHostEnt
#define PR_InitializeNetAddr NemuNsprPR_InitializeNetAddr
#define PR_SetNetAddr NemuNsprPR_SetNetAddr
#define PR_IsNetAddrType NemuNsprPR_IsNetAddrType
#define PR_ConvertIPv4AddrToIPv6 NemuNsprPR_ConvertIPv4AddrToIPv6
#define PR_GetProtoByName NemuNsprPR_GetProtoByName
#define PR_GetProtoByNumber NemuNsprPR_GetProtoByNumber
#define PR_GetAddrInfoByName NemuNsprPR_GetAddrInfoByName
#define PR_FreeAddrInfo NemuNsprPR_FreeAddrInfo
#define PR_EnumerateAddrInfo NemuNsprPR_EnumerateAddrInfo
#define PR_GetCanonNameFromAddrInfo NemuNsprPR_GetCanonNameFromAddrInfo
#define PR_htonl NemuNsprPR_htonl
#define PR_htonll NemuNsprPR_htonll
#define PR_htons NemuNsprPR_htons
#define PR_ntohl NemuNsprPR_ntohl
#define PR_ntohll NemuNsprPR_ntohll
#define PR_ntohs NemuNsprPR_ntohs
