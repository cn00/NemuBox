...
/** @file
 * Nemu Qt GUI - Implementation of Linux-specific keyboard functions.
 */
...
/* NemuKeyboard uses the deprecated XKeycodeToKeysym(3) API, but uses it safely.
 */
...
unsigned handleXKeyEvent(XEvent *event)
{
    ...
    LogRel3(("NemuKeyboard: converting keycode %d to scancode %s0x%x\n",
