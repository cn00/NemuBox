...
#define PR_AtomicDecrement NemuNsprPR_AtomicDecrement
#define PR_AtomicIncrement NemuNsprPR_AtomicIncrement
#define PR_AtomicAdd NemuNsprPR_AtomicAdd
#define PR_AtomicSet NemuNsprPR_AtomicSet
#define PR_CreateStack NemuNsprPR_CreateStack
#define PR_StackPush NemuNsprPR_StackPush
#define PR_StackPop NemuNsprPR_StackPop
#define PR_DestroyStack NemuNsprPR_DestroyStack
