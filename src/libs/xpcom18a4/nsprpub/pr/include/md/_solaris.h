...
#if defined(_LARGEFILE64_SOURCE)                                    /* nemu */
#define _PR_HAVE_OFF64_T                                            /* nemu */
#elif defined(_LP64) || _FILE_OFFSET_BITS == 32                     /* nemu */
#define _PR_HAVE_LARGE_OFF_T                                        /* nemu */
#else                                                               /* nemu */
#define _PR_NO_LARGE_FILES                                          /* nemu */
#endif                                                              /* nemu */
...
#if !defined(_XPG4_2) || defined(_XPG6) || defined(__EXTENSIONS__)  /* nemu */
#define _PR_INET6                                                   /* nemu */
#endif                                                              /* nemu */
#ifdef _PR_INET6
