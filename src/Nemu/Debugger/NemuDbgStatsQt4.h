...
#ifndef ___Debugger_NemuDbgStats_h
#define ___Debugger_NemuDbgStats_h
 ...
 */
class NemuDbgStatsView : public QTreeView, public NemuDbgBase
{
    Q_OBJECT;
...
public:
     ...
     */
    NemuDbgStatsView(NemuDbgGui *a_pDbgGui, NemuDbgStatsModel *a_pModel, NemuDbgStats *a_pParent = NULL);

    /** Destructor. */
    virtual ~NemuDbgStatsView();
...
protected:
    ...
    NemuDbgStatsModel *m_pModel;
    /** The current selection pattern. */
    QString m_PatStr;
    /** The parent widget. */
    NemuDbgStats *m_pParent;
 ...
 */
class NemuDbgStats : public NemuDbgBaseWindow
{
    Q_OBJECT;
...
public:
     ...
     */
    NemuDbgStats(NemuDbgGui *a_pDbgGui, const char *pszPat = NULL, unsigned uRefreshRate= 0, QWidget *pParent = NULL);

    /** Destructor. */
    virtual ~NemuDbgStats();
