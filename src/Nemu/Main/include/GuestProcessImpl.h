...
public:
     ...
     * @{ */
    int i_callbackDispatcher(PNEMUGUESTCTRLHOSTCBCTX pCbCtx, PNEMUGUESTCTRLHOSTCALLBACK pSvcCb);
...
protected:
    ...
    int i_onGuestDisconnected(PNEMUGUESTCTRLHOSTCBCTX pCbCtx, PNEMUGUESTCTRLHOSTCALLBACK pSvcCbData);
    int i_onProcessInputStatus(PNEMUGUESTCTRLHOSTCBCTX pCbCtx, PNEMUGUESTCTRLHOSTCALLBACK pSvcCbData);
    int i_onProcessNotifyIO(PNEMUGUESTCTRLHOSTCBCTX pCbCtx, PNEMUGUESTCTRLHOSTCALLBACK pSvcCbData);
    int i_onProcessStatusChange(PNEMUGUESTCTRLHOSTCBCTX pCbCtx, PNEMUGUESTCTRLHOSTCALLBACK pSvcCbData);
    int i_onProcessOutput(PNEMUGUESTCTRLHOSTCBCTX pCbCtx, PNEMUGUESTCTRLHOSTCALLBACK pSvcCbData);
...
/**
 * Internal class for handling a NemuService tool ("nemu_ls", nemu_stat", ...).
 */
