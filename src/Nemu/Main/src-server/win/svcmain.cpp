...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, LPSTR /*lpCmdLine*/, int /*nShowCmd*/)
{
    ...
    /*
     * Need to parse the command line before initializing the Nemu runtime so we can
    ...
    /* Only create the log file when running NemuSVC normally, but not when
    ...
    if (fRun)
    {
        ...
        vrc = com::NemuLogRelCreate("COM Server", szLogFile,
    ...
    _Module.Init(ObjectMap, hInstance, &LIBID_NEMU);
