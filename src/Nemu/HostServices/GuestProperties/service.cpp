...
struct GuestCall
{
    ...
    GuestCall(uint32_t aClientId, NEMUHGCMCALLHANDLE aHandle, uint32_t aFunction,
              uint32_t aParmsCnt, NEMUHGCMSVCPARM aParms[], int aRc)
...
private:
    ...
    int setPropertyBlock(uint32_t cParms, NEMUHGCMSVCPARM paParms[]);
    int getProperty(uint32_t cParms, NEMUHGCMSVCPARM paParms[]);
    int setProperty(uint32_t cParms, NEMUHGCMSVCPARM paParms[], bool isGuest);
    int delProperty(uint32_t cParms, NEMUHGCMSVCPARM paParms[], bool isGuest);
    int enumProps(uint32_t cParms, NEMUHGCMSVCPARM paParms[]);
    int getNotification(uint32_t u32ClientId, NEMUHGCMCALLHANDLE callHandle, uint32_t cParms,
                        NEMUHGCMSVCPARM paParms[]);
    int getOldNotificationInternal(const char *pszPattern,
                                   uint64_t u64Timestamp, Property *pProp);
    int getNotificationWriteOut(uint32_t cParms, NEMUHGCMSVCPARM paParms[], Property prop);
    ...
    void call(NEMUHGCMCALLHANDLE callHandle, uint32_t u32ClientID,
 ...
 * @thread  HGCM
 */
int Service::setPropertyBlock(uint32_t cParms, NEMUHGCMSVCPARM paParms[])
{
 ...
 * @thread  HGCM
 */
int Service::getProperty(uint32_t cParms, NEMUHGCMSVCPARM paParms[])
{
    int         rc;
 ...
 * @thread  HGCM
 */
int Service::setProperty(uint32_t cParms, NEMUHGCMSVCPARM paParms[], bool isGuest)
{
    int rc = VINF_SUCCESS;
    const char *pcszName = NULL;        /* shut up gcc */
 ...
 * @thread  HGCM
 */
int Service::delProperty(uint32_t cParms, NEMUHGCMSVCPARM paParms[], bool isGuest)
{
    int         rc;
    const char *pcszName = NULL;        /* shut up gcc */
    uint32_t    cbName;
 ...
 * @thread  HGCM
 */
int Service::enumProps(uint32_t cParms, NEMUHGCMSVCPARM paParms[])
{
    int rc = VINF_SUCCESS;
...
int Service::getNotificationWriteOut(uint32_t cParms, NEMUHGCMSVCPARM paParms[], Property prop)
{
 ...
 */
int Service::getNotification(uint32_t u32ClientId, NEMUHGCMCALLHANDLE callHandle,
