...
#ifndef ___NEMU_CREDPROV_FACTORY_H___
#define ___NEMU_CREDPROV_FACTORY_H___

#include <Windows.h>

class NemuCredProvFactory : public IClassFactory
{
private:
    /*
     ...
     */
    NemuCredProvFactory(void);
    virtual ~NemuCredProvFactory(void);
...
private:
    LONG m_cRefs;
    friend HRESULT NemuCredentialProviderCreate(REFCLSID classID, REFIID interfaceID, void **ppv);
};
#endif /* !___NEMU_CREDPROV_FACTORY_H___ */
