...
#define PR_GetFileMethods NemuNsprPR_GetFileMethods
#define PR_GetTCPMethods NemuNsprPR_GetTCPMethods
#define PR_GetUDPMethods NemuNsprPR_GetUDPMethods
#define PR_GetPipeMethods NemuNsprPR_GetPipeMethods
#define PR_FileDesc2NativeHandle NemuNsprPR_FileDesc2NativeHandle
#define PR_ChangeFileDescNativeHandle NemuNsprPR_ChangeFileDescNativeHandle
#define PR_AllocFileDesc NemuNsprPR_AllocFileDesc
#define PR_FreeFileDesc NemuNsprPR_FreeFileDesc
#define PR_ImportFile NemuNsprPR_ImportFile
#define PR_ImportPipe NemuNsprPR_ImportPipe
#define PR_ImportTCPSocket NemuNsprPR_ImportTCPSocket
#define PR_ImportUDPSocket NemuNsprPR_ImportUDPSocket
#define PR_CreateSocketPollFd NemuNsprPR_CreateSocketPollFd
#define PR_DestroySocketPollFd NemuNsprPR_DestroySocketPollFd
#define PR_Socket NemuNsprPR_Socket
#define PR_LockFile NemuNsprPR_LockFile
#define PR_TLockFile NemuNsprPR_TLockFile
#define PR_UnlockFile NemuNsprPR_UnlockFile
#define PR_EmulateAcceptRead NemuNsprPR_EmulateAcceptRead
#define PR_EmulateSendFile NemuNsprPR_EmulateSendFile
#define PR_NTFast_AcceptRead NemuNsprPR_NTFast_AcceptRead
#define PR_NTFast_AcceptRead_WithTimeoutCallback NemuNsprPR_NTFast_AcceptRead_WithTimeoutCallback
#define PR_NTFast_Accept NemuNsprPR_NTFast_Accept
#define PR_NTFast_UpdateAcceptContext NemuNsprPR_NTFast_UpdateAcceptContext
#define PR_NT_CancelIo NemuNsprPR_NT_CancelIo
#define PR_Init_Log NemuNsprPR_Init_Log
