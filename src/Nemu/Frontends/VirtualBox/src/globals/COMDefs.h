/* $Id: COMDefs.h $ */
/** @file
 * Nemu Qt GUI - Various COM definitions and COM wrapper class declarations.
 *
 ...
 * COM/XPCOM Abstraction Layer library (the NemuCOM glue library defined in
 * include/Nemu/com and implemented in src/Nemu/Main/glue).
 *
 * ...
 *
...
/* Both Nemu/com/assert.h and qglobal.h contain a definition of ASSERT.
