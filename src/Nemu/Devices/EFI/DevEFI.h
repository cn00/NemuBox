 ...
 *
 * WARNING: This header is used by both firmware and Nemu device,
...
#ifndef ___EFI_NemuEFI_h
#define ___EFI_NemuEFI_h
...
#define NEMU_EFI_DEBUG_BUFFER   512
 ...
 *       SEC hands to PEI and the NemuAutoScan PEIM reports. */
#define NEMU_EFI_TOP_OF_STACK   0x300000
