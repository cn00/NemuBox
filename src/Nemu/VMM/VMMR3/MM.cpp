...
00000000a051e000-00000000a0522000 00002aaab36f5000 LOCKED  autofree         NemuDD2RC.rc
00000000a051d000-00000000a051e000                  DYNAMIC                  fence
00000000a04eb000-00000000a051d000 00002aaab36c3000 LOCKED  autofree         NemuDDRC.rc
 ...
 * and exposed thru STAM when NEMU_WITH_STATISTICS is defined.
 *
 *
 ...
 * NEMU_WITH_STATISTICS is defined.
 *
 *
 ...
 * support driver, SUPDrv (aka. NemuDrv), thru the support library API,
 * SUPR3 (aka. SUPLib).
 *
 *
 ...
 *
 * @returns Nemu status code - see GMMR0UpdateReservation.
 * @param   pVM             The cross context VM structure.
 */
 ...
 *
 * @returns Nemu status code. Will set VM error on failure.
 * @param   pVM             The cross context VM structure.
