/* $Id: UIActionPool.cpp $ */
/** @file
 * Nemu Qt GUI - UIActionPool class implementation.
 */
...
QString UIAction::nameInMenu() const
{
    ...
    switch (m_actionPoolType)
    {
        ...
        case UIActionPoolType_Runtime: return NemuGlobal::removeAccelMark(name());
    }
    /* Nothing by default: */
    return QString();
}
...
void UIAction::updateText()
{
    ...
    switch (m_actionPoolType)
    {
        ...
        case UIActionPoolType_Runtime:
            setText(nemuGlobal().insertKeyToActionText(nameInMenu(),
