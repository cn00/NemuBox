 ...
 */
bool NemuIsPasswordHashed(RTCString const *a_pstrPassword)
{
    /* prefix */
 ...
 *                              input and output.
 */
void NemuHashPassword(RTCString *a_pstrPassword)
{
    AssertReturnVoid(!NemuIsPasswordHashed(a_pstrPassword));
