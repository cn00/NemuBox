...
#ifndef ___Nemu_com_AutoLock_h
#define ___Nemu_com_AutoLock_h
...
# define NEMU_WITH_MAIN_LOCK_VALIDATION
...
{
public:
    RWLockHandle(NemuLockingClass lockClass);
...
{
public:
    WriteLockHandle(NemuLockingClass lockClass);
