/* $Id: VBGLInternal.h $ */
/** @file
 * NemuGuestLibR0 - Internal header.
 */
...
#ifndef ___NemuGuestLib_VBGLInternal_h
#define ___NemuGuestLib_VBGLInternal_h
