...
#include <Nemu/vd.h>
#include <Nemu/vd-ifs-internal.h>


/** @name Nemu HDD backend write flags
 * @{
 */
...
/** @name Nemu HDD backend discard flags
 * @{
 */
...
/** @name Nemu HDD backend metadata traverse flags
 * @{
 */
...
/**
 * Image format backend interface used by Nemu HDD Container implementation.
 */
typedef struct NEMUHDDBACKEND
{
    /**
...
typedef NEMUHDDBACKEND *PNEMUHDDBACKEND;
/** Constant pointer to VD backend. */
typedef const NEMUHDDBACKEND *PCNEMUHDDBACKEND;
