/* $Id: NemuGuest-win-pnp.cpp $ */
/** @file
 * NemuGuest-win-pnp - Windows Plug'n'Play specifics.
 */
 ...
 * Fix it instead of kind of working around things there!! */
        ...
        case IRP_MN_SURPRISE_REMOVAL:
        {
            ...
            NEMUGUEST_UPDATE_DEVSTATE(pDevExt, VGDRVNTDEVSTATE_SURPRISEREMOVED);

            /* Do nothing here actually. Cleanup is done in IRP_MN_REMOVE_DEVICE.
             * This request is not expected for NemuGuest.
             */
            LogRel(("NemuGuest: unexpected device removal\n"));
        ...
        case IRP_MN_QUERY_REMOVE_DEVICE:
        {
...
#ifdef NEMU_REBOOT_ON_UNINSTALL
            ...
            if (NT_SUCCESS(rc))
            {
                NEMUGUEST_UPDATE_DEVSTATE(pDevExt, VGDRVNTDEVSTATE_PENDINGREMOVE);
        ...
        case IRP_MN_REMOVE_DEVICE:
        {
            ...
            NEMUGUEST_UPDATE_DEVSTATE(pDevExt, VGDRVNTDEVSTATE_REMOVED);
            ...
            RtlInitUnicodeString(&win32Name, NEMUGUEST_DEVICE_NAME_DOS);
        ...
        case IRP_MN_QUERY_STOP_DEVICE:
        {
            ...
            if (NT_SUCCESS(rc))
            {
                NEMUGUEST_UPDATE_DEVSTATE(pDevExt, VGDRVNTDEVSTATE_PENDINGSTOP);
        ...
        case IRP_MN_STOP_DEVICE:
        {
            ...
            NEMUGUEST_UPDATE_DEVSTATE(pDevExt, VGDRVNTDEVSTATE_STOPPED);
 ...
 * @param pContext  Context value passed to IoSetCompletionRoutine in NemuGuestPower.
 */
static NTSTATUS vgdrvNtPowerComplete(IN PDEVICE_OBJECT pDevObj, IN PIRP pIrp, IN PVOID pContext)
{
#ifdef NEMU_STRICT
    PNEMUGUESTDEVEXTWIN pDevExt = (PNEMUGUESTDEVEXTWIN)pContext;
