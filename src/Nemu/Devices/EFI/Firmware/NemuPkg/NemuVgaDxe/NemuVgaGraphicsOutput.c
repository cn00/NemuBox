/* $Id: NemuVgaGraphicsOutput.c $ */
/** @file
 * NemuVgaGraphicsOutput.c
 */
...
STATIC
EFI_STATUS
NemuVgaCompleteModeData (
  IN  NEMU_VGA_PRIVATE_DATA    *Private,
...
EFI_STATUS
EFIAPI
NemuVgaGraphicsOutputQueryMode (
...
--*/
{
  ...
  Private = NEMU_VGA_PRIVATE_DATA_FROM_GRAPHICS_OUTPUT_THIS (This);
...
--*/
{
  ...
  InitializeGraphicsMode (Private, &NemuVgaVideoModes[ModeData->ModeNumber]);
  if (Private->TmpBuf)
  ...
  NemuVgaCompleteModeData (Private, This->Mode);
...
--*/
{
  ...
  case EfiBltVideoToVideo:
    ...
    NemuVgaGraphicsOutputBlt(This, (EFI_GRAPHICS_OUTPUT_BLT_PIXEL*)Private->TmpBuf, EfiBltVideoToBltBuffer, SourceX, SourceY, 0, 0, ScreenWidth - SourceX, ScreenHeight - SourceY, 0);
    NemuVgaGraphicsOutputBlt(This, (EFI_GRAPHICS_OUTPUT_BLT_PIXEL*)Private->TmpBuf, EfiBltBufferToVideo, 0, 0, DestinationX, DestinationY, ScreenWidth - SourceX, ScreenHeight - SourceY, 0);
    break;
  ...
  )
{
  ...
  GraphicsOutput->QueryMode = NemuVgaGraphicsOutputQueryMode;
  GraphicsOutput->SetMode   = NemuVgaGraphicsOutputSetMode;
  GraphicsOutput->Blt       = NemuVgaGraphicsOutputBlt;
