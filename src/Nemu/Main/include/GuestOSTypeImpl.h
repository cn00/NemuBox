...
public:
    ...
    bool i_is64Bit() const { return !!(mOSHint & NEMUOSHINT_64BIT); }
    bool i_recommendedIOAPIC() const { return !!(mOSHint & NEMUOSHINT_IOAPIC); }
    bool i_recommendedVirtEx() const { return !!(mOSHint & NEMUOSHINT_HWVIRTEX); }
    bool i_recommendedEFI() const { return !!(mOSHint & NEMUOSHINT_EFI); }
