/* $Id: NemuGuestRAMSlider.cpp $ */
/** @file
 * Nemu Qt GUI - VirtualBox Qt extensions: NemuGuestRAMSlider class implementation.
 */
...
NemuGuestRAMSlider::NemuGuestRAMSlider (QWidget *aParent /* = 0 */)
...
NemuGuestRAMSlider::NemuGuestRAMSlider (Qt::Orientation aOrientation, QWidget *aParent /* = 0 */)
...
uint NemuGuestRAMSlider::minRAM() const
{
    return mMinRAM;
}

uint NemuGuestRAMSlider::maxRAMOpt() const
{
    return mMaxRAMOpt;
}

uint NemuGuestRAMSlider::maxRAMAlw() const
{
    return mMaxRAMAlw;
}

uint NemuGuestRAMSlider::maxRAM() const
{
    return mMaxRAM;
}

void NemuGuestRAMSlider::init()
{
    ulong fullSize = nemuGlobal().host().GetMemorySize();
 ...
 *  page size is 4.
 */
int NemuGuestRAMSlider::calcPageStep (int aMax) const
{
