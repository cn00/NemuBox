...
int main(int argc, char *argv[])
{
...

    {
        ...
        GetNemuUserHomeDirectory(homeDir, sizeof(homeDir));
    ...
    // "./NemuManage clonehd src.vdi clone.vdi" in parallel.
...
//        }
    ...
    do
    {
        ...
        else
        {
            ...
            machine->COMSETTER(ExtraData)(L"NemuSDL/SecureLabel", secureLabel);
        }
#endif
    }
    while (0);
...
#if 0
        Bstr extraDataKey = "NemuSDL/SecureLabel";
...
#if 0 && defined(NEMU_WITH_RESOURCE_USAGE_API)
    do {
        // Get collector
        ComPtr<IPerformanceCollector> collector;
        CHECK_ERROR_BREAK(virtualBox,
