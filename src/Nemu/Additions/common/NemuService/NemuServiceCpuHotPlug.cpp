/* $Id: NemuServiceCpuHotPlug.cpp $ */
/** @file
 * NemuService - Guest Additions CPU Hot-Plugging Service.
 */
...
/** @page pg_vgsvc_cpuhotplug NemuService - CPU Hot-Plugging
 *
