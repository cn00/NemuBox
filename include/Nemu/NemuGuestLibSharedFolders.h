/* $Id: NemuGuestLibSharedFolders.h $ */
/** @file
 * NemuGuestLib - Central calls header.
 */
...
#ifndef ___Nemu_NemuGuestLibSharedFolders_h_
#define ___Nemu_NemuGuestLibSharedFolders_h_
...
/** @addtogroup grp_nemuguest_lib_r0
 * @{
 */
