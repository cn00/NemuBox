...
typedef struct CRNEMUHGSMI_CLIENT {
    ...
    struct NEMUUHGSMI_BUFFER *pCmdBuffer;
    struct NEMUUHGSMI_BUFFER *pHGBuffer;
    void *pvHGBuffer;
...
# ifdef NEMU_WITH_CRHGSMI
    CRNEMUHGSMI_CLIENT HgsmiClient;
    struct NEMUUHGSMI *pExternalHgsmi;
# endif
#else
# ifdef NEMU_WITH_CRHGSMI
...
# endif
     ...
     * in crNemuHGCMReceiveMessage. As those messages are going to be processed after the corresponding 
