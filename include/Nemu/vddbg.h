...
#ifndef ___Nemu_VDDbg_h
#define ___Nemu_VDDbg_h

#include <Nemu/cdefs.h>
#include <Nemu/types.h>
#include <Nemu/err.h>
#include <Nemu/vd.h> /* for VDRANGE */
#include <iprt/sg.h>
 ...
 */
NEMUDDU_DECL(int) VDDbgIoLogCreate(PVDIOLOGGER phIoLogger, const char *pszFilename, uint32_t fFlags);
 ...
 */
NEMUDDU_DECL(int) VDDbgIoLogOpen(PVDIOLOGGER phIoLogger, const char *pszFilename);
 ...
 */
NEMUDDU_DECL(void) VDDbgIoLogDestroy(VDIOLOGGER hIoLogger);
 ...
 */
NEMUDDU_DECL(int) VDDbgIoLogCommit(VDIOLOGGER hIoLogger);
 ...
 */
NEMUDDU_DECL(uint32_t) VDDbgIoLogGetFlags(VDIOLOGGER hIoLogger);
 ...
 */
NEMUDDU_DECL(int) VDDbgIoLogStart(VDIOLOGGER hIoLogger, bool fAsync, VDDBGIOLOGREQ enmTxDir, uint64_t off, size_t cbIo, PCRTSGBUF pSgBuf,
 ...
 * @param   phIoLogEntry Where to store the I/O log entry handle on success.
 */
NEMUDDU_DECL(int) VDDbgIoLogStartDiscard(VDIOLOGGER hIoLogger, bool fAsync, PCRTRANGE paRanges, unsigned cRanges,
                                         PVDIOLOGENT phIoLogEntry);
 ...
 */
NEMUDDU_DECL(int) VDDbgIoLogComplete(VDIOLOGGER hIoLogger, VDIOLOGENT hIoLogEntry, int rcReq, PCRTSGBUF pSgBuf);
 ...
 */
NEMUDDU_DECL(int) VDDbgIoLogEventTypeGetNext(VDIOLOGGER hIoLogger, VDIOLOGEVENT *penmEvent);
 ...
 */
NEMUDDU_DECL(int) VDDbgIoLogReqTypeGetNext(VDIOLOGGER hIoLogger, PVDDBGIOLOGREQ penmReq);
 ...
 */
NEMUDDU_DECL(int) VDDbgIoLogEventGetStart(VDIOLOGGER hIoLogger, uint64_t *pidEvent, bool *pfAsync,
 ...
 */
NEMUDDU_DECL(int) VDDbgIoLogEventGetStartDiscard(VDIOLOGGER hIoLogger, uint64_t *pidEvent, bool *pfAsync,
 ...
 */
NEMUDDU_DECL(int) VDDbgIoLogEventGetComplete(VDIOLOGGER hIoLogger, uint64_t *pidEvent, int *pRc,
