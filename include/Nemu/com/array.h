...
#ifndef ___Nemu_com_array_h
#define ___Nemu_com_array_h
...
# include <nsMemory.h>
    ...
    #define NEMU_WITH_TYPE_TRAITS
#endif

#ifdef NEMU_WITH_TYPE_TRAITS
# include <type_traits>
#endif
...
protected:
    ...
    /*
     * Fallback method in case type traits (NEMU_WITH_TYPE_TRAITS)
