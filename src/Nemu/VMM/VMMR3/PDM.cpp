 ...
 * will call the entry point 'NemuDevicesRegister' when loading a device module.
 ...
 * varies.  The registration entry point is 'NemuUsbRegister', the device
 ...
 * 'NemuDriversRegister' with a callback table.
 *
 * @see grp_pdm_driver
 *
 *
