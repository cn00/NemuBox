...
/** @file
 * Nemu Qt GUI - UIWizardFirstRunPageBasic class implementation.
 */
...
{
    /* Get opened nemuMedium id: */
    QString strMediumId = nemuGlobal().openMediumWithFileOpenDialog(m_pMediaSelector->type(), thisImp());
    ...
    : UIWizardFirstRunPage(fBootHardDiskWasSet)
{
    ...
    QVBoxLayout *pMainLayout = new QVBoxLayout(this);
    {
        ...
        {
            m_pMediaSelector = new NemuMediaComboBox(this);
            {
...
bool UIWizardFirstRunPageBasic::isComplete() const
{
    ...
    return !nemuGlobal().medium(id()).isNull();
}
