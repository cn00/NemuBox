...
typedef struct _NEMUMOUSE_DEVEXT
{
    LIST_ENTRY ListEntry;
    PDEVICE_OBJECT pdoMain;           /* PDO passed to NemuDrvAddDevice */
    PDEVICE_OBJECT pdoSelf;           /* our PDO created in NemuDrvAddDevice*/
...
} NEMUMOUSE_DEVEXT, *PNEMUMOUSE_DEVEXT;
