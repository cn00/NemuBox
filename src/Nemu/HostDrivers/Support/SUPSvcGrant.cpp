 ...
 *
 * @returns VINF_SUCCESS, Nemu error code on internal error.
 *
 * @param   pThis           Pointer to the grant service instance data.
 ...
 *
 * @returns VINF_SUCCESS on success, Nemu error code on internal error.
 *
 * @param   pThis           Pointer to the grant service instance data.
 ...
 *
 * @returns VINF_SUCCESS on normal exit, Nemu error status on failure.
 * @param   hThread         The thread handle.
