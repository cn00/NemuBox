/* $Id: NemuSysTables.c $ */
/** @file
 * NemuSysTables.c - VirtualBox system tables
 */
 ...
 */
EFI_STATUS EFIAPI
DxeInitializeNemuSysTables(IN EFI_HANDLE ImageHandle, IN EFI_SYSTEM_TABLE *SystemTable)
{
    EFI_STATUS  rc;
    VOID*       Ptr;

    DEBUG((DEBUG_INFO, "DxeInitializeNemuSysTables\n"));
...
EFI_STATUS EFIAPI
DxeUninitializeNemuSysTables(IN EFI_HANDLE         ImageHandle)
{
    return EFI_SUCCESS;
}
