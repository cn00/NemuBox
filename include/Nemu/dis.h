...
#ifndef ___Nemu_dis_h
#define ___Nemu_dis_h
...
/** @defgroup grp_dis   Nemu Disassembler
 * @{ */
 ...
 *
 * @returns Nemu status code, bytes in DISSTATE::abInstr and byte count in
