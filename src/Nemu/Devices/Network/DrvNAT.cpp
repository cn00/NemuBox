 ...
 * search string) at runtime (NEMU_NAT_ENFORCE_INTERNAL_DNS_UPDATE), we can do it safely on NAT thread,
...
DECLINLINE(void) drvNATUpdateDNS(PDRVNAT pThis, bool fFlapLink)
{
    ...
    switch (strategy)
    {
        ...
        case NEMU_NAT_DNS_HOSTRESOLVER:
        default:
            return;
    }
}
...
#endif /* !NEMU_WITH_DNSMAPPING_IN_HOSTRESOLVER */
