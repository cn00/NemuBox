...
<context>
    ...
    <message>
        ...
        <translation>VirtualBox 核心模組不符合這個 VirtualBox 的版本。 顯然 VirtualBox 的安裝不成功。 執行&lt;br/&gt;&lt;br/&gt;  &lt;font color=blue&gt;&apos;/sbin/rcnemudrv setup&apos;&lt;/font&gt;&lt;br/&gt;&lt;br/&gt;應能修正問題。 請確認您未混合 VirtualBox 的 OSE 版本與 PUEL 版本。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>未載入 VirtualBox Linux 核心驅動程式 (nemudrv) 或是 /dev/nemudrv 的權限問題。 請以 root 執行 &lt;br/&gt;&lt;br/&gt;  &lt;font color=blue&gt;&apos;/sbin/rcnemudrv setup&apos;&lt;/font&gt;&lt;br/&gt;&lt;br/&gt;來重新安裝核心模組。 如果在您的發行中可以使用，您應先安裝 DKMS 套件。 這個套件保留 Linux 核心變更的追蹤並在需要時重新編譯 nemudrv 核心模組。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>列出所有可存取這部機器的共用資料夾。 從類似 DOS 的作業系統使用 [net use x: \\nemusvr\share] 存取名為 &lt;i&gt;share&lt;/i&gt; 的共用資料夾，或從 Linux 作業系統 [mount -t nemusf share mount_point] 來存取它。 這個功能需要 Guest Additions 。</translation>
    </message>
    <message>
        <source>Name</source>
        <translation>名稱</translation>
...
<context>
    ...
    <message>
        ...
        <translation>&lt;p&gt;在&lt;b&gt;主機管線&lt;/b&gt;模式: 保留路徑為主機的串列埠管線。 範例: &quot;\\.\pipe\mynemu&quot; 或 &quot;/tmp/mynemu&quot;, 分別對 Windows 和 UNIX 類的系統。&lt;/p&gt;&lt;p&gt;在&lt;b&gt;主機裝置&lt;/b&gt;模式: 保留主機串列裝置名稱。 範例: &quot;COM1&quot; 或 &quot;/dev/ttyS0&quot;。&lt;/p&gt;&lt;p&gt;在 &lt;b&gt;Raw 檔案&lt;/b&gt;模式: 保留在主機系統的檔案路徑，其中將傾印串列輸出。&lt;/p&gt;&lt;p&gt;在 &lt;b&gt;TCP&lt;/b&gt; 模式: 在伺服器模式時保留 TCP &quot;連接埠&quot; 或在用戶端模式時保留 &quot;主機名稱:連接埠&quot; 。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>VirtualBox 目前不允許存取 USB 裝置。 您可以加入您的使用者到 &apos;nemuusers&apos; 群組來變更。  更多詳細解釋請查看使用者手冊</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;p&gt;執行虛擬機器時發生嚴重錯誤，且需要停止執行虛擬機器。&lt;/p&gt;&lt;p&gt;請查看在 &lt;a href=https://www.virtualbox.org&gt;https://www.virtualbox.org&lt;/a&gt; 的 Community 區或您的技術支援合約取得協助。 請提供日誌檔案 &lt;tt&gt;Nemu.log&lt;/tt&gt; 的內容。您可以在虛擬機器的 log 目錄找到，以及發生此錯誤時的動作描述。 請注意，您也可以從 VirtualBox 主視窗的 [&lt;b&gt;機器&lt;/b&gt;] 功能表選取 [&lt;b&gt;顯示日誌&lt;/b&gt;] 來存取上述檔案。&lt;/p&gt;&lt;p&gt;按下 [&lt;b&gt;確定&lt;/b&gt;] 以關閉機器。&lt;/p&gt;</translation>
    </message>
    <message>
