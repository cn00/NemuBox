...
#ifndef ___Nemu_usb_h
#define ___Nemu_usb_h
...
#ifdef NEMU_USB_H_INCL_DESCRIPTORS /* for the time being, since this may easily conflict with system headers */
...
#endif /* NEMU_USB_H_INCL_DESCRIPTORS */
