/* $Id: Nvram.cpp $ */
/** @file
 * Nemu NVRAM COM Class implementation.
 */
...
struct NVRAM
{
     ...
     * NemuInternal/Devices/efi/0/LUN#0/Config/Vars/).
...
#define NVRAM_CFGM_OVERLAY_PATH     "NemuInternal/Devices/efi/0/LUN#0/Config/Vars"
