/* $Id: NemuInterceptor.h $ */
/** @file
 * NemuInterceptor.h - Helpful macrodefinitions used in the interceptor.
 */
...
#ifndef __NEMUINTERCEPTOR_H__
#define __NEMUINTERCEPTOR_H__
#include <Uefi.h>
...
#define NEMUINTERCEPTOR NemuInterceptor
...
static void EFIAPI CONCAT(NEMUINTERCEPTOR,func_name)(PARAMETER(nparams)params)  \
{                                                                               \
...
static return_type EFIAPI CONCAT(NEMUINTERCEPTOR,func_name)(PARAMETER(nparams)params)  \
{                                                                               \
    return_type r;                                                              \
    UINT32 off = (UINT32)(uintptr_t)&(((typeof(gThis))0)->CONCAT(SERVICE,Orig).func_name); \
    DEBUG((DEBUG_INFO, "%a%a[%x] enter " PRNT_PARAMETERS(nparams)params "\n",   \
...
} NEMUINTERCEPTOR, *PNEMUINTERCEPTOR;

PNEMUINTERCEPTOR gThis;
