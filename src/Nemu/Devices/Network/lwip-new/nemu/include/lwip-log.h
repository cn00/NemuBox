...
#ifndef __NEMU_LWIP_LOG_H__
#define __NEMU_LWIP_LOG_H__
...
# define LWIP_DEBUGF(_when, _args) \
    do { \
        const NEMU_LOGGROUP _group = (_when) >> LWIP_DEBUGF_LOG_GROUP_SHIFT; \
