...
/** @file
 * Nemu Qt GUI - UIConsoleEventHandler class implementation.
 */
...
void UIConsoleEventHandler::prepare()
{
    ...
    events
        << KNemuEventType_OnMousePointerShapeChanged
        << KNemuEventType_OnMouseCapabilityChanged
        << KNemuEventType_OnKeyboardLedsChanged
        << KNemuEventType_OnStateChanged
        << KNemuEventType_OnAdditionsStateChanged
        << KNemuEventType_OnNetworkAdapterChanged
        << KNemuEventType_OnStorageDeviceChanged
        << KNemuEventType_OnMediumChanged
        << KNemuEventType_OnVRDEServerChanged
        << KNemuEventType_OnVRDEServerInfoChanged
        << KNemuEventType_OnVideoCaptureChanged
        << KNemuEventType_OnUSBControllerChanged
        << KNemuEventType_OnUSBDeviceStateChanged
        << KNemuEventType_OnSharedFolderChanged
        << KNemuEventType_OnCPUExecutionCapChanged
        << KNemuEventType_OnGuestMonitorChanged
        << KNemuEventType_OnRuntimeError
        << KNemuEventType_OnCanShowWindow
        << KNemuEventType_OnShowWindow;
