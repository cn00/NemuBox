...
#ifndef ___Nemu_log_h
#define ___Nemu_log_h
...
/** @defgroup grp_rt_nemu_log    Nemu Logging
 * @ingroup grp_rt_nemu
 * @{
 */
...
typedef enum LOGGROUP
{
    ...
    /** NemuHDD media driver group. */
    LOG_GROUP_DRV_NEMUHDD,
    /** Nemu HDD container media driver group. */
    LOG_GROUP_DRV_VD,
    ...
    /** Main group, INemuSVCAvailabilityChangedEvent. */
    LOG_GROUP_MAIN_NEMUSVCAVAILABILITYCHANGEDEVENT,
    ...
    /** Nemu Guest Additions Driver (NemuGuest). */
    LOG_GROUP_VGDRV,
    /** Nemu Guest Additions Library. */
    LOG_GROUP_VBGL,
...
{                   \
    ...
    "MAIN_NEMUSVCAVAILABILITYCHANGEDEVENT", \
    "MAIN_VETOEVENT", \
    "MAIN_VFSEXPLORER", \
