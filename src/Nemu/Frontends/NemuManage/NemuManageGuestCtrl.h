/* $Id: NemuManageGuestCtrl.h $ */
/** @file
 * NemuManageGuestCtrl.h - Definitions for guest control.
 */
...
#ifndef ___H_NEMUMANAGE_GUESTCTRL
#define ___H_NEMUMANAGE_GUESTCTRL
...
#endif /* !___H_NEMUMANAGE_GUESTCTRL */
