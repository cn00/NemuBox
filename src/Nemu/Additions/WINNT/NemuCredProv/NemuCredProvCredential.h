...
#ifndef ___NEMU_CREDPROV_CREDENTIAL_H___
#define ___NEMU_CREDPROV_CREDENTIAL_H___
...
class NemuCredProvCredential : public ICredentialProviderCredential
{
public:

    NemuCredProvCredential(void);

    virtual ~NemuCredProvCredential(void);
...
private:
    ...
    PRTUTF16                              m_apwszCredentials[NEMUCREDPROV_NUM_FIELDS];
...
#endif /* !___NEMU_CREDPROV_CREDENTIAL_H___ */
