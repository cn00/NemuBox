...
#ifndef ___nemuclient_nemuclient_h
# define ___nemuclient_nemuclient_h
...
/** A simple interface describing a service.  NemuClient will run exactly one
...
#endif /* !___nemuclient_nemuclient_h */
