...
#include "HGSMIHost.h"
#include <Nemu/HGSMI/HGSMIChannels.h>
...
#ifdef DEBUG_misha
//# define NEMUHGSMI_STATE_DEBUG
#endif

#ifdef NEMUHGSMI_STATE_DEBUG
#define NEMUHGSMI_STATE_START_MAGIC 0x12345678
#define NEMUHGSMI_STATE_STOP_MAGIC  0x87654321
#define NEMUHGSMI_STATE_FIFOSTART_MAGIC 0x9abcdef1
#define NEMUHGSMI_STATE_FIFOSTOP_MAGIC 0x1fedcba9

#define NEMUHGSMI_SAVE_START(_pSSM)     do{ int rc2 = SSMR3PutU32(_pSSM, NEMUHGSMI_STATE_START_MAGIC);      AssertRC(rc2);}while(0)
#define NEMUHGSMI_SAVE_STOP(_pSSM)      do{ int rc2 = SSMR3PutU32(_pSSM, NEMUHGSMI_STATE_STOP_MAGIC);       AssertRC(rc2);}while(0)
#define NEMUHGSMI_SAVE_FIFOSTART(_pSSM) do{ int rc2 = SSMR3PutU32(_pSSM, NEMUHGSMI_STATE_FIFOSTART_MAGIC);  AssertRC(rc2);}while(0)
#define NEMUHGSMI_SAVE_FIFOSTOP(_pSSM)  do{ int rc2 = SSMR3PutU32(_pSSM, NEMUHGSMI_STATE_FIFOSTOP_MAGIC);   AssertRC(rc2);}while(0)

#define NEMUHGSMI_LOAD_CHECK(_pSSM, _v) \
    do{ \
        uint32_t u32; \
...
#define NEMUHGSMI_LOAD_START(_pSSM) NEMUHGSMI_LOAD_CHECK(_pSSM, NEMUHGSMI_STATE_START_MAGIC)
#define NEMUHGSMI_LOAD_FIFOSTART(_pSSM) NEMUHGSMI_LOAD_CHECK(_pSSM, NEMUHGSMI_STATE_FIFOSTART_MAGIC)
#define NEMUHGSMI_LOAD_FIFOSTOP(_pSSM) NEMUHGSMI_LOAD_CHECK(_pSSM, NEMUHGSMI_STATE_FIFOSTOP_MAGIC)
#define NEMUHGSMI_LOAD_STOP(_pSSM) NEMUHGSMI_LOAD_CHECK(_pSSM, NEMUHGSMI_STATE_STOP_MAGIC)
#else
#define NEMUHGSMI_SAVE_START(_pSSM) do{ }while(0)
#define NEMUHGSMI_SAVE_STOP(_pSSM) do{ }while(0)
#define NEMUHGSMI_SAVE_FIFOSTART(_pSSM) do{ }while(0)
#define NEMUHGSMI_SAVE_FIFOSTOP(_pSSM) do{ }while(0)


#define NEMUHGSMI_LOAD_START(_pSSM) do{ }while(0)
#define NEMUHGSMI_LOAD_FIFOSTART(_pSSM) do{ }while(0)
#define NEMUHGSMI_LOAD_FIFOSTOP(_pSSM) do{ }while(0)
#define NEMUHGSMI_LOAD_STOP(_pSSM) do{ }while(0)
 ...
 *
 * @return Nemu status code. Pointer to the payload data in *ppvData.
