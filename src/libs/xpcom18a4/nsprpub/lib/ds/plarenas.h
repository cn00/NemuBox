...
#define PL_ArenaAllocate NemuNsplPL_ArenaAllocate
#define PL_ArenaFinish NemuNsplPL_ArenaFinish
#define PL_ArenaGrow NemuNsplPL_ArenaGrow
#define PL_ArenaRelease NemuNsplPL_ArenaRelease
#define PL_CompactArenaPool NemuNsplPL_CompactArenaPool
#define PL_FinishArenaPool NemuNsplPL_FinishArenaPool
#define PL_FreeArenaPool NemuNsplPL_FreeArenaPool
#define PL_InitArenaPool NemuNsplPL_InitArenaPool
