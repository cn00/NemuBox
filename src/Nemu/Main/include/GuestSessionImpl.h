...
public:
    ...
    int                     i_dispatchToDirectory(PNEMUGUESTCTRLHOSTCBCTX pCtxCb, PNEMUGUESTCTRLHOSTCALLBACK pSvcCb);
    int                     i_dispatchToFile(PNEMUGUESTCTRLHOSTCBCTX pCtxCb, PNEMUGUESTCTRLHOSTCALLBACK pSvcCb);
    int                     i_dispatchToObject(PNEMUGUESTCTRLHOSTCBCTX pCtxCb, PNEMUGUESTCTRLHOSTCALLBACK pSvcCb);
    int                     i_dispatchToProcess(PNEMUGUESTCTRLHOSTCBCTX pCtxCb, PNEMUGUESTCTRLHOSTCALLBACK pSvcCb);
    int                     i_dispatchToThis(PNEMUGUESTCTRLHOSTCBCTX pCtxCb, PNEMUGUESTCTRLHOSTCALLBACK pSvcCb);
    ...
    int                     i_onRemove(void);
    int                     i_onSessionStatusChange(PNEMUGUESTCTRLHOSTCBCTX pCbCtx, PNEMUGUESTCTRLHOSTCALLBACK pSvcCbData);
    ...
    int                     i_sendCommand(uint32_t uFunction, uint32_t uParms, PNEMUHGCMSVCPARM paParms);
...
private:
    ...
    struct Data
    {
         ...
         *  Guest Additions < Nemu 4.3 have version 1,
