...
typedef struct VHDIMAGE
{
    ...
    /** Open flags passed by NemuHDD layer. */
    unsigned        uOpenFlags;
                          ...
                          unsigned uPercentStart, unsigned uPercentSpan)
{
    ...
    memcpy(Footer.CreatorApp, "nemu", sizeof(Footer.CreatorApp));
    Footer.CreatorVer = RT_H2BE_U32(NEMU_VERSION);
#ifdef RT_OS_DARWIN
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnCheckIfValid} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnOpen} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnCreate} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnRename} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnClose} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnRead} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnWrite} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnFlush} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnGetVersion} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnGetSectorSize} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnGetSize} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnGetFileSize} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnGetPCHSGeometry} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnSetPCHSGeometry} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnGetLCHSGeometry} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnSetLCHSGeometry} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnGetImageFlags} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnGetOpenFlags} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnSetOpenFlags} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnGetComment} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnSetComment} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnGetUuid} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnSetUuid} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnGetModificationUuid} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnSetModificationUuid} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnGetParentUuid} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnSetParentUuid} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnGetParentModificationUuid} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnSetParentModificationUuid} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnDump} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnGetTimestamp} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnGetParentTimestamp} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnSetParentTimestamp} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnGetParentFilename} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnSetParentFilename} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnCompact} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnResize} */
...
/** @interface_method_impl{NEMUHDDBACKEND,pfnRepair} */
...
const NEMUHDDBACKEND g_VhdBackend =
{
    /* pszBackendName */
    "VHD",
    /* cbSize */
    sizeof(NEMUHDDBACKEND),
    /* uBackendCaps */
