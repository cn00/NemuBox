...
/** @def NEMU_WITH_RC_RELEASE_LOGGING
 * Enables RC release logging. */
#define NEMU_WITH_RC_RELEASE_LOGGING

/** @def NEMU_WITH_R0_LOGGING
 ...
 * \#if, or by adding NEMU_WITH_R0_LOGGING to your LocalConfig.kmk.
 */
#if defined(DEBUG_sandervl) || defined(DEBUG_frank) || defined(DEBUG_ramshankar) || defined(DOXYGEN_RUNNING)
# define NEMU_WITH_R0_LOGGING
#endif

/** @def NEMU_STRICT_VMM_STACK
 * Enables VMM stack guard pages to catch stack over- and underruns. */
#if defined(NEMU_STRICT) || defined(DOXYGEN_RUNNING)
# define NEMU_STRICT_VMM_STACK
#endif
