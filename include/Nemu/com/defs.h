...
#ifndef ___Nemu_com_defs_h
#define ___Nemu_com_defs_h
...
#error "NEMU_WITH_XPCOM must be defined on a platform other than Windows!"
...
#ifdef RT_OS_WINDOWS
#define NEMU_SCRIPTABLE_IMPL(iface)                                          \
    public IDispatchImpl<iface, &IID_##iface, &LIBID_NEMU,             \
                         kTypeLibraryMajorVersion, kTypeLibraryMinorVersion>

#define NEMU_SCRIPTABLE_DISPATCH_IMPL(iface)                                 \
...
#define NEMU_DEFAULT_INTERFACE_ENTRIES(iface)                                \
