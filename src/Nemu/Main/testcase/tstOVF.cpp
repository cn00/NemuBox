               ...
               std::list<Guid> &llMachinesCreated)
{
         ...
         ++u)
    {
        ...
        com::SafeArray<BSTR> aNemuValues;
        ...
        rc = pVSys->GetDescription(ComSafeArrayAsOutParam(aTypes),
                                   ...
                                   ComSafeArrayAsOutParam(aNemuValues),
             ...
             ++u2)
        {
            ...
            RTPrintf("  vsys %2u item %2u: type %2d (%s), ovf: \"%ls\", nemu: \"%ls\", extra: \"%ls\"\n",
                     u, u2, t, pcszType,
                     aOvfValues[u2],
                     aNemuValues[u2],
...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        // testcase 2: import ovf-winxp-nemu-sharedfolders/winxp.ovf
        copyDummyDiskImage("winxp-nemu-sharedfolders", llFiles2Delete, "ovf-testcases/ovf-winxp-nemu-sharedfolders/Windows 5.1 XP 1 merged.vmdk");
        copyDummyDiskImage("winxp-nemu-sharedfolders", llFiles2Delete, "ovf-testcases/ovf-winxp-nemu-sharedfolders/smallvdi.vmdk");
        importOVF("winxp-nemu-sharedfolders", pVirtualBox, "ovf-testcases/ovf-winxp-nemu-sharedfolders/winxp.ovf", llMachinesCreated);

        // testcase 3: import ovf-winxp-nemu-sharedfolders/winxp.ovf
