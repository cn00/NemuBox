...
<!--
    ...
    websrv-nsmap.xsl:
        XSLT stylesheet that generates a nemuweb.nsmap file from
 ...
 * Generator: src/Nemu/Main/webservice/websrv-nsmap.xsl */
...
SOAP_NMAC struct Namespace namespaces[] =
{
  ...
  <xsl:value-of select="concat('    {&quot;nemu&quot;, &quot;', $G_targetNamespace, $G_targetNamespaceSeparator, '&quot;, NULL, NULL},')" />
