...
#define XPT_NewArena NemuNsxpXPT_NewArena
#define XPT_ArenaMalloc NemuNsxpXPT_ArenaMalloc
#define XPT_DestroyArena NemuNsxpXPT_DestroyArena
#define XPT_ArenaFree NemuNsxpXPT_ArenaFree
#define XPT_DestroyArena NemuNsxpXPT_DestroyArena
#define XPT_DumpStats NemuNsxpXPT_DumpStats
#define XPT_NotifyDoneLoading NemuNsxpXPT_NotifyDoneLoading
#define XPT_ArenaStrDup NemuNsxpXPT_ArenaStrDup
#define XPT_AssertFailed NemuNsxpXPT_AssertFailed
