  ...
  )
{
  ...
  Private = NEMU_VGA_PRIVATE_DATA_FROM_UGA_DRAW_THIS (This);
  ...
  )
{
  ...
  for (Index = 0; Index < Private->MaxMode; Index++) {
    ...
    InitializeGraphicsMode (Private, &NemuVgaVideoModes[Private->ModeData[Index].ModeNumber]);
    if (Private->TmpBuf)
  ...
  )
{
  ...
  case EfiUgaVideoToVideo:
    ...
    NemuVgaUgaDrawBlt(This, (EFI_UGA_PIXEL *)Private->TmpBuf, EfiUgaVideoToBltBuffer, SourceX, SourceY, 0, 0, ScreenWidth - SourceX, ScreenHeight - SourceY, 0);
    NemuVgaUgaDrawBlt(This, (EFI_UGA_PIXEL *)Private->TmpBuf, EfiUgaBltBufferToVideo, 0, 0, DestinationX, DestinationY, ScreenWidth - SourceX, ScreenHeight - SourceY, 0);
    break;
  ...
  )
{
  ...
  UgaDraw->GetMode  = NemuVgaUgaDrawGetMode;
  UgaDraw->SetMode  = NemuVgaUgaDrawSetMode;
  UgaDraw->Blt      = NemuVgaUgaDrawBlt;
