...
/** @file
 * Nemu Qt GUI - UIWizardNewVMPageExpert class implementation.
 */
    ...
    : UIWizardNewVMPage1(strGroup)
{
    ...
    QVBoxLayout *pMainLayout = new QVBoxLayout(this);
    {
        ...
        m_pMemoryCnt = new QGroupBox(this);
        {
            ...
            {
                m_pRamSlider = new NemuGuestRAMSlider(m_pMemoryCnt);
                {
                ...
                m_pRamEditor = new QSpinBox(m_pMemoryCnt);
                {
                    ...
                    nemuGlobal().setMinimumWidthAccordingSymbolCount(m_pRamEditor, 5);
                }
        ...
        m_pDiskCnt = new QGroupBox(this);
        {
            ...
            QGridLayout *pDiskCntLayout = new QGridLayout(m_pDiskCnt);
            {
                ...
                m_pDiskSelector = new NemuMediaComboBox(m_pDiskCnt);
                {
...
void UIWizardNewVMPageExpert::retranslateUi()
{
    ...
    m_pRamUnits->setText(NemuGlobal::tr("MB", "size suffix MBytes=1024 KBytes"));
    m_pRamMin->setText(QString("%1 %2").arg(m_pRamSlider->minRAM()).arg(NemuGlobal::tr("MB", "size suffix MBytes=1024 KBytes")));
    m_pRamMax->setText(QString("%1 %2").arg(m_pRamSlider->maxRAM()).arg(NemuGlobal::tr("MB", "size suffix MBytes=1024 KBytes")));
...
bool UIWizardNewVMPageExpert::isComplete() const
{
    ...
    return UIWizardPage::isComplete() &&
           ...
           (m_pDiskSkip->isChecked() || !m_pDiskPresent->isChecked() || !nemuGlobal().medium(m_pDiskSelector->id()).isNull());
}
