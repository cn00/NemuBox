...
#ifndef ___Nemu_com_listeners_h
#define ___Nemu_com_listeners_h
...
#ifdef NEMU_WITH_XPCOM
# define NEMU_LISTENER_DECLARE(klazz) NS_DECL_CLASSINFO(klazz)
#else
# define NEMU_LISTENER_DECLARE(klazz)
#endif
