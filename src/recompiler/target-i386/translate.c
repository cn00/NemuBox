 ...
 reswitch:
    ...
    case 0x122: /* mov crN, reg */
        if (s->cpl != 0) {
            ...
            modrm = ldub_code(s->pc++);
#ifndef NEMU    /* mod bits are always understood to be 11 (0xc0) regardless of actual content; see AMD manuals */
            if ((modrm & 0xc0) != 0xc0)
                goto illegal_op;
#endif
            rm = (modrm & 7) | REX_B(s);
