/* $Id: NemuMediaComboBox.h $ */
/** @file
 * Nemu Qt GUI - NemuMediaComboBox class declaration.
 */
...
#ifndef __NemuMediaComboBox_h__
#define __NemuMediaComboBox_h__
...
class NemuMediaComboBox : public QComboBox
{
    Q_OBJECT
...
public:
    ...
    NemuMediaComboBox (QWidget *aParent);
