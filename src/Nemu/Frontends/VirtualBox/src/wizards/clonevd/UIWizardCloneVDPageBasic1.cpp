...
/** @file
 * Nemu Qt GUI - UIWizardCloneVDPageBasic1 class implementation.
 */
...
{
    return nemuGlobal().medium(m_pSourceDiskSelector->id()).medium();
}
...
UIWizardCloneVDPageBasic1::UIWizardCloneVDPageBasic1(const CMedium &sourceVirtualDisk)
{
    ...
    QVBoxLayout *pMainLayout = new QVBoxLayout(this);
    {
        ...
        {
            m_pSourceDiskSelector = new NemuMediaComboBox(this);
            {
