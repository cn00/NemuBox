...
# Users files first
test -f "${HOME}/Library/LaunchAgents/org.virtualbox.nemuwebsrv.plist"  && my_files+=("${HOME}/Library/LaunchAgents/org.virtualbox.nemuwebsrv.plist")

test -d /Library/StartupItems/VirtualBox/          && my_directories+=("/Library/StartupItems/VirtualBox/")
test -d /Library/Receipts/NemuStartupItems.pkg/    && my_directories+=("/Library/Receipts/NemuStartupItems.pkg/")
...
test -d "/Library/Application Support/VirtualBox/NemuDrv.kext/"     && my_directories+=("/Library/Application Support/VirtualBox/NemuDrv.kext/")
test -d "/Library/Application Support/VirtualBox/NemuUSB.kext/"     && my_directories+=("/Library/Application Support/VirtualBox/NemuUSB.kext/")
test -d "/Library/Application Support/VirtualBox/NemuNetFlt.kext/"  && my_directories+=("/Library/Application Support/VirtualBox/NemuNetFlt.kext/")
test -d "/Library/Application Support/VirtualBox/NemuNetAdp.kext/"  && my_directories+=("/Library/Application Support/VirtualBox/NemuNetAdp.kext/")
# Pre 4.3.0rc1 locations:
test -d /Library/Extensions/NemuDrv.kext/          && my_directories+=("/Library/Extensions/NemuDrv.kext/")
test -d /Library/Extensions/NemuUSB.kext/          && my_directories+=("/Library/Extensions/NemuUSB.kext/")
test -d /Library/Extensions/NemuNetFlt.kext/       && my_directories+=("/Library/Extensions/NemuNetFlt.kext/")
test -d /Library/Extensions/NemuNetAdp.kext/       && my_directories+=("/Library/Extensions/NemuNetAdp.kext/")
# Tiger support is obsolete, but we leave it here for a clean removing of older
# VirtualBox versions
test -d /Library/Extensions/NemuDrvTiger.kext/     && my_directories+=("/Library/Extensions/NemuDrvTiger.kext/")
test -d /Library/Extensions/NemuUSBTiger.kext/     && my_directories+=("/Library/Extensions/NemuUSBTiger.kext/")
test -d /Library/Receipts/NemuKEXTs.pkg/           && my_directories+=("/Library/Receipts/NemuKEXTs.pkg/")

test -f /usr/bin/VirtualBox                        && my_files+=("/usr/bin/VirtualBox")
test -f /usr/bin/NemuManage                        && my_files+=("/usr/bin/NemuManage")
test -f /usr/bin/NemuVRDP                          && my_files+=("/usr/bin/NemuVRDP")
test -f /usr/bin/NemuHeadless                      && my_files+=("/usr/bin/NemuHeadless")
test -f /usr/bin/nemuwebsrv                        && my_files+=("/usr/bin/nemuwebsrv")
test -f /usr/bin/NemuBalloonCtrl                   && my_files+=("/usr/bin/NemuBalloonCtrl")
test -f /usr/bin/NemuAutostart                     && my_files+=("/usr/bin/NemuAutostart")
test -f /usr/bin/NemuDTrace                        && my_files+=("/usr/bin/NemuDTrace")
test -f /usr/bin/nemu-img                          && my_files+=("/usr/bin/nemu-img")
test -f /usr/local/bin/VirtualBox                  && my_files+=("/usr/local/bin/VirtualBox")
test -f /usr/local/bin/NemuManage                  && my_files+=("/usr/local/bin/NemuManage")
test -f /usr/local/bin/NemuVRDP                    && my_files+=("/usr/local/bin/NemuVRDP")
test -f /usr/local/bin/NemuHeadless                && my_files+=("/usr/local/bin/NemuHeadless")
test -f /usr/local/bin/nemuwebsrv                  && my_files+=("/usr/local/bin/nemuwebsrv")
test -f /usr/local/bin/NemuBalloonCtrl             && my_files+=("/usr/local/bin/NemuBalloonCtrl")
test -f /usr/local/bin/NemuAutostart               && my_files+=("/usr/local/bin/NemuAutostart")
test -f /usr/local/bin/NemuDTrace                  && my_files+=("/usr/local/bin/NemuDTrace")
test -f /usr/local/bin/nemu-img                    && my_files+=("/usr/local/bin/nemu-img")
...
# legacy
test -d /Library/Receipts/NemuDrv.pkg/             && my_directories+=("/Library/Receipts/NemuDrv.pkg/")
test -d /Library/Receipts/NemuUSB.pkg/             && my_directories+=("/Library/Receipts/NemuUSB.pkg/")

# python stuff
python_versions="2.3 2.5 2.6 2.7"
for p in $python_versions; do
    test -f /Library/Python/$p/site-packages/nemuapi/VirtualBox_constants.py  && my_files+=("/Library/Python/$p/site-packages/nemuapi/VirtualBox_constants.py")
    test -f /Library/Python/$p/site-packages/nemuapi/VirtualBox_constants.pyc && my_files+=("/Library/Python/$p/site-packages/nemuapi/VirtualBox_constants.pyc")
    test -f /Library/Python/$p/site-packages/nemuapi/__init__.py              && my_files+=("/Library/Python/$p/site-packages/nemuapi/__init__.py")
    test -f /Library/Python/$p/site-packages/nemuapi/__init__.pyc             && my_files+=("/Library/Python/$p/site-packages/nemuapi/__init__.pyc")
    test -f /Library/Python/$p/site-packages/nemuapi-1.0-py$p.egg-info        && my_files+=("/Library/Python/$p/site-packages/nemuapi-1.0-py$p.egg-info")
    test -d /Library/Python/$p/site-packages/nemuapi/                         && my_directories+=("/Library/Python/$p/site-packages/nemuapi/")
done
...
#
declare -a my_kexts
for kext in org.virtualbox.kext.NemuUSB org.virtualbox.kext.NemuNetFlt org.virtualbox.kext.NemuNetAdp org.virtualbox.kext.NemuDrv; do
...
my_pkgs=`/usr/sbin/pkgutil --pkgs="${my_pb}nemukexts|${my_pb}nemustartupitems|${my_pb}virtualbox|${my_pb}virtualboxcli"`
...
#
my_processes="`ps -axco 'pid uid command' | grep -wEe '(VirtualBox|VirtualBoxVM|NemuManage|NemuHeadless|nemuwebsrv|NemuXPCOMIPCD|NemuSVC|NemuNetDHCP|NemuNetNAT)' | grep -vw grep | grep -vw VirtualBox_Uninstall.tool | tr '\n' '\a'`";
