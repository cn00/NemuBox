...
#define GetCurrentContext() NemuTlsRefGetCurrent(CRContext, &__contextTSD)
...
#define SetCurrentContext(_ctx) NemuTlsRefSetCurrent(CRContext, &__contextTSD, _ctx)
#else
extern CRContext *__currentContext;
#define GetCurrentContext() __currentContext
#endif

extern GLboolean g_bNemuEnableDiffOnMakeCurrent;
