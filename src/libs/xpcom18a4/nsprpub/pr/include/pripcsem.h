...
#define PR_OpenSemaphore NemuNsprPR_OpenSemaphore
#define PR_WaitSemaphore NemuNsprPR_WaitSemaphore
#define PR_PostSemaphore NemuNsprPR_PostSemaphore
#define PR_CloseSemaphore NemuNsprPR_CloseSemaphore
#define PR_DeleteSemaphore NemuNsprPR_DeleteSemaphore
