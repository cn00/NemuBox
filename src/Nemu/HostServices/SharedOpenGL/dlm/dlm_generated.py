...
def wrap_struct(functionName):
	...
	print '	NemuDLOpCode iNemuOpCode;'
...
def wrap_compile(functionName):
    ...
    # Set OPCODE.
    print '    instance->iNemuOpCode = NEMU_DL_OPCODE_%s;' % functionName
...
if whichfile == "headers":
    ...
    print 'typedef void (*NemuDLMExecuteFn)(struct DLMInstanceList *instance, SPUDispatchTable *dispatchTable);'
    print ''
    print 'extern NemuDLMExecuteFn g_NemuDLMExecuteFns[NEMU_DL_OPCODE_MAX];'
    print ''
else:
    print ''
    print 'NemuDLMExecuteFn g_NemuDLMExecuteFns[] = {'
