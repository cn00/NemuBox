...
#ifndef ___NemuDbgLog_h__
#define ___NemuDbgLog_h__

#ifndef NEMU_DBG_LOG_NAME
# error NEMU_DBG_LOG_NAME should be defined!
#endif

/* Uncomment to show file/line info in the log */
/*#define NEMU_DBG_LOG_SHOWLINEINFO*/

#define NEMU_DBG_LOG_PREFIX_FMT NEMU_DBG_LOG_NAME"::"LOG_FN_FMT": "
#define NEMU_DBG_LOG_PREFIX_PARMS __PRETTY_FUNCTION__

#ifdef NEMU_DBG_LOG_SHOWLINEINFO
# define NEMU_DBG_LOG_SUFFIX_FMT " (%s:%d)\n"
# define NEMU_DBG_LOG_SUFFIX_PARMS ,__FILE__, __LINE__
#else
# define NEMU_DBG_LOG_SUFFIX_FMT "\n"
# define NEMU_DBG_LOG_SUFFIX_PARMS
#endif
...
#define _LOGMSG(_logger, _a)                                                \
    do                                                                      \
    {                                                                       \
        _logger((NEMU_DBG_LOG_PREFIX_FMT, NEMU_DBG_LOG_PREFIX_PARMS));  \
        _logger(_a);                                                        \
        _logger((NEMU_DBG_LOG_SUFFIX_FMT  NEMU_DBG_LOG_SUFFIX_PARMS));  \
    } while (0)
...
#define WARN_NOBP(_a)                                                          \
    do                                                                            \
    {                                                                             \
        Log((NEMU_DBG_LOG_PREFIX_FMT"WARNING! ", NEMU_DBG_LOG_PREFIX_PARMS)); \
        Log(_a);                                                                  \
        Log((NEMU_DBG_LOG_SUFFIX_FMT NEMU_DBG_LOG_SUFFIX_PARMS));             \
    } while (0)
