...
void PACK_APIENTRY crPackNemuTexPresent( CR_PACKER_CONTEXT_ARGDECL GLuint texture, GLuint cfg, GLint xPos, GLint yPos, GLint cRects, const GLint * pRects )
{
    GLint i, size, cnt;
    ...
    WRITE_DATA( 4, GLenum, CR_NEMUTEXPRESENT_EXTEND_OPCODE );
