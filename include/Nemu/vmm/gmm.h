...
#ifndef ___Nemu_vmm_gmm_h
#define ___Nemu_vmm_gmm_h
 ...
 */
#ifdef IN_GMM_R0
# define GMMR0DECL(type)    DECLEXPORT(type) NEMUCALL
#else
# define GMMR0DECL(type)    DECLIMPORT(type) NEMUCALL
#endif
 ...
 */
#ifdef IN_GMM_R3
# define GMMR3DECL(type)    DECLEXPORT(type) NEMUCALL
#else
# define GMMR3DECL(type)    DECLIMPORT(type) NEMUCALL
#endif
...
GMMR0DECL(int)  GMMR0RegisterSharedModule(PVM pVM, VMCPUID idCpu, NEMUOSFAMILY enmGuestOS, char *pszModuleName, char *pszVersion,
