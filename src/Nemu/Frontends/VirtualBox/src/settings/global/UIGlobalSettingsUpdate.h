...
/** @file
 * Nemu Qt GUI - UIGlobalSettingsUpdate class declaration.
 */
...
struct UISettingsCacheGlobalUpdate
{
    ...
    NemuUpdateData::PeriodType m_periodIndex;
    NemuUpdateData::BranchType m_branchIndex;
    QString m_strDate;
};
...
private:
    ...
    /* Helpers: */
    NemuUpdateData::PeriodType periodType() const;
    NemuUpdateData::BranchType branchType() const;
