/* $Id: NemuStubCertUtil.cpp $ */
/** @file
 * NemuStub - VirtualBox's Windows installer stub (certificate manipulations).
 *
 * NOTE: The content of this file is partly
 *       grabbed from src/Nemu/Additions/WINNT/tools/NemuCertUtil.cpp
 */
