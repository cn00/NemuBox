...
@NEMU_PRODUCT@ for Solaris (TM) Operating System
--------------------------------------------------------
...
2. Install the VirtualBox package:
      ...
      pkgadd -d VirtualBox-@NEMU_VERSION_STRING@-SunOS-@BUILD_TARGET_ARCH@-r@NEMU_SVN_REV@.pkg

      To perform an unattended (non-interactive) installation of this
      package, add "-n -a autoresponse SUNWnemu" (without quotes)
