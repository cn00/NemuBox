...
#ifndef ___Nemu_vmm_vmapi_h
#define ___Nemu_vmm_vmapi_h
...
{
    /** The request returns a Nemu status code. */
    VMREQFLAGS_NEMU_STATUS  = 0,
...
typedef struct VMREQ
{
    ...
    /** Nemu status code for the completed request. */
