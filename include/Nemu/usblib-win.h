/** @file
 * USBLib - Library for wrapping up the NemuUSB functionality, Windows flavor.
 * (DEV,HDrv,Main)
 */
...
#ifndef ___Nemu_usblib_win_h
#define ___Nemu_usblib_win_h
...
DEFINE_GUID(GUID_CLASS_NEMUUSB, 0x873fdf, 0xCAFE, 0x80EE, 0xaa, 0x5e, 0x0, 0xc0, 0x4f, 0xb1, 0x72, 0xb);

#define USBFLT_SERVICE_NAME              "\\\\.\\NemuUSBFlt"
#define USBFLT_NTDEVICE_NAME_STRING      L"\\Device\\NemuUSBFlt"
#define USBFLT_SYMBOLIC_NAME_STRING      L"\\DosDevices\\NemuUSBFlt"

#define USBMON_SERVICE_NAME_W              L"NemuUSBMon"
#define USBMON_DEVICE_NAME               "\\\\.\\NemuUSBMon"
#define USBMON_DEVICE_NAME_NT            L"\\Device\\NemuUSBMon"
#define USBMON_DEVICE_NAME_DOS           L"\\DosDevices\\NemuUSBMon"
...
typedef void* HNEMUUSBDEVUSR;

typedef struct
{
    HNEMUUSBDEVUSR  hDevice;
    uint8_t         fAttached;
    uint8_t         fHiSpeed;
