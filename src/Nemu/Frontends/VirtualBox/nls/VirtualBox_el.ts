...
<context>
    ...
    <message>
        ...
        <translation type="obsolete">Ο οδηγός πυρήνα του VirtualBox Linux (nemudrv) δεν φορτώθηκε ή υπάρχει πρόβλημα με δικαιώματα του /dev/nemudrv. Εγκαταστήστε ξανά την υπομονάδα του πυρήνα εκτελώντας&lt;br/&gt;&lt;br/&gt;  &lt;font color=&quot;blue&quot;&gt;&apos;/etc/init.d/nemudrv setup&apos;&lt;/font&gt;&lt;br/&gt;&lt;br/&gt;σαν διαχειριστής. Χρήστες των Ubuntu, Fedora ή Mandriva θα έπρεπε να εγκαταστήσουν πρώτα το πακέτο DKMS. Αυτό το πακέτο διατηρεί ένα αρχείο με τις αλλαγές στον πυρήνα του Linux και ξαναχτίζει την υπομονάδα του πυρήνα nemudrv αν χρειάζεται.</translation>
    </message>
    <message>
