; $Id:  $
;; @file
; NemuGuestAdditionsUninstallOld.nsh - Guest Additions uninstallation handling
;                                      for legacy packages.
;
...
common:
  ...
  ;Delete "$SYSDIR\drivers\NemuMouseNT.sys"
...
common:
  ...
  Delete /REBOOTOK "$1\NemuGuestDrvInst.exe"
  Delete /REBOOTOK "$1\NemuMouseInst.exe"
  Delete /REBOOTOK "$1\NemuSFDrvInst.exe"
  Delete /REBOOTOK "$1\RegCleanup.exe"
  Delete /REBOOTOK "$1\NemuService.exe"
  Delete /REBOOTOK "$1\NemuMouseInst.exe"
  ...
  Delete /REBOOTOK "$1\NemuControl.exe"
  Delete /REBOOTOK "$1\NemuDisp.dll"
  Delete /REBOOTOK "$1\NemuGINA.dll"
  Delete /REBOOTOK "$1\NemuGuest.cat"
  Delete /REBOOTOK "$1\NemuGuest.inf"
  Delete /REBOOTOK "$1\NemuGuest.sys"
  Delete /REBOOTOK "$1\NemuMouse.inf"
  Delete /REBOOTOK "$1\NemuMouse.sys"
  Delete /REBOOTOK "$1\NemuVideo.cat"
  Delete /REBOOTOK "$1\NemuVideo.inf"
  Delete /REBOOTOK "$1\NemuVideo.sys"
