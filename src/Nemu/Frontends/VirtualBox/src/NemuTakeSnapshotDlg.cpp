/* $Id: NemuTakeSnapshotDlg.cpp $ */
/** @file
 * Nemu Qt GUI - NemuTakeSnapshotDlg class implementation.
 */
...
NemuTakeSnapshotDlg::NemuTakeSnapshotDlg(QWidget *pParent, const CMachine &machine)
    : QIWithRetranslateUI<QIDialog>(pParent)
{
    /* Apply UI decorations */
    Ui::NemuTakeSnapshotDlg::setupUi(this);
...
void NemuTakeSnapshotDlg::retranslateUi()
{
    /* Translate uic generated strings */
    Ui::NemuTakeSnapshotDlg::retranslateUi(this);
}

void NemuTakeSnapshotDlg::nameChanged(const QString &strName)
{
