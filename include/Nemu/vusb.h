...
#ifndef ___Nemu_vusb_h
#define ___Nemu_vusb_h
...
/** @defgroup grp_vusb  Nemu USB API
 * @{
 */
...
/** Pointer to a Nemu USB device interface. */
...
/** Pointer to a Nemu USB port bitmap. */
...
/**
 * The VUSB RootHub connector interface provided by the Nemu USB RootHub driver
 * (up).
...
typedef struct VUSBIROOTHUBCONNECTOR
{
     ...
     * @returns Other Nemu status code.
     *
     * @param   pInterface  Pointer to this struct.
 ...
 * @param   rc      The Nemu status code of the reset operation.
