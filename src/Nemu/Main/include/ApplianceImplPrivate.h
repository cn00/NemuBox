...
struct VirtualSystemDescription::Data
{
    ...
    settings::MachineConfigFile
                            *pConfig;           // machine config created from <nemu:Machine> element if found (import only)
};
