/* $Id: NemuDnDDropSource.cpp $ */
/** @file
 * NemuDnDSource.cpp - IDropSource implementation.
 */
...
NemuDnDDropSource::NemuDnDDropSource(NemuDnDWnd *pParent)
    : mRefCount(1),
      mpWndParent(pParent),
      mdwCurEffect(0),
...
NemuDnDDropSource::~NemuDnDDropSource(void)
{
...
STDMETHODIMP_(ULONG) NemuDnDDropSource::AddRef(void)
{
    return InterlockedIncrement(&mRefCount);
}

STDMETHODIMP_(ULONG) NemuDnDDropSource::Release(void)
{
...
STDMETHODIMP NemuDnDDropSource::QueryInterface(REFIID iid, void **ppvObject)
{
 ...
 * @return  HRESULT
 */
STDMETHODIMP NemuDnDDropSource::QueryContinueDrag(BOOL fEscapePressed, DWORD dwKeyState)
{
#if 1
 ...
 * @return  HRESULT
 */
STDMETHODIMP NemuDnDDropSource::GiveFeedback(DWORD dwEffect)
{
