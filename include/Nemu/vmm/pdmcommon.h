...
#ifndef ___Nemu_vmm_pdmcommon_h
#define ___Nemu_vmm_pdmcommon_h
 ...
 *
 * @returns Nemu status code. PDMDevHlpCallR0 will return this.
 ...
 * The ring-0 driver request handler.
 *
 * @returns Nemu status code. PDMDrvHlpCallR0 will return this.
