/* $Id: NemuGlobal.h $ */
/** @file
 * Nemu Qt GUI - NemuGlobal class declaration.
 */
...
#ifndef ___NemuGlobal_h___
#define ___NemuGlobal_h___
...
class NemuGlobal : public QObject
{
    Q_OBJECT
...
public:
    ...
    QString nemuVersionString() const;
    QString nemuVersionStringNormalized() const;
    ...
    /** Mac OS X: Returns #MacOSXRelease determined during NemuGlobal prepare routine. */
    ...
    CVirtualBox virtualBox() const { return m_nemu; }
    ...
    /** Returns the NemuSVC availability value. */
    bool isNemuSVCAvailable() const { return m_fNemuSVCAvailable; }
    ...
    NemuGlobalSettings &settings() { return gset; }
    bool setSettings (NemuGlobalSettings &gs);
    ...
    RTLDRMOD getDebuggerModule() const { return m_hNemuDbg; }
    ...
    /* Nemu enum to/from string/icon/color convertors */
...
signals:
    ...
    /** Notifies listeners about the NemuSVC availability change. */
    void sigNemuSVCAvailabilityChange();
...
protected slots:
    ...
    /** Handles the NemuSVC availability change. */
    void sltHandleNemuSVCAvailabilityChange(bool fAvailable);
...
private:
    ...
    /** Holds whether NemuSVC is currently available. */
    bool m_fNemuSVCAvailable;

    NemuGlobalSettings gset;
     ...
     * Use --dbg, the env.var. NEMU_GUI_DBG_ENABLED,
     *     --debug or the env.var. NEMU_GUI_DBG_AUTO_SHOW to enable. */
    mutable int m_fDbgEnabled;
    /** Whether to show the debugger automatically with the console.
     * Use --debug or the env.var. NEMU_GUI_DBG_AUTO_SHOW to enable. */
    ...
    static NemuGlobal* m_spInstance;
    friend NemuGlobal& nemuGlobal();
};

/* Shortcut to the static NemuGlobal::instance() method: */
inline NemuGlobal& nemuGlobal() { return *NemuGlobal::instance(); }

#endif /* !___NemuGlobal_h___ */
