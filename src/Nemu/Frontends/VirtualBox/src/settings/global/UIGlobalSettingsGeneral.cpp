...
/** @file
 * Nemu Qt GUI - UIGlobalSettingsGeneral class implementation.
 */
...
UIGlobalSettingsGeneral::UIGlobalSettingsGeneral()
{
    ...
    /* Setup widgets: */
    m_pSelectorMachineFolder->setHomeDir(nemuGlobal().homeFolder());
    m_pSelectorVRDPLibName->setHomeDir(nemuGlobal().homeFolder());
    m_pSelectorVRDPLibName->setMode(NemuFilePathSelectorWidget::Mode_File_Open);
