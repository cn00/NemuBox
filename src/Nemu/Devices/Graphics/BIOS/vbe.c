...
char vbebios_vendor_name[]      = NEMU_VENDOR;
char vbebios_product_name[]     = NEMU_PRODUCT " VBE Adapter";
char vbebios_product_revision[] = NEMU_PRODUCT " Version " NEMU_VERSION_STRING;
...
#ifdef VGA_DEBUG
char msg_vbe_init[] = "VirtualBox Version " NEMU_VERSION_STRING " VBE Display Adapter\r\n";
#endif
