...
#endif
    CPU86_LDouble ft0;
#if defined(NEMU) && defined(RT_ARCH_X86) && !defined(RT_OS_DARWIN)
...
#ifndef NEMU /* remR3CpuId deals with these */
...
# if HC_ARCH_BITS == 64 \
  || (   HC_ARCH_BITS == 32 \
      ...
      && (   (!defined(NEMU_ENABLE_NEMUREM64) && !defined(RT_OS_SOLARIS) && !defined(RT_OS_FREEBSD)) \
          || (defined(NEMU_ENABLE_NEMUREM64) && (defined(RT_OS_SOLARIS) || defined(RT_OS_FREEBSD))) ) )
