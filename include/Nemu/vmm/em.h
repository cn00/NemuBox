...
#ifndef ___Nemu_vmm_em_h
#define ___Nemu_vmm_em_h
...
VMM_INT_DECL(NEMUSTRICTRC)      EMInterpretInstruction(PVMCPU pVCpu, PCPUMCTXCORE pCoreCtx, RTGCPTR pvFault);
...
VMM_INT_DECL(NEMUSTRICTRC)      EMInterpretInstructionDisasState(PVMCPU pVCpu, PDISCPUSTATE pDis, PCPUMCTXCORE pCoreCtx,
