/** @file
 * Nemu Remote Desktop Extension (VRDE) - Mouse pointer updates interface.
 */
...
#ifndef ___Nemu_RemoteDesktop_VRDEMousePtr_h
#define ___Nemu_RemoteDesktop_VRDEMousePtr_h
