...
#define PR_CEnterMonitor NemuNsprPR_CEnterMonitor
#define PR_CExitMonitor NemuNsprPR_CExitMonitor
#define PR_CNotify NemuNsprPR_CNotify
#define PR_CWait NemuNsprPR_CWait
#define PR_CNotifyAll NemuNsprPR_CNotifyAll
#define PR_CSetOnMonitorRecycle NemuNsprPR_CSetOnMonitorRecycle
