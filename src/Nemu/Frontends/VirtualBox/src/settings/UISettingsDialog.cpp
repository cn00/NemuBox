...
/** @file
 * Nemu Qt GUI - UISettingsDialog class implementation.
 */
    ...
    , m_pWhatsThisCandidate(0)
{
    ...
    m_pSelector = new NemuSettingsToolBarSelector(this);
    ...
    m_pSelector = new NemuSettingsTreeViewSelector(this);
...
#ifndef NEMU_GUI_WITH_TOOLBAR_SETTINGS
