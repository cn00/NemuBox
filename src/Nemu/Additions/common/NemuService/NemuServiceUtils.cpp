/* $Id: NemuServiceUtils.cpp $ */
/** @file
 * NemuServiceUtils - Some utility functions.
 */
 ...
 *
 * @returns Nemu status code, fully bitched.
 *
 ...
 * logging.
 *
 * @returns Nemu status code. Errors will be logged.
 *
 * @param   u32ClientId     The HGCM client ID for the guest property session.
 ...
 *
 * @returns Nemu status code.  The output buffer is always valid and the status
