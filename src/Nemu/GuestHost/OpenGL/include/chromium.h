...
/* to shut up gcc warning for struct NEMUUHGSMI * parameters */
struct NEMUUHGSMI;
...
#if defined(IN_GUEST) && (WINDOWS) && defined(NEMU_WITH_WDDM)
# ifdef NEMU_WDDM_WOW64
#  define NEMU_MODNAME_DISPD3D "NemuDispD3D-x86"
# else
#  define NEMU_MODNAME_DISPD3D "NemuDispD3D"
# endif
#endif
...
extern void APIENTRY crNemuTexPresent(GLuint texture, GLuint cfg, GLint xPos, GLint yPos, GLint cRects, const GLint *pRects);
