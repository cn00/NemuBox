 ...
 * @param   pszGroupSettings    The group settings string. (NEMU_LOG)
 */
 ...
 * @returns Nemu status code.
 * @param   pUVM                The user mode VM handle.
 * @param   pszFlagSettings     The group settings string. (NEMU_LOG_FLAGS)
 */
 ...
 * @returns Nemu status code.
 * @param   pUVM                The user mode VM handle.
 * @param   pszDestSettings     The destination settings string. (NEMU_LOG_DEST)
 */
