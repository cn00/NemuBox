...
/** @file
 * Nemu Qt GUI - UIWizardImportAppPageExpert class implementation.
 */
...
UIWizardImportAppPageExpert::UIWizardImportAppPageExpert(const QString &strFileName)
{
    ...
    QVBoxLayout *pMainLayout = new QVBoxLayout(this);
    {
        ...
        m_pApplianceCnt = new QGroupBox(this);
        {
            ...
            {
                m_pFileSelector = new NemuEmptyFileSelector(m_pApplianceCnt);
                {
                    m_pFileSelector->setHomeDir(nemuGlobal().documentsPath());
                    m_pFileSelector->setMode(NemuFilePathSelectorWidget::Mode_File_Open);
...
bool UIWizardImportAppPageExpert::isComplete() const
{
    ...
    return NemuGlobal::hasAllowedExtension(m_pFileSelector->path().toLower(), OVFFileExts) &&
