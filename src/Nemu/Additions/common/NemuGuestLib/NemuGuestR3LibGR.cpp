/* $Id: NemuGuestR3LibGR.cpp $ */
/** @file
 * NemuGuestR3Lib - Ring-3 Support Library for VirtualBox guest additions, GR.
 */
...
{
    return vbglR3DoIOCtl(NEMUGUEST_IOCTL_VMMREQUEST(pReq->size), pReq, pReq->size);
}
