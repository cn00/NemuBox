 ...
 */
static int vdReadHelper(PNEMUHDD pDisk, uint64_t off, void *pvBuf, size_t cbRead)
{
    int rc = VINF_SUCCESS;
 ...
 */
static int vdWriteHelper(PNEMUHDD pDisk, uint64_t off, const void *pvBuf, size_t cbWrite)
{
    int rc = VINF_SUCCESS;
