...
6b. While in the group policy editor, make sure that  "Computer Configuration"
   ...
   disabled so the nemu account can be created later one.
...
9. Create a user named "nemu" with password "password".  Must be an
   Administrator user!

10. Configure user "nemu" to log in automatically via "control userpasswords2".
...
21. Activate windows. "https://linserv.de.oracle.com/nemu/wiki/MSDN Volume License Keys"
