...
#ifndef ___Nemu_GuestHost_SharedClipboard_h
#define ___Nemu_GuestHost_SharedClipboard_h
...
/** Opaque data structure for the X11/Nemu frontend/glue code. */
struct _NEMUCLIPBOARDCONTEXT;
typedef struct _NEMUCLIPBOARDCONTEXT NEMUCLIPBOARDCONTEXT;

/** Opaque data structure for the X11/Nemu backend code. */
struct _CLIPBACKEND;
...
extern CLIPBACKEND *ClipConstructX11(NEMUCLIPBOARDCONTEXT *pFrontend, bool fHeadless);
...
/* APIs exported by the X11/Nemu frontend */
extern int ClipRequestDataForX11(NEMUCLIPBOARDCONTEXT *pCtx,
                                 uint32_t u32Format, void **ppv,
                                 uint32_t *pcb);
extern void ClipReportX11Formats(NEMUCLIPBOARDCONTEXT *pCtx,
                                 uint32_t u32Formats);
extern void ClipCompleteDataRequestFromX11(NEMUCLIPBOARDCONTEXT *pCtx, int rc,
