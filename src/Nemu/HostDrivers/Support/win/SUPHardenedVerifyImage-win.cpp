...
#if defined(NEMU_PERMIT_EVEN_MORE) && !defined(NEMU_PERMIT_MORE)
# error "NEMU_PERMIT_EVEN_MORE without NEMU_PERMIT_MORE!"
#endif
...
#if defined(IN_RING3) && !defined(NEMU_PERMIT_EVEN_MORE)
...
# endif
#endif /* IN_RING3 && !NEMU_PERMIT_MORE*/
...
DECLHIDDEN(int) supHardNtViRdrCreate(HANDLE hFile, PCRTUTF16 pwszName, uint32_t fFlags, PSUPHNTVIRDR *ppNtViRdr)
{
     ...
     */
#if defined(IN_RING3) || defined(NEMU_STRICT)
...
#ifdef NEMU_PERMIT_VERIFIER_DLL
...
#endif /* NEMU_PERMIT_MORE */


#ifndef IN_RING0
# if defined(NEMU_PERMIT_MORE) && !defined(NEMU_PERMIT_EVEN_MORE)
    /*
...
# elif defined(NEMU_PERMIT_MORE) && defined(NEMU_PERMIT_EVEN_MORE)
    /*
                                                  ...
                                                  bool fAvoidWinVerifyTrust, bool *pfWinVerifyTrust, PRTERRINFO pErrInfo)
{
     ...
     * owning user32.dll, see public ticket 13187, NemuStartup.3.log.)
     *
...
#endif /* IN_RING3 && !NEMU_PERMIT_EVEN_MORE */
 ...
 * and we require all Nemu extensions to have it set as well.  In effect, the
...
# ifdef IN_SUP_HARDENED_R3
    ...
    supR3HardenedPathAppSharedLibs(szPath, sizeof(szPath) - sizeof("/NemuSupLib.DLL"));
    suplibHardenedStrCat(szPath, "/NemuSupLib.DLL");
