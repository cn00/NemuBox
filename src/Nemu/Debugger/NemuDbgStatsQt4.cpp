/* $Id: NemuDbgStatsQt4.cpp $ */
/** @file
 * Nemu Debugger GUI - Statistics.
 */
 ...
 */
class NemuDbgStatsModel : public QAbstractItemModel
{
protected:
...
public:
     ...
     *                          docs for details.
     */
    NemuDbgStatsModel(QObject *a_pParent);
 ...
 */
class NemuDbgStatsModelVM : public NemuDbgStatsModel, public NemuDbgBase
{
public:
    /**
     * Constructor.
     ...
     */
    NemuDbgStatsModelVM(NemuDbgGui *a_pDbgGui, QString &a_rPatStr, QObject *a_pParent);

    /** Destructor */
    virtual ~NemuDbgStatsModelVM();
...
NemuDbgStatsModel::NemuDbgStatsModel(QObject *a_pParent)
...
NemuDbgStatsModel::~NemuDbgStatsModel()
{
    destroyTree(m_pRoot);
    m_pRoot = NULL;
}
...
/*static*/ void
NemuDbgStatsModel::destroyTree(PDBGGUISTATSNODE a_pRoot)
{
    if (!a_pRoot)
        return;
...
/* static*/ void
NemuDbgStatsModel::destroyNode(PDBGGUISTATSNODE a_pNode)
{
...
NemuDbgStatsModel::createRootNode(void)
{
...
/*static*/ PDBGGUISTATSNODE
NemuDbgStatsModel::createAndInsertNode(PDBGGUISTATSNODE pParent, const char *pszName, size_t cchName, uint32_t iPosition)
{
    /*
     * Create it.
     */
...
PDBGGUISTATSNODE
NemuDbgStatsModel::createAndInsert(PDBGGUISTATSNODE pParent, const char *pszName, size_t cchName, uint32_t iPosition)
{
    PDBGGUISTATSNODE pNode;
...
/*static*/ PDBGGUISTATSNODE
NemuDbgStatsModel::removeNode(PDBGGUISTATSNODE pNode)
{
...
/*static*/ void
NemuDbgStatsModel::removeAndDestroyNode(PDBGGUISTATSNODE pNode)
{
    removeNode(pNode);
    destroyNode(pNode);
}
...
void
NemuDbgStatsModel::removeAndDestroy(PDBGGUISTATSNODE pNode)
{
    if (m_fUpdateInsertRemove)
...
/*static*/ void
NemuDbgStatsModel::resetNode(PDBGGUISTATSNODE pNode)
{
...
/*static*/ int
NemuDbgStatsModel::initNode(PDBGGUISTATSNODE pNode, STAMTYPE enmType, void *pvSample, STAMUNIT enmUnit, const char *pszDesc)
{
    /*
     * Copy the data.
     */
...
/*static*/ void
NemuDbgStatsModel::updateNode(PDBGGUISTATSNODE pNode, STAMTYPE enmType, void *pvSample, STAMUNIT enmUnit, const char *pszDesc)
{
...
/*static*/ ssize_t
NemuDbgStatsModel::getNodePath(PCDBGGUISTATSNODE pNode, char *psz, ssize_t cch)
{
    ssize_t off;
    if (!pNode->pParent)
    {
...
/*static*/ char *
NemuDbgStatsModel::getNodePath2(PCDBGGUISTATSNODE pNode, char *psz, ssize_t cch)
{
    if (NemuDbgStatsModel::getNodePath(pNode, psz, cch) < 0)
        return NULL;
    return psz;
}
...
/*static*/ bool
NemuDbgStatsModel::isNodeAncestorOf(PCDBGGUISTATSNODE pAncestor, PCDBGGUISTATSNODE pDescendant)
{
    while (pDescendant)
    {
...
/*static*/ PDBGGUISTATSNODE
NemuDbgStatsModel::nextNode(PDBGGUISTATSNODE pNode)
{
    if (!pNode)
        return NULL;
...
/*static*/ PDBGGUISTATSNODE
NemuDbgStatsModel::nextDataNode(PDBGGUISTATSNODE pNode)
{
    do
...
/*static*/ PDBGGUISTATSNODE
NemuDbgStatsModel::prevNode(PDBGGUISTATSNODE pNode)
{
    if (!pNode)
        return NULL;
    PDBGGUISTATSNODE pParent = pNode->pParent;
...
/*static*/ PDBGGUISTATSNODE
NemuDbgStatsModel::prevDataNode(PDBGGUISTATSNODE pNode)
{
    do
...
#if 0
/*static*/ PDBGGUISTATSNODE
NemuDbgStatsModel::createNewTree(IMachineDebugger *a_pIMachineDebugger)
{
    /** @todo  */
    return NULL;
}
...
#if 0
/*static*/ PDBGGUISTATSNODE
NemuDbgStatsModel::createNewTree(const char *pszFilename)
{
    /** @todo  */
    return NULL;
}
...
#if 0
/*static*/ PDBGGUISTATSNODE
NemuDbgStatsModel::createDiffTree(PDBGGUISTATSNODE pTree1, PDBGGUISTATSNODE pTree2)
{
    /** @todo  */
    return NULL;
}
...
PDBGGUISTATSNODE
NemuDbgStatsModel::updateCallbackHandleOutOfOrder(const char *pszName)
{
#if defined(NEMU_STRICT) || defined(LOG_ENABLED)
    char szStrict[1024];
#endif
...
PDBGGUISTATSNODE
NemuDbgStatsModel::updateCallbackHandleTail(const char *pszName)
{
    /*
...
void
NemuDbgStatsModel::updateCallbackAdvance(PDBGGUISTATSNODE pNode)
{
    /*
...
NemuDbgStatsModel::updateCallback(const char *pszName, STAMTYPE enmType, void *pvSample, STAMUNIT enmUnit,
                                  STAMVISIBILITY enmVisibility, const char *pszDesc, void *pvUser)
{
    NemuDbgStatsModelVM *pThis = (NemuDbgStatsModelVM *)pvUser;
...
bool
NemuDbgStatsModel::updatePrepare(void)
{
    /*
...
bool
NemuDbgStatsModel::updateDone(bool a_fSuccess)
{
    /*
...
bool
NemuDbgStatsModel::updateStatsByPattern(const QString &a_rPatStr)
{
    /* stub */
    NOREF(a_rPatStr);
    return false;
...
void
NemuDbgStatsModel::updateStatsByIndex(QModelIndex const &a_rIndex)
{
...
void
NemuDbgStatsModel::resetStatsByPattern(QString const &a_rPatStr)
{
    /* stub */
    NOREF(a_rPatStr);
}
...
void
NemuDbgStatsModel::resetStatsByIndex(QModelIndex const &a_rIndex, bool fSubTree /*= true*/)
{
...
QModelIndex
NemuDbgStatsModel::getRootIndex(void) const
{
    if (!m_pRoot)
        return QModelIndex();
...
void
NemuDbgStatsModel::setRootNode(PDBGGUISTATSNODE a_pRoot)
{
...
Qt::ItemFlags
NemuDbgStatsModel::flags(const QModelIndex &a_rIndex) const
{
...
int
NemuDbgStatsModel::columnCount(const QModelIndex &a_rParent) const
{
    NOREF(a_rParent);
...
int
NemuDbgStatsModel::rowCount(const QModelIndex &a_rParent) const
{
...
bool
NemuDbgStatsModel::hasChildren(const QModelIndex &a_rParent) const
{
    PDBGGUISTATSNODE pParent = nodeFromIndex(a_rParent);
...
QModelIndex
NemuDbgStatsModel::index(int iRow, int iColumn, const QModelIndex &a_rParent) const
{
    PDBGGUISTATSNODE pParent = nodeFromIndex(a_rParent);
    if (!pParent)
    {
...
QModelIndex
NemuDbgStatsModel::parent(const QModelIndex &a_rChild) const
{
...
QVariant
NemuDbgStatsModel::headerData(int a_iSection, Qt::Orientation a_eOrientation, int a_eRole) const
{
...
/*static*/ QString
NemuDbgStatsModel::strUnit(PCDBGGUISTATSNODE pNode)
{
...
/*static*/ QString
NemuDbgStatsModel::strValueTimes(PCDBGGUISTATSNODE pNode)
{
    char sz[128];
...
/*static*/ QString
NemuDbgStatsModel::strMinValue(PCDBGGUISTATSNODE pNode)
{
    char sz[128];
...
/*static*/ QString
NemuDbgStatsModel::strAvgValue(PCDBGGUISTATSNODE pNode)
{
    char sz[128];
...
/*static*/ QString
NemuDbgStatsModel::strMaxValue(PCDBGGUISTATSNODE pNode)
{
    char sz[128];
...
/*static*/ QString
NemuDbgStatsModel::strTotalValue(PCDBGGUISTATSNODE pNode)
{
    char sz[128];
...
/*static*/ QString
NemuDbgStatsModel::strDeltaValue(PCDBGGUISTATSNODE pNode)
{
    char sz[128];
...
QVariant
NemuDbgStatsModel::data(const QModelIndex &a_rIndex, int a_eRole) const
{
...
/*static*/ void
NemuDbgStatsModel::stringifyNodeNoRecursion(PDBGGUISTATSNODE a_pNode, QString &a_rString)
{
    /*
...
/*static*/ void
NemuDbgStatsModel::stringifyNode(PDBGGUISTATSNODE a_pNode, QString &a_rString)
{
...
void
NemuDbgStatsModel::stringifyTree(QModelIndex &a_rRoot, QString &a_rString) const
{
...
void
NemuDbgStatsModel::copyTreeToClipboard(QModelIndex &a_rRoot) const
{
    QString String;
...
/*static*/ void
NemuDbgStatsModel::logNode(PDBGGUISTATSNODE a_pNode, bool a_fReleaseLog)
{
    /* this node (if it has data) */
    if (a_pNode->enmType != STAMTYPE_INVALID)
    {
...
void
NemuDbgStatsModel::logTree(QModelIndex &a_rRoot, bool a_fReleaseLog) const
{
    PDBGGUISTATSNODE pRoot = a_rRoot.isValid() ? nodeFromIndex(a_rRoot) : m_pRoot;
    if (pRoot)
...
NemuDbgStatsModelVM::NemuDbgStatsModelVM(NemuDbgGui *a_pDbgGui, QString &a_rPatStr, QObject *a_pParent)
    : NemuDbgStatsModel(a_pParent), NemuDbgBase(a_pDbgGui)
{
    /*
...
NemuDbgStatsModelVM::~NemuDbgStatsModelVM()
{
    /* nothing to do here. */
}
...
bool
NemuDbgStatsModelVM::updateStatsByPattern(const QString &a_rPatStr)
{
...
void
NemuDbgStatsModelVM::resetStatsByPattern(QString const &a_rPatStr)
{
    stamReset(a_rPatStr);
}
...
/*static*/ DECLCALLBACK(int)
NemuDbgStatsModelVM::createNewTreeCallback(const char *pszName, STAMTYPE enmType, void *pvSample, STAMUNIT enmUnit,
                                           STAMVISIBILITY enmVisibility, const char *pszDesc, void *pvUser)
{
...
PDBGGUISTATSNODE
NemuDbgStatsModelVM::createNewTree(QString &a_rPatStr)
{
...
NemuDbgStatsView::NemuDbgStatsView(NemuDbgGui *a_pDbgGui, NemuDbgStatsModel *a_pModel, NemuDbgStats *a_pParent/* = NULL*/)
    : QTreeView(a_pParent), NemuDbgBase(a_pDbgGui), m_pModel(a_pModel), m_PatStr(), m_pParent(a_pParent),
...
NemuDbgStatsView::~NemuDbgStatsView()
{
    m_pParent = NULL;
    m_pCurMenu = NULL;
...
void
NemuDbgStatsView::updateStats(const QString &rPatStr)
{
    m_PatStr = rPatStr;
...
void
NemuDbgStatsView::resizeColumnsToContent()
{
    for (int i = 0; i <= 8; i++)
    {
...
void
NemuDbgStatsView::setSubTreeExpanded(QModelIndex const &a_rIndex, bool a_fExpanded)
{
...
void
NemuDbgStatsView::contextMenuEvent(QContextMenuEvent *a_pEvt)
{
    /*
...
void
NemuDbgStatsView::headerContextMenuRequested(const QPoint &a_rPos)
{
    /*
     * Show the view menu.
     */
...
void
NemuDbgStatsView::actAdjColumns()
{
...
NemuDbgStats::NemuDbgStats(NemuDbgGui *a_pDbgGui, const char *pszPat/* = NULL*/, unsigned uRefreshRate/* = 0*/, QWidget *pParent/* = NULL*/)
    : NemuDbgBaseWindow(a_pDbgGui, pParent), m_PatStr(pszPat), m_pPatCB(NULL), m_uRefreshRate(0), m_pTimer(NULL), m_pView(NULL)
{
    /* Assign window-title: */
    if (parent())
    {
        ...
        setWindowTitle("NemuDbg - Statistics");
     ...
     */
    NemuDbgStatsModelVM *pModel = new NemuDbgStatsModelVM(a_pDbgGui, m_PatStr, NULL);
    m_pView = new NemuDbgStatsView(a_pDbgGui, pModel, this);
...
void
NemuDbgStats::closeEvent(QCloseEvent *a_pCloseEvt)
{
    a_pCloseEvt->accept();
    delete this;
}
...
bool NemuDbgStats::eventFilter(QObject *pWatched, QEvent *pEvent)
{
    /* Skip events which are not related to our parent: */
    if (pWatched != parent())
        return NemuDbgBaseWindow::eventFilter(pWatched, pEvent);
...
void
NemuDbgStats::apply(const QString &Str)
{
    m_PatStr = Str;
    refresh();
}
...
void
NemuDbgStats::setRefresh(int iRefresh)
{
