...
#ifndef ___Nemu_vmm_vmm_h
#define ___Nemu_vmm_vmm_h
 ...
 * Rendezvous callback.
 *
 * @returns Nemu strict status code - EM scheduling.  Do not return
 ...
 * @param   pvUser  The user argument.
 */
typedef DECLCALLBACK(NEMUSTRICTRC) FNVMMEMTRENDEZVOUS(PVM pVM, PVMCPU pVCpu, void *pvUser);
