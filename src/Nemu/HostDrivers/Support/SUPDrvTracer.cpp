/* $Id: SUPDrvTracer.cpp $ */
/** @file
 * NemuDrv - The VirtualBox Support Driver - Tracer Interface.
 */
...
int NEMUCALL supdrvTracerInit(PSUPDRVDEVEXT pDevExt)
{
    ...
    if (RT_SUCCESS(rc))
    {
        ...
        rc = supdrvTracerRegisterVtgObj(pDevExt, &g_VTGObjHeader, NULL /*pImage*/, NULL /*pSession*/, NULL /*pUmod*/, "nemudrv");
        if (RT_SUCCESS(rc))
            return rc;
