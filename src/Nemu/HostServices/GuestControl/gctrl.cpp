...
/*
int gctrlAllocateExecBlock(PNEMUGUESTCTRLEXECBLOCK *ppBlock,
...
{
    PNEMUGUESTCTRLEXECBLOCK pNewBlock = (NEMUGUESTCTRLEXECBLOCK*)RTMemAlloc(sizeof(NEMUGUESTCTRLEXECBLOCK));
    int rc;
    if (pNewBlock)
    {
...
int gctrlFreeExecBlock(PNEMUGUESTCTRLEXECBLOCK pBlock)
{
    AssertPtr(pBlock);
...
int gctrlPrepareHostCmdExec(PNEMUHGCMSVCPARM *ppaParms, uint32_t *pcParms,
                            PNEMUGUESTCTRLEXECBLOCK pBlock)
{
    AssertPtr(ppaParms);
    AssertPtr(pBlock);

    PNEMUHGCMSVCPARM pNewParms =
        (NEMUHGCMSVCPARM*)RTMemAlloc(sizeof(NEMUHGCMSVCPARM) * 13);
...
void gctrlFreeHostCmd(PNEMUHGCMSVCPARM paParms)
{
    RTMemFree(paParms);
}
*/
