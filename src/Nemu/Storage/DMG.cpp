/* $Id: DMG.cpp $ */
/** @file
 * NemuDMG - Interpreter for Apple Disk Images (DMG).
 */
                                 ...
                                 PRTVFSFSSTREAM phXarFss, PRTVFSFILE phDmgFileInXar)
{
     ...
     */
    RTVFSFILE hVfsFile;
#ifdef NEMU_WITH_DIRECT_XAR_ACCESS
...
const NEMUHDDBACKEND g_DmgBackend =
{
    /* pszBackendName */
    "DMG",
    /* cbSize */
