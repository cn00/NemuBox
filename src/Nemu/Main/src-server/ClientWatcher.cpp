...
#if defined(NEMU_WITH_SYS_V_IPC_SESSION_WATCHER) || defined(NEMU_WITH_GENERIC_SESSION_WATCHER)
...
#elif defined(RT_OS_OS2) || defined(NEMU_WITH_SYS_V_IPC_SESSION_WATCHER) || defined(NEMU_WITH_GENERIC_SESSION_WATCHER)
...
#elif defined(NEMU_WITH_SYS_V_IPC_SESSION_WATCHER) || defined(NEMU_WITH_GENERIC_SESSION_WATCHER)
    RTSemEventCreate(&mUpdateReq);
